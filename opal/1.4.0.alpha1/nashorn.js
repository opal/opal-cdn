Opal.modules["nashorn/io"] = function(Opal) {/* Generated by Opal 1.4.0.alpha1 */
  var nil = Opal.nil, $send = Opal.send, $gvars = Opal.gvars, $to_a = Opal.to_a, $rb_minus = Opal.rb_minus, $writer = nil;
  ...
  $send($gvars.stdout, 'write_proc=', $to_a($writer));
  $writer[$rb_minus($writer["length"], 1)];;
  
  $writer = [function(s){print(s)}];
  $send($gvars.stderr, 'write_proc=', $to_a($writer));
...
Opal.modules["nashorn/file"] = function(Opal) {/* Generated by Opal 1.4.0.alpha1 */
  var self = Opal.top, $nesting = [], nil = Opal.nil, $klass = Opal.klass, $defs = Opal.defs;
...
Opal.modules["nashorn"] = function(Opal) {/* Generated by Opal 1.4.0.alpha1 */
