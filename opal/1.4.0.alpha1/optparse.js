Opal.modules["optparse/version"] = function(Opal) {/* Generated by Opal 1.4.0.alpha1 */
  var $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $send = Opal.send, $eqeq = Opal.eqeq, $Object = Opal.Object, $eqeqeq = Opal.eqeqeq, $truthy = Opal.truthy, $def = Opal.def, $regexp = Opal.regexp, $neqeq = Opal.neqeq;
  ...
  return (function(self, $parent_nesting) {
    ...
    $def(self, '$show_version', function $$show_version($a) {
      ...
      show = $send(self, 'proc', [], function $$1(klass, cname, version){var self = $$1.$$s == null ? this : $$1.$$s, str = nil;
        ...
        self.$puts(str);
        return (result = true);}, {$$arity: 3, $$s: self});
    ...
    $def(self, '$each_const', function $$each_const(path, base) {
      ...
      return $send(path.$split(/::|\//), 'inject', [base], function $$6(klass, name){var self = $$6.$$s == null ? this : $$6.$$s;
        ...
        return $send(klass.$constants(), 'grep', [$regexp([name], 'i')], function $$7(c){var $ret_or_1 = nil;
          ...
          return klass.$const_get(c);}, 1);}, {$$arity: 2, $$s: self});
    }, -2);
    return $def(self, '$search_const', function $$search_const(klass, name) {
      var $a, $yield = $$search_const.$$p || nil, klasses = nil;

      delete $$search_const.$$p;
...
Opal.modules["shellwords"] = function(Opal) {/* Generated by Opal 1.4.0.alpha1 */
  var $nesting = [], nil = Opal.nil, $module = Opal.module, $rb_plus = Opal.rb_plus, $send = Opal.send, $to_ary = Opal.to_ary, $truthy = Opal.truthy, $def = Opal.def, $alias = Opal.alias, $klass = Opal.klass;

  Opal.add_stubs('+,new,scan,raise,inspect,gsub,<<,module_function,to_s,empty?,dup,join,map,shellescape,split,escape');
...
Opal.modules["optparse"] = function(Opal) {/* Generated by Opal 1.4.0.alpha1 */
  ...
  (function($base, $super, $parent_nesting) {
    ...
    var $nesting = [self].concat($parent_nesting), $$ = Opal.$r($nesting), $writer = nil, decimal = nil, binary = nil, hex = nil, octal = nil, integer = nil, float$ = nil, floatpat = nil, real = nil, yesno = nil, $proto = self.$$prototype;
    ...
    (function($base, $parent_nesting) {
      ...
      $def(self, '$complete', function $$complete(key, icase, pat) {
        ...
        if ($eqeq(candidates.$size(), 1)) {
          ...
          $send(candidates, 'each', [], function $$3(k, v, kn){var $c, self = $$3.$$s == null ? this : $$3.$$s;
            ...
            return self.$throw("ambiguous", key);}, {$$arity: 3, $$s: self});
        };
        if ($truthy(canon)) {
      ...
      return $def(self, '$convert', function $$convert($a, $b, $c) {
        var $post_args, opt, val, $rest_arg;

        
        
        $post_args = Opal.slice.call(arguments);
        
        if ($post_args.length > 0) opt = $post_args.shift();
        if (opt == null) opt = nil;;
        
        if ($post_args.length > 0) val = $post_args.shift();
        if (val == null) val = nil;;
    ...
    (function($base, $super, $parent_nesting) {
      ...
      $def(self, '$summarize', function $$summarize(sdone, ldone, width, max, indent) {
        var $a, $yield = $$summarize.$$p || nil, self = this, sopts = nil, lopts = nil, left = nil, right = nil, s = nil, l = nil, $ret_or_1 = nil, $ret_or_2 = nil, $writer = nil, mlen = nil, r = nil;

        delete $$summarize.$$p;
        
        
        if (sdone == null) sdone = $hash2([], {});;
        
        if (ldone == null) ldone = $hash2([], {});;
        ...
        if ($truthy(self["short"])) {
          $send(self["short"], 'each', [], function $$5(s){var $writer = nil;
            ...
            $writer = [s, true];
            $send(sdone, '[]=', $to_a($writer));
            return $writer[$rb_minus($writer["length"], 1)];;}, 1)
        };
        if ($truthy(self["long"])) {
          $send(self["long"], 'each', [], function $$7(s){var $writer = nil;
        ...
        while ($truthy((s = lopts.$shift()))) {
          ...
          $writer = [-1, $rb_plus(left['$[]'](-1), $rb_plus(($truthy(left['$[]'](-1)['$empty?']()) ? ($rb_times(" ", 4)) : (", ")), s))];
          $send(left, '[]=', $to_a($writer));
          $writer[$rb_minus($writer["length"], 1)];;
        };
        if ($truthy(self.$arg())) {
          
          $writer = [0, $rb_plus(left['$[]'](0), ($truthy(left['$[]'](1)) ? ($rb_plus(self.$arg().$sub(/^(\[?)=/, "\\1"), ",")) : (self.$arg())))];
          $send(left, '[]=', $to_a($writer));
          $writer[$rb_minus($writer["length"], 1)];
        };
      ...
      $def(self, '$compsys', function $$compsys(sdone, ldone) {
        ...
        if ($truthy(self["short"])) {
          $send(self["short"], 'each', [], function $$10(s){var $writer = nil;
        ...
        if ($truthy(self["long"])) {
          $send(self["long"], 'each', [], function $$12(s){var $writer = nil;
      ...
      return (function($base, $super) {
        ...
        return $def(self, '$parse', function $$parse(arg, argv) {
          var error = $$parse.$$p || nil, self = this, val = nil, opt = nil, $writer = nil;
    ...
    (function($base, $super, $parent_nesting) {
      ...
      $def(self, '$accept', function $$accept(t, pat) {
        var block = $$accept.$$p || nil, self = this, $ret_or_1 = nil, $writer = nil;
      ...
      $def(self, '$update', function $$update(sw, sopts, lopts, nsw, nlopts) {
        ...
        if ($truthy(sopts)) {
          $send(sopts, 'each', [], function $$15(o){var self = $$15.$$s == null ? this : $$15.$$s, $writer = nil;
            ...
            if (o == null) o = nil;;
            $writer = [o, sw];
            $send(self["short"], '[]=', $to_a($writer));
            return $writer[$rb_minus($writer["length"], 1)];}, {$$arity: 1, $$s: self})
        };
        if ($truthy(lopts)) {
          $send(lopts, 'each', [], function $$16(o){var self = $$16.$$s == null ? this : $$16.$$s, $writer = nil;
            ...
            if (o == null) o = nil;;
            $writer = [o, sw];
            $send(self["long"], '[]=', $to_a($writer));
            return $writer[$rb_minus($writer["length"], 1)];}, {$$arity: 1, $$s: self})
        };
        if (($truthy(nsw) && ($truthy(nlopts)))) {
          $send(nlopts, 'each', [], function $$17(o){var self = $$17.$$s == null ? this : $$17.$$s, $writer = nil;
            if (self["long"] == null) self["long"] = nil;
      ...
      $def(self, '$search', function $$search(id, key) {try {
      ...
      $def(self, '$complete', function $$complete(id, opt, $a, $b) {
        ...
        if ($post_args.length > 0) icase = $post_args.shift();
        if (icase == null) icase = false;;
    ...
    (function($base, $super, $parent_nesting) {
      ...
      return $def(self, '$match', function $$match(key) {try {
        ...
        $b = $send(self, 'fetch', [key], function $$24(){var self = $$24.$$s == null ? this : $$24.$$s;
          ...
          return self.$raise($$('AmbiguousArgument'), $send(self, 'catch', ["ambiguous"], function $$25(){var self = $$25.$$s == null ? this : $$25.$$s;
            ...
            Opal.ret(self.$complete(key))}, {$$arity: 0, $$s: self}))}, {$$arity: 0, $$s: self}), $a = $to_ary($b), (values = $slice.call($a, 0)), $b;
        return [key].concat($to_a(values));
        } catch ($returner) { if ($returner === Opal.returner) { return $returner.$v } throw $returner; }
      }, 1);
    })($nesting[0], $$('Hash'), $nesting);
    $const_set($nesting[0], 'ArgumentStyle', $hash2([], {}));
    $send($$('NoArgument'), 'each', [], function $OptionParser$26(el){var $writer = nil;

      
      
      if (el == null) el = nil;;
      $writer = [el, $$$($$('Switch'), 'NoArgument')];
      $send($$('ArgumentStyle'), '[]=', $to_a($writer));
      return $writer[$rb_minus($writer["length"], 1)];}, 1);
    $send($$('RequiredArgument'), 'each', [], function $OptionParser$27(el){var $writer = nil;

      
      
      if (el == null) el = nil;;
      $writer = [el, $$$($$('Switch'), 'RequiredArgument')];
      $send($$('ArgumentStyle'), '[]=', $to_a($writer));
      return $writer[$rb_minus($writer["length"], 1)];}, 1);
    $send($$('OptionalArgument'), 'each', [], function $OptionParser$28(el){var $writer = nil;

      
      
      if (el == null) el = nil;;
      $writer = [el, $$$($$('Switch'), 'OptionalArgument')];
      $send($$('ArgumentStyle'), '[]=', $to_a($writer));
      return $writer[$rb_minus($writer["length"], 1)];}, 1);
    $$('ArgumentStyle').$freeze();
    $const_set($nesting[0], 'DefaultList', $$('List').$new());
    
    $writer = ["-", $send($$$($$('Switch'), 'NoArgument'), 'new', [], function $OptionParser$29(){
      return nil}, 0)];
    $send($$('DefaultList').$short(), '[]=', $to_a($writer));
    $writer[$rb_minus($writer["length"], 1)];;
    
    $writer = ["", $send($$$($$('Switch'), 'NoArgument'), 'new', [], function $OptionParser$30(){var self = $OptionParser$30.$$s == null ? this : $OptionParser$30.$$s;

      return self.$throw("terminate")}, {$$arity: 0, $$s: self})];
    $send($$('DefaultList').$long(), '[]=', $to_a($writer));
    $writer[$rb_minus($writer["length"], 1)];;
    ...
    $def(self, '$compsys', function $$compsys(to, name) {
      ...
      to['$<<']("#compdef " + (name) + "\n");
      to['$<<']($$('COMPSYS_HEADER'));
      $send(self, 'visit', ["compsys", $hash2([], {}), $hash2([], {})], function $$31(o, d){
    ...
    $const_set($nesting[0], 'Officious', $hash2([], {}));
    
    $writer = ["help", $send(self, 'proc', [], function $OptionParser$32(parser){var self = $OptionParser$32.$$s == null ? this : $OptionParser$32.$$s;

      
      
      if (parser == null) parser = nil;;
      return $send($$$($$('Switch'), 'NoArgument'), 'new', [], function $$33(arg){var self = $$33.$$s == null ? this : $$33.$$s;

        
        
        if (arg == null) arg = nil;;
        self.$puts(parser.$help());
        return self.$exit();}, {$$arity: 1, $$s: self});}, {$$arity: 1, $$s: self})];
    $send($$('Officious'), '[]=', $to_a($writer));
    $writer[$rb_minus($writer["length"], 1)];;
    
    $writer = ["*-completion-bash", $send(self, 'proc', [], function $OptionParser$34(parser){var self = $OptionParser$34.$$s == null ? this : $OptionParser$34.$$s;

      
      
      if (parser == null) parser = nil;;
      return $send($$$($$('Switch'), 'RequiredArgument'), 'new', [], function $$35(arg){var self = $$35.$$s == null ? this : $$35.$$s;
    ...
    $writer = ["*-completion-zsh", $send(self, 'proc', [], function $OptionParser$36(parser){var self = $OptionParser$36.$$s == null ? this : $OptionParser$36.$$s;

      
      
      if (parser == null) parser = nil;;
      return $send($$$($$('Switch'), 'OptionalArgument'), 'new', [], function $$37(arg){var self = $$37.$$s == null ? this : $$37.$$s;
    ...
    $writer = ["version", $send(self, 'proc', [], function $OptionParser$38(parser){var self = $OptionParser$38.$$s == null ? this : $OptionParser$38.$$s;

      
      
      if (parser == null) parser = nil;;
      return $send($$$($$('Switch'), 'OptionalArgument'), 'new', [], function $$39(pkg){var self = $$39.$$s == null ? this : $$39.$$s, $ret_or_1 = nil, v = nil;
    ...
    $send($$('Officious'), '[]=', $to_a($writer));
    $writer[$rb_minus($writer["length"], 1)];;
    $defs(self, '$with', function $OptionParser_with$40($a) {
      var block = $OptionParser_with$40.$$p || nil, $post_args, args, self = this, opts = nil;

      delete $OptionParser_with$40.$$p;
    ...
    $def(self, '$add_officious', function $$add_officious() {
      ...
      list = self.$base();
      return $send($$('Officious'), 'each', [], function $$41(opt, block){var self = $$41.$$s == null ? this : $$41.$$s, $logical_op_recvr_tmp_1 = nil, $ret_or_1 = nil, $writer = nil;
        ...
        if ($truthy(($ret_or_1 = $logical_op_recvr_tmp_1['$[]'](opt)))) {
          ...
          $writer = [opt, block.$call(self)];
          $send($logical_op_recvr_tmp_1, '[]=', $to_a($writer));
          return $writer[$rb_minus($writer["length"], 1)];
        };}, {$$arity: 2, $$s: self});
    }, 0);
    ...
    $def(self, '$new', function $OptionParser_new$42() {
      var $yield = $OptionParser_new$42.$$p || nil, self = this;

      delete $OptionParser_new$42.$$p;
    ...
    $def(self, '$summarize', function $$summarize(to, width, max, indent) {
      ...
      nl = "\n";
      blk = ($truthy(($ret_or_1 = blk)) ? ($ret_or_1) : ($send(self, 'proc', [], function $$43(l){
        
        
        if (l == null) l = nil;;
        return to['$<<'](($truthy(l.$index(nl, -1)) ? (l) : ($rb_plus(l, nl))));}, 1)));
      $send(self, 'visit', ["summarize", $hash2([], {}), $hash2([], {}), width, max, indent], blk.$to_proc());
      return to;
    }, -1);
    ...
    $const_set($nesting[0], 'SPLAT_PROC', $send(self, 'proc', [], function $OptionParser$44($a){var $post_args, a;
    ...
    $def(self, '$make_switch', function $$make_switch(opts, block) {
      ...
      has_arg = false;
      $send(opts, 'each', [], function $$45(o){var $c, $d, self = $$45.$$s == null ? this : $$45.$$s, $ret_or_1 = nil, $ret_or_2 = nil, $ret_or_3 = nil;

        
        
        if (o == null) o = nil;;
        if ($truthy($send(self, 'search', ["atype", o], function $$46(pat, c){var $c, self = $$46.$$s == null ? this : $$46.$$s;
        ...
        if (($eqeqeq($$('Proc'), ($ret_or_1 = o)) || ($eqeqeq($$('Method'), $ret_or_1)))) {
          ...
          return $send(o, 'each', [], function $$47(pat, $c){var $post_args, v, $writer = nil;
            ...
            v = $post_args;;
            $writer = [pat, $send(v, 'fetch', [0], function $$48(){
              return pat}, 0)];
            $send(pattern, '[]=', $to_a($writer));
        ...
        } else if ($truthy($send($$('ArgumentStyle').$keys(), 'any?', [], function $$49($ret_or_2){
          
          
          if ($ret_or_2 == null) $ret_or_2 = nil;;
          return $ret_or_2['$===']($ret_or_1);}, 1))) {
    ...
    $def(self, '$order', function $$order($a, $b) {
      ...
      into = $kwargs.$$smap["into"];
      if (into == null) into = nil;
      if (($eqeq(argv.$size(), 1) && ($eqeqeq($$('Array'), argv['$[]'](0))))) {
        argv = argv['$[]'](0).$dup()
      };
      return $send(self, 'order!', [argv, $hash2(["into"], {"into": into})], nonopt.$to_proc());
    }, -1);
    
    $def(self, '$order!', function $OptionParser_order$excl$50($a, $b) {
      var nonopt = $OptionParser_order$excl$50.$$p || nil, $post_args, $kwargs, argv, into, self = this, setter = nil;

      delete $OptionParser_order$excl$50.$$p;
      ...
      if ($post_args.length > 0) argv = $post_args.shift();
      if (argv == null) argv = self.$default_argv();;
      
      into = $kwargs.$$smap["into"];
      if (into == null) into = nil;
      if ($truthy(into)) {
        setter = $lambda(function $$51(name, val){var $writer = nil;
          ...
          if (val == null) val = nil;;
          $writer = [name.$to_sym(), val];
          $send(into, '[]=', $to_a($writer));
          return $writer[$rb_minus($writer["length"], 1)];}, 2)
      };
    ...
    $def(self, '$parse_in_order', function $$parse_in_order(argv, setter) {
      ...
      nonopt = ($truthy(($ret_or_2 = nonopt)) ? ($ret_or_2) : ($send(self, 'proc', [], function $$52(a){var self = $$52.$$s == null ? this : $$52.$$s;

        
        
        if (a == null) a = nil;;
        return self.$throw("terminate", a);}, {$$arity: 1, $$s: self})));
      if ($truthy((arg = $send(self, 'catch', ["terminate"], function $$53(){var $c, $d, $e, self = $$53.$$s == null ? this : $$53.$$s, sw = nil, cb = nil, eq = nil, has_arg = nil, $ret_or_3 = nil;
        if ($gvars["!"] == null) $gvars["!"] = nil;
        ...
        while ($truthy((arg = argv.$shift()))) {
          if ($eqeqeq(/^--([^=]*)(?:=(.*))?/m, ($ret_or_2 = arg))) {
            ...
            $d = [$$('Regexp').$last_match(1), $$('Regexp').$last_match(2)], (opt = $d[0]), (rest = $d[1]), $d;
            opt = opt.$tr("_", "-");
            
            try {
              
              $e = self.$complete("long", opt, true), $d = $to_ary($e), (sw = ($d[0] == null ? nil : $d[0])), $e;
            ...
            try {
              ...
              $e = $send(sw, 'parse', [rest, argv], function $$54($f){var $post_args, exc, self = $$54.$$s == null ? this : $$54.$$s;
                ...
                exc = $post_args;;
                return $send(self, 'raise', $to_a(exc));}, {$$arity: -1, $$s: self}), $d = $to_ary($e), (opt = ($d[0] == null ? nil : $d[0])), (cb = ($d[1] == null ? nil : $d[1])), (val = ($d[2] == null ? nil : $d[2])), $e;
              if ($truthy(cb)) {
                val = cb.$call(val)
              };
              if ($truthy(setter)) {
            ...
            $d = [$$('Regexp').$last_match(3), $$('Regexp').$last_match(2), $$('Regexp').$last_match(1)], (eq = $d[0]), (rest = $d[1]), (opt = $d[2]), $d;
            $d = [eq, rest], (has_arg = $d[0]), (val = $d[1]), $d;
            
            try {
              
              $e = self.$search("short", opt), $d = $to_ary($e), (sw = ($d[0] == null ? nil : $d[0])), $e;
              if (!$truthy(sw)) {
                
                try {
                  
                  $e = self.$complete("short", opt), $d = $to_ary($e), (sw = ($d[0] == null ? nil : $d[0])), $e;
                  ...
                  if (Opal.rescue($err, [$$('InvalidOption')])) {
                    try {
                      ...
                      $e = self.$complete("long", opt), $d = $to_ary($e), (sw = ($d[0] == null ? nil : $d[0])), $e;
            ...
            var $no_errors = true;try {
              $e = $send(sw, 'parse', [val, argv], function $$55($f){var $post_args, exc, self = $$55.$$s == null ? this : $$55.$$s;
                ...
                if ($truthy(eq)) {
                  ...
                  return nil
                };}, {$$arity: -1, $$s: self}), $d = $to_ary($e), (opt = ($d[0] == null ? nil : $d[0])), (cb = ($d[1] == null ? nil : $d[1])), (val = ($d[2] == null ? nil : $d[2])), $e
            } catch ($err) {
              $no_errors = false;
              if (Opal.rescue($err, [$$('ParseError')])) {
                try {
            ...
            $send(self, 'catch', ["prune"], function $$56(){var self = $$56.$$s == null ? this : $$56.$$s;

              
              $send(self, 'visit', ["each_option"], function $$57(sw0){
              ...
              return nonopt.$call(arg);}, {$$arity: 0, $$s: self})
          }
        };
        return nil;}, {$$arity: 0, $$s: self})))) {
        argv.$unshift(arg)
      };
      $send(self, 'visit', ["search", "short", nil], function $$58(sw){
    ...
    $def(self, '$permute', function $$permute($a, $b) {
      ...
      return self['$permute!'](argv, $hash2(["into"], {"into": into}));
    }, -1);
    
    $def(self, '$permute!', function $OptionParser_permute$excl$59($a, $b) {
      var $post_args, $kwargs, argv, into, self = this, nonopts = nil, $writer = nil;
      ...
      if (into == null) into = nil;
      nonopts = [];
      $send(self, 'order!', [argv, $hash2(["into"], {"into": into})], nonopts.$method("<<").$to_proc());
      
      $writer = [0, 0, nonopts];
      $send(argv, '[]=', $to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      return argv;
    }, -1);
    ...
    $def(self, '$parse', function $$parse($a, $b) {
      ...
      return self['$parse!'](argv, $hash2(["into"], {"into": into}));
    }, -1);
    
    $def(self, '$parse!', function $OptionParser_parse$excl$60($a, $b) {
      var $post_args, $kwargs, argv, into, self = this;
      ...
      if ($truthy($$('ENV')['$include?']("POSIXLY_CORRECT"))) {
        return self['$order!'](argv, $hash2(["into"], {"into": into}))
      } else {
        return self['$permute!'](argv, $hash2(["into"], {"into": into}))
      };
    }, -1);
    ...
    $def(self, '$getopts', function $$getopts($a) {
      ...
      $b = [].concat($to_a(args)), (single_options = ($b[0] == null ? nil : $b[0])), (long_options = $slice.call($b, 1)), $b;
      result = $hash2([], {});
      if ($truthy(single_options)) {
        $send(single_options, 'scan', [/(.)(:)?/], function $$61(opt, val){var self = $$61.$$s == null ? this : $$61.$$s, $writer = nil;
      ...
      $send(long_options, 'each', [], function $$62(arg){var $c, $d, self = $$62.$$s == null ? this : $$62.$$s, desc = nil, opt = nil, val = nil, $writer = nil, $ret_or_2 = nil;
        ...
        if ($truthy(val)) {
          ...
          $writer = [opt, ($truthy(val['$empty?']()) ? (nil) : (val))];
          $send(result, '[]=', $to_a($writer));
          $writer[$rb_minus($writer["length"], 1)];;
    ...
    $def(self, '$visit', function $$visit(id, $a) {
      ...
      args = $post_args;;
      $send(self.stack, 'reverse_each', [], function $$63(el){
        
        
        if (el == null) el = nil;;
        return $send(el, '__send__', [id].concat($to_a(args)), block.$to_proc());}, 1);
      return nil;
    }, -2);
    self.$private("visit");
    ...
    $def(self, '$search', function $$search(id, key) {
      ...
      retval = nil;
      (function(){var $brk = Opal.new_brk(); try {return $send(self, 'visit', ["search", id, key], function $$64(k){
        
        
        if (k == null) k = nil;;
        retval = ($truthy(block_given) ? (Opal.yield1($yield, k)) : (k));
        
        Opal.brk(nil, $brk);}, {$$arity: 1, $$brk: $brk})
      } catch (err) { if (err === $brk) { return err.$v } else { throw err } }})();
      return retval;
    }, 2);
    self.$private("search");
    
    $def(self, '$complete', function $$complete(typ, opt, $a, $b) {try {
      ...
      if ($truthy(pat['$empty?']())) {
        ...
        retval = nil;
        (function(){var $brk = Opal.new_brk(); try {return $send(self, 'search', [typ, opt], function $$65(sw){
      ...
      ambiguous = (function(){var $brk = Opal.new_brk(); try {return $send(self, 'catch', ["ambiguous"], function $$66(){var self = $$66.$$s == null ? this : $$66.$$s;

        
        retval = nil;
        (function(){var $brk = Opal.new_brk(); try {return $send(self, 'visit', ["complete", typ, opt, icase].concat($to_a(pat)), function $$67(o, $c){var $post_args, sw;
          ...
          Opal.brk(nil, $brk);}, {$$arity: -2, $$brk: $brk})
        } catch (err) { if (err === $brk) { return err.$v } else { throw err } }})();
        if ($truthy(retval)) {
          Opal.ret(retval)
        } else {
      ...
      return self.$raise(exc.$new(opt, $hash2(["additional"], {"additional": self.$method("additional_message").$curry()['$[]'](typ)})));
      } catch ($returner) { if ($returner === Opal.returner) { return $returner.$v } throw $returner; }
    }, -3);
    ...
    $def(self, '$additional_message', function $$additional_message(typ, opt) {
      ...
      all_candidates = [];
      $send(self, 'visit', ["get_candidates", typ], function $$68(candidates){
        
        
        if (candidates == null) candidates = nil;;
        return all_candidates.$concat(candidates);}, 1);
      $send(all_candidates, 'select!', [], function $$69(cand){
        
        
        if (cand == null) cand = nil;;
        return cand['$is_a?']($$('String'));}, 1);
      checker = $$$($$('DidYouMean'), 'SpellChecker').$new($hash2(["dictionary"], {"dictionary": all_candidates}));
    ...
    $def(self, '$candidate', function $$candidate(word) {
      ...
      $send(self, 'visit', ["each_option"], function $$70(opt){var opts = nil;
    ...
    $def(self, '$load', function $$load(filename) {
      ...
      if (!$truthy(filename)) {
        ...
        basename['$<<'](".options");
        return $send([$$('ENV')['$[]']("XDG_CONFIG_HOME"), "~/.config"].concat($to_a(($a = $$('ENV')['$[]']("XDG_CONFIG_DIRS"), ($a === nil || $a == null) ? nil : $send($a, 'split', [$$$($$('File'), 'PATH_SEPARATOR')])))).concat(["~/config/settings"]), 'any?', [], function $$72(dir){var self = $$72.$$s == null ? this : $$72.$$s;
    ...
    $send(self, 'accept', [$$('Object')], function $OptionParser$73(s){var $ret_or_2 = nil;
      ...
      if ($truthy(($ret_or_2 = s))) {
        ...
        return s['$nil?']()
      };}, {$$arity: 1, $$has_trailing_comma_in_args: true});
    $send(self, 'accept', [$$('NilClass')], function $OptionParser$74(s){
      
      
      if (s == null) s = nil;;
      return s;}, {$$arity: 1, $$has_trailing_comma_in_args: true});
    $send(self, 'accept', [$$('String'), /.+/m], function $OptionParser$75(s, $a){var $post_args, $rest_arg;
    ...
    $send(self, 'accept', [$$('Integer'), $regexp(["\\A[-+]?(?:", integer, ")\\z"], 'i')], function $OptionParser$76(s){var self = $OptionParser$76.$$s == null ? this : $OptionParser$76.$$s;
      ...
      if ($truthy(s)) {
        ...
        return nil
      };}, {$$arity: 1, $$s: self, $$has_trailing_comma_in_args: true});
    float$ = "(?:" + (decimal) + "(?=(.)?)(?:\\.(?:" + (decimal) + ")?)?|\\." + (decimal) + ")(?:E[-+]?" + (decimal) + ")?";
    floatpat = $regexp(["\\A[-+]?", float$, "\\z"], 'i');
    $send(self, 'accept', [$$('Float'), floatpat], function $OptionParser$77(s){
    ...
    real = "[-+]?(?:" + (octal) + "|" + (float$) + ")";
    $send(self, 'accept', [$$('Numeric'), $regexp(["\\A(", real, ")(?:/(", real, "))?\\z"], 'i')], function $OptionParser$78(s, d, f, n){var self = $OptionParser$78.$$s == null ? this : $OptionParser$78.$$s;
      ...
      if ($truthy(n)) {
        ...
        return self.$Integer(s)
      };}, {$$arity: 4, $$s: self, $$has_trailing_comma_in_args: true});
    $const_set($nesting[0], 'DecimalInteger', $regexp(["\\A[-+]?", decimal, "\\z"], 'i'));
    $send(self, 'accept', [$$('DecimalInteger'), $$('DecimalInteger')], function $OptionParser$79(s){var self = $OptionParser$79.$$s == null ? this : $OptionParser$79.$$s;
    ...
    $send(self, 'accept', [$$('OctalInteger'), $$('OctalInteger')], function $OptionParser$80(s){var self = $OptionParser$80.$$s == null ? this : $OptionParser$80.$$s;
    ...
    $send(self, 'accept', [$$('DecimalNumeric'), floatpat], function $OptionParser$81(s, f){var self = $OptionParser$81.$$s == null ? this : $OptionParser$81.$$s;
    ...
    $send(["-", "no", "false"], 'each', [], function $OptionParser$82(el){
      
      
      if (el == null) el = nil;;
      $writer = [el, false];
      $send(yesno, '[]=', $to_a($writer));
      return $writer[$rb_minus($writer["length"], 1)];}, 1);
    $send(["+", "yes", "true"], 'each', [], function $OptionParser$83(el){
    ...
    $send(yesno, '[]=', $to_a($writer));
    $writer[$rb_minus($writer["length"], 1)];;
    $send(self, 'accept', [$$('TrueClass'), yesno], function $OptionParser$84(arg, val){var $ret_or_2 = nil;
    ...
    $send(self, 'accept', [$$('FalseClass'), yesno], function $OptionParser$85(arg, val){var $ret_or_2 = nil;
    ...
    $send(self, 'accept', [$$('Array')], function $OptionParser$86(s){
      
      
      if (s == null) s = nil;;
      if ($truthy(s)) {
        s = $send(s.$split(","), 'collect', [], function $$87(ss){
      ...
      return s;}, {$$arity: 1, $$has_trailing_comma_in_args: true});
    $send(self, 'accept', [$$('Regexp'), /^\/((?:\\.|[^\\])*)\/([[:alpha:]]+)?$|.*/], function $OptionParser$88(all, s, o){var f = nil, k = nil, $ret_or_2 = nil;
      ...
      return $$('Regexp').$new(($truthy(($ret_or_2 = s)) ? ($ret_or_2) : (all)), f, k);}, 3);
    (function($base, $super, $parent_nesting) {
      ...
      $def(self, '$initialize', function $$initialize($a, $b) {
        ...
        additional = $kwargs.$$smap["additional"];
      ...
      $defs(self, '$filter_backtrace', function $$filter_backtrace(array) {
        ...
        if (!$truthy($gvars.DEBUG)) {
          $send(array, 'delete_if', [], $regexp(["\\A", $$('Regexp').$quote($enc("./optparse.rb", "US-ASCII")), ":"]).$method("=~").$to_proc())
        };
        return array;
      }, 1);
    ...
    (function($base, $parent_nesting) {
      ...
      $def(self, '$options=', function $Arguable_options$eq$89(opt) {
        var self = this;
      ...
      $def(self, '$options', function $$options() {
        var $yield = $$options.$$p || nil, self = this, $ret_or_2 = nil, $writer = nil;
        ...
        $writer = [self];
        $send(self.optparse, 'default_argv=', $to_a($writer));
        $writer[$rb_minus($writer["length"], 1)];;
      ...
      $def(self, '$order!', function $Arguable_order$excl$90() {
        var blk = $Arguable_order$excl$90.$$p || nil, self = this;

        delete $Arguable_order$excl$90.$$p;
        
        ;
        return $send(self.$options(), 'order!', [self], blk.$to_proc());
      }, 0);
      
      $def(self, '$permute!', function $Arguable_permute$excl$91() {
        var self = this;

        return self.$options()['$permute!'](self)
      }, 0);
      
      $def(self, '$parse!', function $Arguable_parse$excl$92() {
        var self = this;
      ...
      $defs(self, '$extend_object', function $$extend_object(obj) {
        ...
        return $send(obj, 'instance_eval', [], function $$93(){var self = $$93.$$s == null ? this : $$93.$$s;

          return (self.optparse = nil)}, {$$arity: 0, $$s: self});
      }, 1);
