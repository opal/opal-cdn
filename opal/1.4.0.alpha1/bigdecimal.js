Opal.modules["js"] = function(Opal) {/* Generated by Opal 1.4.0.alpha1 */
...
Opal.modules["bigdecimal/bignumber"] = function(Opal) {/* Generated by Opal 1.4.0.alpha1 */
  var $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $klass = Opal.klass;
...
Opal.modules["bigdecimal"] = function(Opal) {/* Generated by Opal 1.4.0.alpha1 */
  var self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $klass = Opal.klass, $module = Opal.module, $def = Opal.def, $hash2 = Opal.hash2, $send = Opal.send, $to_a = Opal.to_a, $hash = Opal.hash, $defs = Opal.defs, $const_set = Opal.const_set, $truthy = Opal.truthy, $eqeqeq = Opal.eqeqeq, $send2 = Opal.send2, $find_super = Opal.find_super, $rb_lt = Opal.rb_lt, $to_ary = Opal.to_ary, $rb_gt = Opal.rb_gt, $rb_ge = Opal.rb_ge, $eqeq = Opal.eqeq, $rb_divide = Opal.rb_divide, $alias = Opal.alias;
