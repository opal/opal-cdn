Opal.modules["benchmark"] = function(Opal) {/* Generated by Opal 1.4.0.alpha1 */
  var $nesting = [], nil = Opal.nil, $$$ = Opal.$$$, $module = Opal.module, $const_set = Opal.const_set, $send = Opal.send, $to_a = Opal.to_a, $rb_minus = Opal.rb_minus, $truthy = Opal.truthy, $rb_plus = Opal.rb_plus, $rb_times = Opal.rb_times, $def = Opal.def, $to_ary = Opal.to_ary, $klass = Opal.klass, $rb_lt = Opal.rb_lt, $alias = Opal.alias, $gvars = Opal.gvars, $hash2 = Opal.hash2, $eqeqeq = Opal.eqeqeq;
  ...
  return (function($base, $parent_nesting) {
    ...
    $def(self, '$benchmark', function $$benchmark($a, $b, $c, $d) {
      var $post_args, caption, label_width, format, labels, $yield = $$benchmark.$$p || nil, self = this, sync = nil, $writer = nil, $ret_or_1 = nil, report = nil, results = nil;
      ...
      if ($post_args.length > 0) caption = $post_args.shift();
      if (caption == null) caption = "";;
      
      if ($post_args.length > 0) label_width = $post_args.shift();
      if (label_width == null) label_width = nil;;
      
      if ($post_args.length > 0) format = $post_args.shift();
      ...
      if ($truthy(($ret_or_1 = $$('Array')['$==='](results)))) {
        $send(results.$grep($$('Tms')), 'each', [], function $$1(t){var self = $$1.$$s == null ? this : $$1.$$s, $ret_or_2 = nil, $ret_or_3 = nil;
          ...
          if (t == null) t = nil;;
          return self.$print(($truthy(($ret_or_2 = ($truthy(($ret_or_3 = labels.$shift())) ? ($ret_or_3) : (t.$label())))) ? ($ret_or_2) : ("")).$ljust(label_width), t.$format(format));}, {$$arity: 1, $$s: self})
      } else {
        $ret_or_1
      };
      return report.$list();
      } finally {
        ($truthy(sync['$nil?']()) ? (nil) : ((($writer = [sync]), $send($$('STDOUT'), 'sync=', $to_a($writer)), $writer[$rb_minus($writer["length"], 1)])))
      }; })();
    }, -1);
    ...
    $def(self, '$bm', function $$bm($a, $b) {
      ...
      if ($post_args.length > 0) label_width = $post_args.shift();
      if (label_width == null) label_width = 0;;
    ...
    $def(self, '$bmbm', function $$bmbm(width) {
      var $yield = $$bmbm.$$p || nil, self = this, job = nil, sync = nil, $writer = nil, ets = nil;
      ...
      ets = $send(job.$list(), 'inject', [$$('Tms').$new()], function $$2(sum, $mlhs_tmp1){var $a, $b, self = $$2.$$s == null ? this : $$2.$$s, label = nil, item = nil, res = nil;
        ...
        return $rb_plus(sum, res);}, {$$arity: 2, $$s: self, $$has_top_level_mlhs_arg: true}).$format("total: %tsec");
      ...
      return $send(job.$list(), 'map', [], function $$3(label, item){var self = $$3.$$s == null ? this : $$3.$$s;
        ...
        return $send($send($$('Benchmark'), 'measure', [label], item.$to_proc()), 'tap', [], function $$4(res){var self = $$4.$$s == null ? this : $$4.$$s;
          ...
          if (res == null) res = nil;;
          return self.$print(res);}, {$$arity: 1, $$s: self});}, {$$arity: 2, $$s: self});
      } finally {
        ($truthy(sync['$nil?']()) ? (nil) : ((($writer = [sync]), $send($$('STDOUT'), 'sync=', $to_a($writer)), $writer[$rb_minus($writer["length"], 1)])))
      }; })();
    }, -1);
    ...
    (function($base, $super, $parent_nesting) {
      ...
      $def(self, '$item', function $$item($a, $b) {
        ...
        if ($post_args.length > 0) label = $post_args.shift();
        if (label == null) label = "";;
    ...
    (function($base, $super, $parent_nesting) {
      ...
      $def(self, '$format', function $$format($a, $b) {
        ...
        str = $send($send($send($send($send($send($send(($truthy(($ret_or_1 = format)) ? ($ret_or_1) : ($$('FORMAT'))).$dup(), 'gsub', [/(%[-+.\d]*)n/], function $$10(){var $c, self = $$10.$$s == null ? this : $$10.$$s;
          ...
          return (("" + ((($c = $gvars['~']) === nil ? nil : $c['$[]'](1)))) + "s")['$%'](self.$label())}, {$$arity: 0, $$s: self}), 'gsub', [/(%[-+.\d]*)u/], function $$11(){var $c, self = $$11.$$s == null ? this : $$11.$$s;

          return (("" + ((($c = $gvars['~']) === nil ? nil : $c['$[]'](1)))) + "f")['$%'](self.$utime())}, {$$arity: 0, $$s: self}), 'gsub', [/(%[-+.\d]*)y/], function $$12(){var $c, self = $$12.$$s == null ? this : $$12.$$s;

          return (("" + ((($c = $gvars['~']) === nil ? nil : $c['$[]'](1)))) + "f")['$%'](self.$stime())}, {$$arity: 0, $$s: self}), 'gsub', [/(%[-+.\d]*)U/], function $$13(){var $c, self = $$13.$$s == null ? this : $$13.$$s;

          return (("" + ((($c = $gvars['~']) === nil ? nil : $c['$[]'](1)))) + "f")['$%'](self.$cutime())}, {$$arity: 0, $$s: self}), 'gsub', [/(%[-+.\d]*)Y/], function $$14(){var $c, self = $$14.$$s == null ? this : $$14.$$s;

          return (("" + ((($c = $gvars['~']) === nil ? nil : $c['$[]'](1)))) + "f")['$%'](self.$cstime())}, {$$arity: 0, $$s: self}), 'gsub', [/(%[-+.\d]*)t/], function $$15(){var $c, self = $$15.$$s == null ? this : $$15.$$s;

          return (("" + ((($c = $gvars['~']) === nil ? nil : $c['$[]'](1)))) + "f")['$%'](self.$total())}, {$$arity: 0, $$s: self}), 'gsub', [/(%[-+.\d]*)r/], function $$16(){var $c, self = $$16.$$s == null ? this : $$16.$$s;

          return ((("(") + ((($c = $gvars['~']) === nil ? nil : $c['$[]'](1)))) + "f)")['$%'](self.$real())}, {$$arity: 0, $$s: self});
        if ($truthy(format)) {
          return str['$%'](args)
        } else {
          return str
