Opal.modules["observer"] = function(Opal) {/* Generated by Opal 1.4.0.alpha1 */
  var $nesting = [], nil = Opal.nil, $module = Opal.module, $truthy = Opal.truthy, $hash2 = Opal.hash2, $send = Opal.send, $to_a = Opal.to_a, $rb_minus = Opal.rb_minus, $def = Opal.def;
  ...
  return (function($base, $parent_nesting) {
    ...
    $def(self, '$add_observer', function $$add_observer(observer, func) {
      ...
      $send(self.observer_peers, '[]=', $to_a($writer));
