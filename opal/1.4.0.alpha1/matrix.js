Opal.modules["e2mmap"] = function(Opal) {/* Generated by Opal 1.4.0.alpha1 */
  ...
  return (function($base, $parent_nesting) {
    ...
    $defs($$('E2MM'), '$Raise', function $$Raise($a, $b, $c) {
      ...
      if ($truthy((form = self.$e2mm_message(klass, err)))) {
        ...
        if ($truthy(b['$[]'](0)['$=~']($regexp(["^", $$('Regexp').$quote($enc("./e2mmap.rb", "US-ASCII")), ":"])))) {
          b.$shift()
        };
...
Opal.modules["matrix/eigenvalue_decomposition"] = function(Opal) {/* Generated by Opal 1.4.0.alpha1 */
...
Opal.modules["matrix/lup_decomposition"] = function(Opal) {/* Generated by Opal 1.4.0.alpha1 */
...
Opal.modules["matrix"] = function(Opal) {/* Generated by Opal 1.4.0.alpha1 */
