...
Opal.modules["erb"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return (function($base, $parent_nesting) {
      function $Util() {};
      var self = $Util = $module($base, 'Util', $Util);

      var def = self.prototype, $nesting = [self].concat($parent_nesting), TMP_Util_html_escape_1;

      
      var escapes = { '&': '&amp;', '<': '&lt;', '>': '&gt;', '"': '&quot;', "'": '&#39;'};;
      var escape_regexp = /[&<>"']/g;;
      
      Opal.def(self, '$html_escape', TMP_Util_html_escape_1 = function $$html_escape(str) {
        var self = this;
