...
Opal.modules["bigdecimal/kernel"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    var def = self.prototype, $nesting = [self].concat($parent_nesting), TMP_Kernel_BigDecimal_1;

    
    Opal.def(self, '$BigDecimal', TMP_Kernel_BigDecimal_1 = function $$BigDecimal(initial, digits) {
      var self = this;
...
Opal.modules["bigdecimal"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$initialize', TMP_BigDecimal_initialize_3 = function $$initialize(initial, digits) {
      var self = this;
    ...
    Opal.def(self, '$==', TMP_BigDecimal_$eq$eq_4 = function(other) {
    ...
    Opal.def(self, '$<=>', TMP_BigDecimal_$lt$eq$gt_5 = function(other) {
    ...
    Opal.def(self, '$<', TMP_BigDecimal_$lt_6 = function(other) {
      var $a, $b, $iter = TMP_BigDecimal_$lt_6.$$p, $yield = $iter || nil, self = this, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;
    ...
    Opal.def(self, '$<=', TMP_BigDecimal_$lt$eq_7 = function(other) {
      var $a, $b, $iter = TMP_BigDecimal_$lt$eq_7.$$p, $yield = $iter || nil, self = this, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;
    ...
    Opal.def(self, '$>', TMP_BigDecimal_$gt_8 = function(other) {
      var $a, $b, $iter = TMP_BigDecimal_$gt_8.$$p, $yield = $iter || nil, self = this, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;
    ...
    Opal.def(self, '$>=', TMP_BigDecimal_$gt$eq_9 = function(other) {
      var $a, $b, $iter = TMP_BigDecimal_$gt$eq_9.$$p, $yield = $iter || nil, self = this, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;
    ...
    Opal.def(self, '$abs', TMP_BigDecimal_abs_10 = function $$abs() {
      var self = this;

      return self.$class().$new(self.$bignumber().abs())
    }, TMP_BigDecimal_abs_10.$$arity = 0);
    
    Opal.def(self, '$add', TMP_BigDecimal_add_11 = function $$add(other, digits) {
    ...
    Opal.def(self, '$ceil', TMP_BigDecimal_ceil_12 = function $$ceil(n) {
      var self = this;
    ...
    Opal.def(self, '$coerce', TMP_BigDecimal_coerce_13 = function $$coerce(other) {
      var self = this, $case = nil;
    ...
    Opal.def(self, '$div', TMP_BigDecimal_div_14 = function $$div(other, digits) {
    ...
    Opal.def(self, '$finite?', TMP_BigDecimal_finite$q_15 = function() {
      var self = this;

      return self.$bignumber().isFinite()
    }, TMP_BigDecimal_finite$q_15.$$arity = 0);
    
    Opal.def(self, '$infinite?', TMP_BigDecimal_infinite$q_16 = function() {
      var $a, self = this;
    ...
    Opal.def(self, '$minus', TMP_BigDecimal_minus_17 = function $$minus(other) {
      var $a, $b, self = this, _ = nil;
    ...
    Opal.def(self, '$mult', TMP_BigDecimal_mult_18 = function $$mult(other, digits) {
      var $a, $b, self = this, _ = nil;
    ...
    Opal.def(self, '$nan?', TMP_BigDecimal_nan$q_19 = function() {
      var self = this;

      return self.$bignumber().isNaN()
    }, TMP_BigDecimal_nan$q_19.$$arity = 0);
    
    Opal.def(self, '$quo', TMP_BigDecimal_quo_20 = function $$quo(other) {
      var $a, $b, self = this, _ = nil;
    ...
    Opal.def(self, '$sign', TMP_BigDecimal_sign_21 = function $$sign() {
      var self = this;
    ...
    Opal.def(self, '$sub', TMP_BigDecimal_sub_22 = function $$sub(other, precision) {
      var $a, $b, self = this, _ = nil;
    ...
    Opal.def(self, '$to_f', TMP_BigDecimal_to_f_23 = function $$to_f() {
      var self = this;

      return self.$bignumber().toNumber()
    }, TMP_BigDecimal_to_f_23.$$arity = 0);
    
    Opal.def(self, '$to_s', TMP_BigDecimal_to_s_24 = function $$to_s(s) {
      var self = this;
    ...
    return (Opal.def(self, '$zero?', TMP_BigDecimal_zero$q_25 = function() {
      var self = this;
