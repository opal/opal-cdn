Opal.modules["promise/v2"] = function(Opal) {/* Generated by Opal 1.6.0.alpha1 */
...
Opal.modules["await"] = function(Opal) {/* Generated by Opal 1.6.0.alpha1 */
  var $coerce_to = Opal.coerce_to, $truthy = Opal.truthy, $klass = Opal.klass, $rb_lt = Opal.rb_lt, $rb_plus = Opal.rb_plus, $def = Opal.def, $module = Opal.module, $send = Opal.send, $to_a = Opal.to_a, $gvars = Opal.gvars, $rb_times = Opal.rb_times, $alias = Opal.alias, $slice = Opal.slice, $Kernel = Opal.Kernel, self = Opal.top, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$;

  Opal.add_stubs('warn,require,<,<<,await,[],+,when,map,to_proc,empty?,pop,call,new,proc,resolve,*,itself,async?,raise');
