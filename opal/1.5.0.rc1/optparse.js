Opal.modules["optparse/version"] = function(Opal) {/* Generated by Opal 1.5.0.rc1 */
...
Opal.modules["shellwords"] = function(Opal) {/* Generated by Opal 1.5.0.rc1 */
...
Opal.modules["optparse"] = function(Opal) {/* Generated by Opal 1.5.0.rc1 */
  ...
  (function($base, $super, $parent_nesting) {
        ...
        if ($truthy(self["short"])) {
          $send(self["short"], 'each', [], function $$5(s){var $b;
            ...
            $send(sdone, 'fetch', [s], function $$6(){
              return sopts['$<<'](s)}, 0);
            return ($b = [s, true], $send(sdone, '[]=', $b), $b[$b.length - 1]);}, 1)
        };
        if ($truthy(self["long"])) {
          $send(self["long"], 'each', [], function $$7(s){var $b;
            ...
            $send(ldone, 'fetch', [s], function $$8(){
              return lopts['$<<'](s)}, 0);
            return ($b = [s, true], $send(ldone, '[]=', $b), $b[$b.length - 1]);}, 1)
        };
      ...
      $def(self, '$update', function $$update(sw, sopts, lopts, nsw, nlopts) {
        ...
        if ($truthy(sopts)) {
          $send(sopts, 'each', [], function $$15(o){var $a, self = $$15.$$s == null ? this : $$15.$$s;
            ...
            if (o == null) o = nil;;
            return ($a = [o, sw], $send(self["short"], '[]=', $a), $a[$a.length - 1]);}, {$$arity: 1, $$s: self})
        };
        if ($truthy(lopts)) {
          $send(lopts, 'each', [], function $$16(o){var $a, self = $$16.$$s == null ? this : $$16.$$s;
            ...
            if (o == null) o = nil;;
            return ($a = [o, sw], $send(self["long"], '[]=', $a), $a[$a.length - 1]);}, {$$arity: 1, $$s: self})
        };
        if (($truthy(nsw) && ($truthy(nlopts)))) {
          $send(nlopts, 'each', [], function $$17(o){var $a, self = $$17.$$s == null ? this : $$17.$$s;
            ...
            if (o == null) o = nil;;
            return ($a = [o, nsw], $send(self["long"], '[]=', $a), $a[$a.length - 1]);}, {$$arity: 1, $$s: self})
        };
    ...
    $send($$('NoArgument'), 'each', [], function $OptionParser$26(el){var $a;
      ...
      if (el == null) el = nil;;
      return ($a = [el, $$$($$('Switch'), 'NoArgument')], $send($$('ArgumentStyle'), '[]=', $a), $a[$a.length - 1]);}, 1);
    $send($$('RequiredArgument'), 'each', [], function $OptionParser$27(el){var $a;

      
      
      if (el == null) el = nil;;
      return ($a = [el, $$$($$('Switch'), 'RequiredArgument')], $send($$('ArgumentStyle'), '[]=', $a), $a[$a.length - 1]);}, 1);
    $send($$('OptionalArgument'), 'each', [], function $OptionParser$28(el){var $a;

      
      
      if (el == null) el = nil;;
      return ($a = [el, $$$($$('Switch'), 'OptionalArgument')], $send($$('ArgumentStyle'), '[]=', $a), $a[$a.length - 1]);}, 1);
    $$('ArgumentStyle').$freeze();
    $const_set($nesting[0], 'DefaultList', $$('List').$new());
    $$('DefaultList').$short()['$[]=']("-", $send($$$($$('Switch'), 'NoArgument'), 'new', [], $return_val(nil), 0));
    ...
    $def(self, '$compsys', function $$compsys(to, name) {
      ...
      to['$<<']("#compdef " + (name) + "\n");
      to['$<<']($$('COMPSYS_HEADER'));
      $send(self, 'visit', ["compsys", $hash2([], {}), $hash2([], {})], function $$30(o, d){
        ...
        if (($eqeqeq($$('Proc'), ($ret_or_1 = o)) || ($eqeqeq($$('Method'), $ret_or_1)))) {
          ...
          return $send(o, 'each', [], function $$46(pat, $c){var $post_args, v, $d;
            ...
            return ($d = [pat, $send(v, 'fetch', [0], function $$47(){
              return pat}, 0)], $send(pattern, '[]=', $d), $d[$d.length - 1]);}, -2);
    ...
    $def(self, '$order!', function $OptionParser_order$excl$49($a, $b) {
      ...
      delete $OptionParser_order$excl$49.$$p;
      ...
      if ($truthy(into)) {
        setter = $lambda(function $$50(name, val){var $c;
          ...
          if (val == null) val = nil;;
          return ($c = [name.$to_sym(), val], $send(into, '[]=', $c), $c[$c.length - 1]);}, 2)
      };
    ...
    $def(self, '$parse_in_order', function $$parse_in_order(argv, setter) {
      ...
      if ($truthy((arg = $send(self, 'catch', ["terminate"], function $$52(){var $c, $d, $e, self = $$52.$$s == null ? this : $$52.$$s, sw = nil, cb = nil, eq = nil, has_arg = nil, $ret_or_3 = nil;
        if ($gvars["!"] == null) $gvars["!"] = nil;
        ...
        while ($truthy((arg = argv.$shift()))) {
          if ($eqeqeq(/^--([^=]*)(?:=(.*))?/m, ($ret_or_2 = arg))) {
            ...
            try {
              ...
              $e = $send(sw, 'parse', [rest, argv], function $$53($f){var $post_args, exc, self = $$53.$$s == null ? this : $$53.$$s;
            ...
            var $no_errors = true;try {
              $e = $send(sw, 'parse', [val, argv], function $$54($f){var $post_args, exc, self = $$54.$$s == null ? this : $$54.$$s;
    ...
    $def(self, '$search', function $$search(id, key) {
      ...
      retval = nil;
      (function(){var $brk = Opal.new_brk(); try {return $send(self, 'visit', ["search", id, key], function $$63(k){
    ...
    $def(self, '$complete', function $$complete(typ, opt, $a, $b) {try {
      ...
      if ($truthy(pat['$empty?']())) {
        ...
        retval = nil;
        (function(){var $brk = Opal.new_brk(); try {return $send(self, 'search', [typ, opt], function $$64(sw){
      ...
      ambiguous = (function(){var $brk = Opal.new_brk(); try {return $send(self, 'catch', ["ambiguous"], function $$65(){var self = $$65.$$s == null ? this : $$65.$$s;

        
        retval = nil;
        (function(){var $brk = Opal.new_brk(); try {return $send(self, 'visit', ["complete", typ, opt, icase].concat($to_a(pat)), function $$66(o, $c){var $post_args, sw;
    ...
    $def(self, '$load', function $$load(filename) {
      ...
      if (!$truthy(filename)) {
        ...
        basename['$<<'](".options");
        return $send([$$('ENV')['$[]']("XDG_CONFIG_HOME"), "~/.config"].concat($to_a(($a = $$('ENV')['$[]']("XDG_CONFIG_DIRS"), ($a === nil || $a == null) ? nil : $$('ENV')['$[]']("XDG_CONFIG_DIRS").$split($$$($$('File'), 'PATH_SEPARATOR'))))).concat(["~/config/settings"]), 'any?', [], function $$71(dir){var self = $$71.$$s == null ? this : $$71.$$s;
    ...
    $send(self, 'accept', [$$('String'), /.+/m], function $OptionParser$74(s, $a){var $post_args, $rest_arg;
    ...
    $send(["-", "no", "false"], 'each', [], function $OptionParser$81(el){var $a;
      ...
      if (el == null) el = nil;;
      return ($a = [el, false], $send(yesno, '[]=', $a), $a[$a.length - 1]);}, 1);
    $send(["+", "yes", "true"], 'each', [], function $OptionParser$82(el){var $a;

      
      
      if (el == null) el = nil;;
      return ($a = [el, true], $send(yesno, '[]=', $a), $a[$a.length - 1]);}, 1);
    yesno['$[]=']("nil", false);
    ...
    (function($base, $parent_nesting) {
      ...
      $def(self, '$order!', function $Arguable_order$excl$89() {
        ...
        delete $Arguable_order$excl$89.$$p;
