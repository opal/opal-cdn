Opal.modules["forwardable"] = function(Opal) {/* Generated by Opal 1.5.0.rc1 */
...
Opal.modules["date/infinity"] = function(Opal) {/* Generated by Opal 1.5.0.rc1 */
  var $nesting = [], nil = Opal.nil, $$$ = Opal.$$$, $klass = Opal.klass, $def = Opal.def, $return_val = Opal.return_val, $eqeqeq = Opal.eqeqeq, $to_ary = Opal.to_ary, $send2 = Opal.send2, $find_super = Opal.find_super, $eqeq = Opal.eqeq, $truthy = Opal.truthy, $rb_gt = Opal.rb_gt;
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return (function($base, $super, $parent_nesting) {
      ...
      $def(self, '$zero?', $return_val(false), 0);
      
      $def(self, '$finite?', $return_val(false), 0);
...
Opal.modules["date/date_time"] = function(Opal) {/* Generated by Opal 1.5.0.rc1 */
  var $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $$$ = Opal.$$$, $klass = Opal.klass, $def = Opal.def, $alias = Opal.alias, $rb_divide = Opal.rb_divide, $rb_times = Opal.rb_times, $rb_plus = Opal.rb_plus, $rb_minus = Opal.rb_minus, $truthy = Opal.truthy, $return_self = Opal.return_self;
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$to_datetime', $return_self, 0);
...
Opal.modules["date/formatters"] = function(Opal) {/* Generated by Opal 1.5.0.rc1 */
...
Opal.modules["date"] = function(Opal) {/* Generated by Opal 1.5.0.rc1 */
  ...
  (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$to_date', $return_self, 0);
    ...
    $def(self, '$to_n', $return_ivar("date"), 0);
...
Opal.modules["time"] = function(Opal) {/* Generated by Opal 1.5.0.rc1 */
  var self = Opal.top, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$, $klass = Opal.klass, $defs = Opal.defs, $hash2 = Opal.hash2, $send = Opal.send, $eqeqeq = Opal.eqeqeq, $truthy = Opal.truthy, $rb_gt = Opal.rb_gt, $rb_plus = Opal.rb_plus, $alias = Opal.alias, $def = Opal.def, $return_self = Opal.return_self;
  ...
  (function($base, $super, $parent_nesting) {
    ...
    return $def(self, '$to_time', $return_self, 0);
  })($nesting[0], null, $nesting);
