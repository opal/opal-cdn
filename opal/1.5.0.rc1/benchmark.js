Opal.modules["benchmark"] = function(Opal) {/* Generated by Opal 1.5.0.rc1 */
  var $nesting = [], nil = Opal.nil, $$$ = Opal.$$$, $module = Opal.module, $const_set = Opal.const_set, $truthy = Opal.truthy, $rb_plus = Opal.rb_plus, $rb_times = Opal.rb_times, $send = Opal.send, $def = Opal.def, $to_a = Opal.to_a, $to_ary = Opal.to_ary, $rb_minus = Opal.rb_minus, $klass = Opal.klass, $rb_lt = Opal.rb_lt, $alias = Opal.alias, $gvars = Opal.gvars, $hash2 = Opal.hash2, $eqeqeq = Opal.eqeqeq;
