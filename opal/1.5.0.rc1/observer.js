Opal.modules["observer"] = function(Opal) {/* Generated by Opal 1.5.0.rc1 */
  var $nesting = [], nil = Opal.nil, $module = Opal.module, $truthy = Opal.truthy, $hash2 = Opal.hash2, $send = Opal.send, $def = Opal.def, $to_a = Opal.to_a;
