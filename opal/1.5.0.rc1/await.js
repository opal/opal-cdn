Opal.modules["promise/v2"] = function(Opal) {/* Generated by Opal 1.5.0.rc1 */
...
Opal.modules["await"] = function(Opal) {/* Generated by Opal 1.5.0.rc1 */
  ...
  Opal.add_stubs('warn,require,<,<<,[],+,map_await,to_proc,when,map,empty?,pop,call,new,proc,resolve,*,itself,async?');
