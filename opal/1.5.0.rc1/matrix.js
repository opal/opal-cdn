Opal.modules["e2mmap"] = function(Opal) {/* Generated by Opal 1.5.0.rc1 */
  var $nesting = [], nil = Opal.nil, $module = Opal.module, $const_set = Opal.const_set, $send2 = Opal.send2, $find_super = Opal.find_super, $truthy = Opal.truthy, $rb_lt = Opal.rb_lt, $defs = Opal.defs, $send = Opal.send, $to_a = Opal.to_a, $def = Opal.def, $alias = Opal.alias, $hash2 = Opal.hash2, $gvars = Opal.gvars, $regexp = Opal.regexp;
...
Opal.modules["matrix/eigenvalue_decomposition"] = function(Opal) {/* Generated by Opal 1.5.0.rc1 */
  var $nesting = [], nil = Opal.nil, $$$ = Opal.$$$, $klass = Opal.klass, $truthy = Opal.truthy, $send = Opal.send, $def = Opal.def, $alias = Opal.alias, $eqeq = Opal.eqeq, $to_a = Opal.to_a, $rb_gt = Opal.rb_gt, $rb_plus = Opal.rb_plus, $rb_minus = Opal.rb_minus, $rb_divide = Opal.rb_divide, $rb_times = Opal.rb_times, $neqeq = Opal.neqeq, $rb_lt = Opal.rb_lt, $rb_le = Opal.rb_le, $rb_ge = Opal.rb_ge, $to_ary = Opal.to_ary;
          ...
          if ($eqeq(scale, 0.0)) {
            ...
            $send(i, 'times', [], function $$18(j){var $a, self = $$18.$$s == null ? this : $$18.$$s;
              ...
              $send(j, 'upto', [$rb_minus(i, 1)], function $$19(k){var $a, self = $$19.$$s == null ? this : $$19.$$s, $binary_op_recvr_tmp_3 = nil;
                ...
                return ($a = [j, $rb_minus($binary_op_recvr_tmp_3['$[]'](j), $rb_plus($rb_times(f, self.e['$[]'](k)), $rb_times(g, self.d['$[]'](k))))], $send($binary_op_recvr_tmp_3, '[]=', $a), $a[$a.length - 1]);}, {$$arity: 1, $$s: self});
              self.d['$[]='](j, self.v['$[]']($rb_minus(i, 1))['$[]'](j));
          ...
          if ($neqeq(h, 0.0)) {
            ...
            $send((0), 'upto', [i], function $$22(j){var self = $$22.$$s == null ? this : $$22.$$s, g = nil;
              ...
              return $send((0), 'upto', [i], function $$24(k){var $a, self = $$24.$$s == null ? this : $$24.$$s, $binary_op_recvr_tmp_4 = nil;
                ...
                return ($a = [j, $rb_minus($binary_op_recvr_tmp_4['$[]'](j), $rb_times(g, self.d['$[]'](k)))], $send($binary_op_recvr_tmp_4, '[]=', $a), $a[$a.length - 1]);}, {$$arity: 1, $$s: self});}, {$$arity: 1, $$s: self});
          };
        ...
        $send(self.size, 'times', [], function $$28(l){var $a, self = $$28.$$s == null ? this : $$28.$$s, m = nil, iter = nil, g = nil, p = nil, r = nil, dl1 = nil, h = nil, c = nil, c2 = nil, c3 = nil, el1 = nil, s = nil, s2 = nil;
          ...
          if ($truthy($rb_gt(m, l))) {
            ...
            do {
              ...
              $send($rb_plus(l, 2), 'upto', [$rb_minus(self.size, 1)], function $$29(i){var $b, self = $$29.$$s == null ? this : $$29.$$s;
                if (self.d == null) self.d = nil;

                
                
                if (i == null) i = nil;;
                return ($b = [i, $rb_minus(self.d['$[]'](i), h)], $send(self.d, '[]=', $b), $b[$b.length - 1]);}, {$$arity: 1, $$s: self});
              f = $rb_plus(f, h);
              p = self.d['$[]'](m);
              c = 1.0;
              c2 = c;
              ...
              $send($rb_minus(m, 1), 'downto', [l], function $$30(i){var self = $$30.$$s == null ? this : $$30.$$s;
                ...
                return $send(self.size, 'times', [], function $$31(k){var $b, self = $$31.$$s == null ? this : $$31.$$s;
                  if (self.v == null) self.v = nil;
                  ...
                  return ($b = [i, $rb_minus($rb_times(c, self.v['$[]'](k)['$[]'](i)), $rb_times(s, h))], $send(self.v['$[]'](k), '[]=', $b), $b[$b.length - 1]);}, {$$arity: 1, $$s: self});}, {$$arity: 1, $$s: self});
          ...
          if ($neqeq(scale, 0.0)) {
            ...
            $send(m, 'upto', [$rb_minus(self.size, 1)], function $$38(j){var self = $$38.$$s == null ? this : $$38.$$s, f = nil;
              ...
              return $send(m, 'upto', [high], function $$40(i){var $a, self = $$40.$$s == null ? this : $$40.$$s, $binary_op_recvr_tmp_5 = nil;
                ...
                return ($a = [j, $rb_minus($binary_op_recvr_tmp_5['$[]'](j), $rb_times(f, self.ort['$[]'](i)))], $send($binary_op_recvr_tmp_5, '[]=', $a), $a[$a.length - 1]);}, {$$arity: 1, $$s: self});}, {$$arity: 1, $$s: self});
            $send((0), 'upto', [high], function $$41(i){var self = $$41.$$s == null ? this : $$41.$$s, f = nil;
              ...
              return $send(m, 'upto', [high], function $$43(j){var $a, self = $$43.$$s == null ? this : $$43.$$s, $binary_op_recvr_tmp_6 = nil;
                ...
                return ($a = [j, $rb_minus($binary_op_recvr_tmp_6['$[]'](j), $rb_times(f, self.ort['$[]'](j)))], $send($binary_op_recvr_tmp_6, '[]=', $a), $a[$a.length - 1]);}, {$$arity: 1, $$s: self});}, {$$arity: 1, $$s: self});
          ...
          if ($neqeq(self.h['$[]'](m)['$[]']($rb_minus(m, 1)), 0.0)) {
            ...
            return $send(m, 'upto', [high], function $$48(j){var self = $$48.$$s == null ? this : $$48.$$s, g = nil;
              ...
              return $send(m, 'upto', [high], function $$50(i){var $a, self = $$50.$$s == null ? this : $$50.$$s, $binary_op_recvr_tmp_7 = nil;
                ...
                return ($a = [j, $rb_plus($binary_op_recvr_tmp_7['$[]'](j), $rb_times(g, self.ort['$[]'](i)))], $send($binary_op_recvr_tmp_7, '[]=', $a), $a[$a.length - 1]);}, {$$arity: 1, $$s: self});}, {$$arity: 1, $$s: self});
          } else {
            return nil
          };}, {$$arity: 1, $$s: self});
      }, 0);
      return $def(self, '$hessenberg_to_real_schur', function $$hessenberg_to_real_schur() {
        var $a, $b, self = this, nn = nil, n = nil, low = nil, high = nil, eps = nil, exshift = nil, p = nil, q = nil, r = nil, s = nil, z = nil, norm = nil, iter = nil, l = nil, w = nil, x = nil, y = nil, m = nil;
        ...
        while ($truthy($rb_ge(n, low))) {
          ...
          if ($eqeq(l, n)) {
            ...
            if ($truthy($rb_ge(q, 0))) {
              ...
              p = $rb_divide(p, r);
              q = $rb_divide(q, r);
              $send($rb_minus(n, 1), 'upto', [$rb_minus(nn, 1)], function $$53(j){var $c, self = $$53.$$s == null ? this : $$53.$$s;
                if (self.h == null) self.h = nil;
                ...
                return ($c = [j, $rb_minus($rb_times(q, self.h['$[]'](n)['$[]'](j)), $rb_times(p, z))], $send(self.h['$[]'](n), '[]=', $c), $c[$c.length - 1]);}, {$$arity: 1, $$s: self});
              $send((0), 'upto', [n], function $$54(i){var $c, self = $$54.$$s == null ? this : $$54.$$s;
                if (self.h == null) self.h = nil;
                ...
                return ($c = [n, $rb_minus($rb_times(q, self.h['$[]'](i)['$[]'](n)), $rb_times(p, z))], $send(self.h['$[]'](i), '[]=', $c), $c[$c.length - 1]);}, {$$arity: 1, $$s: self});
              $send(low, 'upto', [high], function $$55(i){var $c, self = $$55.$$s == null ? this : $$55.$$s;
                if (self.v == null) self.v = nil;
                ...
                return ($c = [n, $rb_minus($rb_times(q, self.v['$[]'](i)['$[]'](n)), $rb_times(p, z))], $send(self.v['$[]'](i), '[]=', $c), $c[$c.length - 1]);}, {$$arity: 1, $$s: self});
            } else {
            ...
            if ($eqeq(iter, 10)) {
              ...
              $send(low, 'upto', [n], function $$56(i){var $c, self = $$56.$$s == null ? this : $$56.$$s, $binary_op_recvr_tmp_8 = nil;
                if (self.h == null) self.h = nil;
                ...
                return ($c = [i, $rb_minus($binary_op_recvr_tmp_8['$[]'](i), x)], $send($binary_op_recvr_tmp_8, '[]=', $c), $c[$c.length - 1]);}, {$$arity: 1, $$s: self});
            ...
            if ($eqeq(iter, 30)) {
              ...
              if ($truthy($rb_gt(s, 0))) {
                ...
                $send(low, 'upto', [n], function $$57(i){var $c, self = $$57.$$s == null ? this : $$57.$$s, $binary_op_recvr_tmp_9 = nil;
                  if (self.h == null) self.h = nil;
                  ...
                  return ($c = [i, $rb_minus($binary_op_recvr_tmp_9['$[]'](i), s)], $send($binary_op_recvr_tmp_9, '[]=', $c), $c[$c.length - 1]);}, {$$arity: 1, $$s: self});
            ...
            $send($rb_plus(m, 2), 'upto', [n], function $$58(i){var $c, self = $$58.$$s == null ? this : $$58.$$s;
              if (self.h == null) self.h = nil;
              ...
              if ($truthy($rb_gt(i, $rb_plus(m, 2)))) {
                return ($c = [$rb_minus(i, 3), 0.0], $send(self.h['$[]'](i), '[]=', $c), $c[$c.length - 1])
              } else {
                return nil
              };}, {$$arity: 1, $$s: self});
            $send(m, 'upto', [$rb_minus(n, 1)], function $$59(k){var self = $$59.$$s == null ? this : $$59.$$s, notlast = nil;
              ...
              if ($neqeq(s, 0)) {
                ...
                q = $rb_divide(q, p);
                r = $rb_divide(r, p);
                $send(k, 'upto', [$rb_minus(nn, 1)], function $$60(j){var $c, self = $$60.$$s == null ? this : $$60.$$s;
                  if (self.h == null) self.h = nil;
                  ...
                  return ($c = [j, $rb_minus(self.h['$[]']($rb_plus(k, 1))['$[]'](j), $rb_times(p, y))], $send(self.h['$[]']($rb_plus(k, 1)), '[]=', $c), $c[$c.length - 1]);}, {$$arity: 1, $$s: self});
                $send((0), 'upto', [[n, $rb_plus(k, 3)].$min()], function $$61(i){var $c, self = $$61.$$s == null ? this : $$61.$$s;
                  if (self.h == null) self.h = nil;
                  ...
                  return ($c = [$rb_plus(k, 1), $rb_minus(self.h['$[]'](i)['$[]']($rb_plus(k, 1)), $rb_times(p, q))], $send(self.h['$[]'](i), '[]=', $c), $c[$c.length - 1]);}, {$$arity: 1, $$s: self});
                return $send(low, 'upto', [high], function $$62(i){var $c, self = $$62.$$s == null ? this : $$62.$$s;
                  if (self.v == null) self.v = nil;
                  ...
                  return ($c = [$rb_plus(k, 1), $rb_minus(self.v['$[]'](i)['$[]']($rb_plus(k, 1)), $rb_times(p, q))], $send(self.v['$[]'](i), '[]=', $c), $c[$c.length - 1]);}, {$$arity: 1, $$s: self});
              } else {
                return nil
              };}, {$$arity: 1, $$s: self});
          };
          ...
          if ($eqeq(q, 0)) {
            ...
            return $send($rb_minus(k, 1), 'downto', [0], function $$64(i){var self = $$64.$$s == null ? this : $$64.$$s, t = nil;
              ...
              if ($truthy($rb_lt(self.e['$[]'](i), 0.0))) {
                ...
                if ($truthy($rb_gt($rb_times($rb_times(eps, t), t), 1))) {
                  return $send(i, 'upto', [k], function $$66(j){var $c, self = $$66.$$s == null ? this : $$66.$$s;
                    if (self.h == null) self.h = nil;

                    
                    
                    if (j == null) j = nil;;
                    return ($c = [k, $rb_divide(self.h['$[]'](j)['$[]'](k), t)], $send(self.h['$[]'](j), '[]=', $c), $c[$c.length - 1]);}, {$$arity: 1, $$s: self})
                } else {
                  return nil
                };
              };}, {$$arity: 1, $$s: self});
            ...
            return $send($rb_minus(n, 2), 'downto', [0], function $$67(i){var $e, $f, self = $$67.$$s == null ? this : $$67.$$s, ra = nil, sa = nil, vr = nil, vi = nil, t = nil;
              ...
              if ($truthy($rb_lt(self.e['$[]'](i), 0.0))) {
                ...
                if ($truthy($rb_gt($rb_times($rb_times(eps, t), t), 1))) {
                  return $send(i, 'upto', [n], function $$69(j){var $g, self = $$69.$$s == null ? this : $$69.$$s;
                    if (self.h == null) self.h = nil;
                    ...
                    return ($g = [n, $rb_divide(self.h['$[]'](j)['$[]'](n), t)], $send(self.h['$[]'](j), '[]=', $g), $g[$g.length - 1]);}, {$$arity: 1, $$s: self})
                } else {
                  return nil
                };
              };}, {$$arity: 1, $$s: self});
        ...
        $send(nn, 'times', [], function $$70(i){var self = $$70.$$s == null ? this : $$70.$$s;
          ...
          if (i == null) i = nil;;
          if (($truthy($rb_lt(i, low)) || ($truthy($rb_gt(i, high))))) {
            return $send(i, 'upto', [$rb_minus(nn, 1)], function $$71(j){var $c, self = $$71.$$s == null ? this : $$71.$$s;
              if (self.h == null) self.h = nil;
              if (self.v == null) self.v = nil;
              ...
              if (j == null) j = nil;;
              return ($c = [j, self.h['$[]'](i)['$[]'](j)], $send(self.v['$[]'](i), '[]=', $c), $c[$c.length - 1]);}, {$$arity: 1, $$s: self})
          } else {
            return nil
          };}, {$$arity: 1, $$s: self});
        return $send($rb_minus(nn, 1), 'downto', [low], function $$72(j){var self = $$72.$$s == null ? this : $$72.$$s;
          ...
          if (j == null) j = nil;;
          return $send(low, 'upto', [high], function $$73(i){var $c, self = $$73.$$s == null ? this : $$73.$$s;
            if (self.v == null) self.v = nil;
            ...
            return ($c = [j, z], $send(self.v['$[]'](i), '[]=', $c), $c[$c.length - 1]);}, {$$arity: 1, $$s: self});}, {$$arity: 1, $$s: self});
      }, 0);
    })($nesting[0], null, $nesting)
  })($nesting[0], null, $nesting)
};

Opal.modules["matrix/lup_decomposition"] = function(Opal) {/* Generated by Opal 1.5.0.rc1 */
  var $nesting = [], nil = Opal.nil, $$$ = Opal.$$$, $klass = Opal.klass, $send = Opal.send, $truthy = Opal.truthy, $rb_gt = Opal.rb_gt, $eqeq = Opal.eqeq, $def = Opal.def, $rb_le = Opal.rb_le, $neqeq = Opal.neqeq, $rb_times = Opal.rb_times, $rb_plus = Opal.rb_plus, $rb_minus = Opal.rb_minus, $to_a = Opal.to_a, $rb_lt = Opal.rb_lt;
          ...
          $send(self.column_count, 'times', [], function $$9(k){var self = $$9.$$s == null ? this : $$9.$$s;
            ...
            return $send($rb_plus(k, 1), 'upto', [$rb_minus(self.column_count, 1)], function $$10(i){var self = $$10.$$s == null ? this : $$10.$$s;
              ...
              return $send(nx, 'times', [], function $$11(j){var $a, self = $$11.$$s == null ? this : $$11.$$s, $binary_op_recvr_tmp_10 = nil;
                ...
                return ($a = [j, $rb_minus($binary_op_recvr_tmp_10['$[]'](j), $rb_times(m['$[]'](k)['$[]'](j), self.lu['$[]'](i)['$[]'](k)))], $send($binary_op_recvr_tmp_10, '[]=', $a), $a[$a.length - 1]);}, {$$arity: 1, $$s: self});}, {$$arity: 1, $$s: self});}, {$$arity: 1, $$s: self});
          $send($rb_minus(self.column_count, 1), 'downto', [0], function $$12(k){var self = $$12.$$s == null ? this : $$12.$$s;
            ...
            return $send(k, 'times', [], function $$14(i){var self = $$14.$$s == null ? this : $$14.$$s;
              ...
              return $send(nx, 'times', [], function $$15(j){var $a, self = $$15.$$s == null ? this : $$15.$$s, $binary_op_recvr_tmp_11 = nil;
                ...
                return ($a = [j, $rb_minus($binary_op_recvr_tmp_11['$[]'](j), $rb_times(m['$[]'](k)['$[]'](j), self.lu['$[]'](i)['$[]'](k)))], $send($binary_op_recvr_tmp_11, '[]=', $a), $a[$a.length - 1]);}, {$$arity: 1, $$s: self});}, {$$arity: 1, $$s: self});}, {$$arity: 1, $$s: self});
...
Opal.modules["matrix"] = function(Opal) {/* Generated by Opal 1.5.0.rc1 */
  var self = Opal.top, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$, $module = Opal.module, $klass = Opal.klass, $defs = Opal.defs, $send = Opal.send, $truthy = Opal.truthy, $eqeq = Opal.eqeq, $rb_lt = Opal.rb_lt, $to_a = Opal.to_a, $alias = Opal.alias, $neqeq = Opal.neqeq, $rb_times = Opal.rb_times, $rb_plus = Opal.rb_plus, $def = Opal.def, $rb_ge = Opal.rb_ge, $rb_minus = Opal.rb_minus, $const_set = Opal.const_set, $hash2 = Opal.hash2, $rb_gt = Opal.rb_gt, $to_ary = Opal.to_ary, $rb_le = Opal.rb_le, $not = Opal.not, $eqeqeq = Opal.eqeqeq, $rb_divide = Opal.rb_divide, $return_self = Opal.return_self, $assign_ivar = Opal.assign_ivar;
