Opal.modules["e2mmap"] = function(Opal) {/* Generated by Opal 1.3.1 */
...
Opal.modules["matrix/eigenvalue_decomposition"] = function(Opal) {/* Generated by Opal 1.3.1 */
  function $rb_minus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs - rhs : lhs['$-'](rhs);
  }
...
Opal.modules["matrix/lup_decomposition"] = function(Opal) {/* Generated by Opal 1.3.1 */
  function $rb_gt(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs > rhs : lhs['$>'](rhs);
  }
  function $rb_le(lhs, rhs) {
...
Opal.modules["matrix"] = function(Opal) {/* Generated by Opal 1.3.1 */
  function $rb_lt(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs < rhs : lhs['$<'](rhs);
  }
  function $rb_minus(lhs, rhs) {
