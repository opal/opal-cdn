Opal.modules["corelib/marshal/read_buffer"] = function(Opal) {/* Generated by Opal 1.8.0.beta1 */
  var $module = Opal.module, $klass = Opal.klass, $neqeq = Opal.neqeq, $Kernel = Opal.Kernel, $def = Opal.def, $ensure_kwargs = Opal.ensure_kwargs, $hash_get = Opal.hash_get, $truthy = Opal.truthy, $rb_ge = Opal.rb_ge, $rb_plus = Opal.rb_plus, $eqeq = Opal.eqeq, $rb_divide = Opal.rb_divide, $rb_times = Opal.rb_times, $send = Opal.send, $to_a = Opal.to_a, $Class = Opal.Class, $Module = Opal.Module, $rb_lt = Opal.rb_lt, $Object = Opal.Object, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$;
  ...
  return (function($base, $parent_nesting) {
    ...
    ;
      ...
      $def(self, '$read', function $$read($kwargs) {
        ...
        cache = $hash_get($kwargs, "cache");if (cache == null) cache = true;
        code = self.$read_char();
      ...
      $def(self, '$read_float', function $$read_float() {
        ...
        s = self.$read_string((new Map([["cache", false]])));
      ...
      $def(self, '$read_regexp', function $$read_regexp() {
        ...
        string = self.$read_string((new Map([["cache", false]])));
      ...
      $def(self, '$read_struct', function $$read_struct() {
        ...
        klass_name = self.$read((new Map([["cache", false]])));
        klass = self.$safe_const_get(klass_name);
        attributes = self.$read_hash((new Map([["cache", false]])));
      ...
      $def(self, '$read_class', function $$read_class() {
        ...
        klass_name = self.$read_string((new Map([["cache", false]])));
      ...
      $def(self, '$read_module', function $$read_module() {
        ...
        mod_name = self.$read_string((new Map([["cache", false]])));
      ...
      $def(self, '$read_object', function $$read_object() {
        ...
        ivars = self.$read_hash((new Map([["cache", false]])));
      ...
      $def(self, '$read_primitive_with_ivars', function $$read_primitive_with_ivars() {
        ...
        object = self.$read();
        primitive_ivars = self.$read_hash((new Map([["cache", false]])));
      ...
      $def(self, '$read_user_class', function $$read_user_class() {
        ...
        klass_name = self.$read((new Map([["cache", false]])));
        klass = self.$safe_const_get(klass_name);
        value = self.$read((new Map([["cache", false]])));
      ...
      $def(self, '$read_user_defined', function $$read_user_defined() {
        ...
        klass_name = self.$read((new Map([["cache", false]])));
        klass = self.$safe_const_get(klass_name);
        data = self.$read_string((new Map([["cache", false]])));
      ...
      $def(self, '$read_user_marshal', function $$read_user_marshal() {
        ...
        self.object_cache['$<<'](result);
        data = self.$read((new Map([["cache", false]])));
...
Opal.modules["corelib/marshal/write_buffer"] = function(Opal) {/* Generated by Opal 1.8.0.beta1 */
  ...
  (function($base, $super) {
    ...
    return $def(self, '$__marshal__', function $$__marshal__(buffer) {
      ...
      if (($truthy($rb_ge(self, -1073741824)) && ($truthy($rb_lt(self, 1073741824))))) {
...
Opal.modules["corelib/marshal"] = function(Opal) {/* Generated by Opal 1.8.0.beta1 */
...
Opal.modules["base64"] = function(Opal) {/* Generated by Opal 1.8.0.beta1 */
...
Opal.modules["corelib/pack_unpack/format_string_parser"] = function(Opal) {/* Generated by Opal 1.8.0.beta1 */
...
Opal.modules["corelib/string/unpack"] = function(Opal) {/* Generated by Opal 1.8.0.beta1 */
  var $klass = Opal.klass, $Kernel = Opal.Kernel, $ensure_kwargs = Opal.ensure_kwargs, $hash_get = Opal.hash_get, $truthy = Opal.truthy, $rb_lt = Opal.rb_lt, $Opal = Opal.Opal, $rb_gt = Opal.rb_gt, $def = Opal.def, self = Opal.top, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$;
  ...
  ;
    ...
    return $def(self, '$unpack1', function $$unpack1(format, $kwargs) {
      ...
      offset = $hash_get($kwargs, "offset");if (offset == null) offset = 0;
      format = $Opal['$coerce_to!'](format, $$$('String'), "to_str").$gsub(/\s/, "").$delete("\u0000");
      return self.$unpack(format['$[]'](0), (new Map([["offset", offset]])))['$[]'](0);
    }, -2);
  })('::', null, $nesting);
};

Opal.modules["corelib/array/pack"] = function(Opal) {/* Generated by Opal 1.8.0.beta1 */
...
Opal.modules["corelib/object_space"] = function(Opal) {/* Generated by Opal 1.8.0.beta1 */
  var $respond_to = Opal.respond_to, $truthy = Opal.truthy, $module = Opal.module, $Kernel = Opal.Kernel, $def = Opal.def, $klass = Opal.klass, $send = Opal.send, $slice = Opal.slice, $alias = Opal.alias, nil = Opal.nil, $$$ = Opal.$$$;
  ...
  ;
    ...
    return (function($base, $super) {
      ...
      $def(self, '$initialize', function $$initialize() {
        ...
        return (self.primitive_map = (new Map()));
      });
...
Opal.modules["corelib/pattern_matching/base"] = function(Opal) {/* Generated by Opal 1.8.0.beta1 */
  var $klass = Opal.klass, $return_self = Opal.return_self, $def = Opal.def, $alias = Opal.alias, $truthy = Opal.truthy, $eqeqeq = Opal.eqeqeq, $Kernel = Opal.Kernel, $rb_gt = Opal.rb_gt, $send = Opal.send, $rb_lt = Opal.rb_lt, $thrower = Opal.thrower, nil = Opal.nil, $$$ = Opal.$$$;
...
Opal.modules["corelib/pattern_matching"] = function(Opal) {/* Generated by Opal 1.8.0.beta1 */
        ...
        switch (type.valueOf()) {
          ...
          case "hash":
            ...
            if ($truthy(($ret_or_2 = $send(hash_match, 'all?', [], function $$6(k, v){var self = $$6.$$s == null ? this : $$6.$$s;
              ...
              if (v == null) v = nil;
              if (!$truthy(a['$key?'](k))) {
                $t_return.$throw(false, $$6.$$is_lambda)
              };
...
Opal.modules["corelib/trace_point"] = function(Opal) {/* Generated by Opal 1.8.0.beta1 */
...
Opal.modules["opal/full"] = function(Opal) {/* Generated by Opal 1.8.0.beta1 */
