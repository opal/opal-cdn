...
Opal.modules["nodejs/env"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$, $$ = Opal.$$, $alias = Opal.alias, $truthy = Opal.truthy;

  Opal.add_stubs(['$new', '$to_s', '$key?', '$[]', '$raise']);
  
  Opal.const_set($nesting[0], 'ENV', $$($nesting, 'Object').$new());
  return (function(self, $parent_nesting) {
    var $nesting = [self].concat($parent_nesting), $$$1, $$$eq$2, $key$ques$3, $empty$ques$4, $keys$5, $delete$6, $fetch$7, $to_s$8;
    ...
    return (Opal.def(self, '$to_s', $to_s$8 = function $$to_s() {
      var self = this;

      return "ENV"
    }, $to_s$8.$$arity = 0), nil) && 'to_s';
