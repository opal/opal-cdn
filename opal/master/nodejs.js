...
(function() {
  ...
  return (function($base) {
    ...
    $opal.defs(self, '$require', function(name) {
      var self = this;
...
Opal.modules["nodejs/file"] = function($opal) {
  ...
  $opal.add_stubs(['$join', '$raise', '$message', '$error', '$call', '$exist?']);
  return (function($base, $super) {
    ...
    $opal.defs(self, '$directory?', function(path) {
      ...
      if ((($a = self['$exist?'](path)) !== nil && (!$a._isBoolean || $a == true))) {
        } else {
        return nil
      };
    ...
    return ($opal.defs(self, '$file?', function(path) {
      var $a, self = this;
...
Opal.modules["nodejs/io"] = function($opal) {
  $opal.dynamic_require_severity = "error";
  var $a, $b, TMP_1, $c, TMP_2, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $gvars = $opal.gvars;
  if ($gvars.stdout == null) $gvars.stdout = nil;
  if ($gvars.stderr == null) $gvars.stderr = nil;

  $opal.add_stubs(['$write_proc=', '$lambda']);
  $gvars.stdout['$write_proc='](($a = ($b = self).$lambda, $a._p = (TMP_1 = function(string){var self = TMP_1._s || this;
if (string == null) string = nil;
  return process.stdout.write(string);}, TMP_1._s = self, TMP_1), $a).call($b));
  return $gvars.stderr['$write_proc='](($a = ($c = self).$lambda, $a._p = (TMP_2 = function(string){var self = TMP_2._s || this;
if (string == null) string = nil;
  return process.stderr.write(string);}, TMP_2._s = self, TMP_2), $a).call($c));
};
