...
(function($opal) {
  ...
  return (function($base, $super) {
    ...
    def['$>>'] = function(promise) {
      ...
      } else if ((($a = ($b = self['$rejected?'](), $b !== false && $b !== nil ?(((($c = self.failure['$!']()) !== false && $c !== nil) ? $c : $scope.get('Promise')['$===']((((($d = self.delayed) !== false && $d !== nil) ? $d : self.error))))) : $b)) !== nil && (!$a._isBoolean || $a == true))) {
    ...
    def.$resolve = function(value) {
      ...
      if ((($a = $scope.get('Promise')['$==='](value)) !== nil && (!$a._isBoolean || $a == true))) {
        value['$<<'](self.prev);
        return value['$^'](self);};
    ...
    def.$trace = TMP_4 = function() {
      ...
      TMP_4._p = null;
      return self['$^']($scope.get('Trace').$new(block));
    };
    ...
    (function($base, $super) {
      ...
      return (def.$initialize = TMP_6 = function(block) {
        ...
        return ($a = block).$call.apply($a, [].concat($scope.get('Trace').$it(self).$reverse()))}, TMP_5._s = self, TMP_5), $a).call($b)]);
      }, nil) && 'initialize';
    })(self, self);
...
if (values == null) values = nil;
        return $scope.get('When').$new(($a = ($b = values).$map, $a._p = block.$to_proc(), $a).call($b))}, TMP_12._s = self, TMP_12), $a).call($b);
      };
...
if (values == null) values = nil;
      ...
      def.$wait = function(promise) {
        ...
        if ((($a = $scope.get('Promise')['$==='](promise)) !== nil && (!$a._isBoolean || $a == true))) {
          } else {
