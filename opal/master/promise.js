  ...
  return (function($base, $super, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      return (Opal.def(self, '$initialize', $Trace_initialize$33 = function $$initialize(depth, block) {
        ...
        self.depth = depth;
        return $send2(self, $find_super(self, 'initialize', $Trace_initialize$33, false, true), 'initialize', [$hash2(["success"], {"success": $send(self, 'proc', [], ($$34 = function(){var self = $$34.$$s == null ? this : $$34.$$s, trace = nil, $ret_or_7 = nil;
    ...
    return (function($base, $super, $parent_nesting) {
      ...
      Opal.def(self, '$initialize', $When_initialize$35 = function $$initialize(promises) {
        ...
        $send2(self, $find_super(self, 'initialize', $When_initialize$35, false, true), 'initialize', [], null);
        self.wait = [];
      ...
      Opal.def(self, '$>>', $When_$gt$gt$45 = function($a) {
        ...
        $post_args = Opal.slice.call(arguments, 0, arguments.length);
        ;
        return $send($send2(self, $find_super(self, '>>', $When_$gt$gt$45, false, true), '>>', $zuper, $iter), 'tap', [], ($$46 = function(){var self = $$46.$$s == null ? this : $$46.$$s;
