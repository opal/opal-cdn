...
Opal.modules["console"] = function(Opal) {
  ...
  (function($base, $super, $parent_nesting) {
    ...
    var def = self.prototype, $nesting = [self].concat($parent_nesting), TMP_Console_clear_1, TMP_Console_trace_2, TMP_Console_log_3, TMP_Console_info_4, TMP_Console_warn_5, TMP_Console_error_6, TMP_Console_time_7, TMP_Console_group_8, TMP_Console_group$B_9;

    def["native"] = nil;
    
    self.$include($$$($$($nesting, 'Native'), 'Wrapper'));
    
    Opal.def(self, '$clear', TMP_Console_clear_1 = function $$clear() {
      var self = this;

      return self["native"].clear()
    }, TMP_Console_clear_1.$$arity = 0);
    
    Opal.def(self, '$trace', TMP_Console_trace_2 = function $$trace() {
      var self = this;

      return self["native"].trace()
    }, TMP_Console_trace_2.$$arity = 0);
    
    Opal.def(self, '$log', TMP_Console_log_3 = function $$log($a) {
    ...
    Opal.def(self, '$info', TMP_Console_info_4 = function $$info($a) {
      var $post_args, args, self = this;
    ...
    Opal.def(self, '$warn', TMP_Console_warn_5 = function $$warn($a) {
      var $post_args, args, self = this;
    ...
    Opal.def(self, '$error', TMP_Console_error_6 = function $$error($a) {
      var $post_args, args, self = this;
    ...
    Opal.def(self, '$time', TMP_Console_time_7 = function $$time(label) {
      var $iter = TMP_Console_time_7.$$p, block = $iter || nil, self = this;
    ...
    Opal.def(self, '$group', TMP_Console_group_8 = function $$group($a) {
      var $iter = TMP_Console_group_8.$$p, block = $iter || nil, $post_args, args, self = this;
    ...
    return (Opal.def(self, '$group!', TMP_Console_group$B_9 = function($a) {
      var $iter = TMP_Console_group$B_9.$$p, block = $iter || nil, $post_args, args, self = this;
