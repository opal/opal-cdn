...
Opal.modules["set"] = function($opal) {
  ...
  $opal.add_stubs(['$include', '$new', '$nil?', '$===', '$raise', '$do_with_enum', '$add', '$[]', '$merge', '$join', '$to_a', '$equal?', '$instance_of?', '$class', '$==', '$instance_variable_get', '$is_a?', '$size', '$all?', '$include?', '$[]=', '$enum_for', '$each_key', '$to_proc', '$empty?', '$clear', '$each', '$keys']);
  (function($base, $super) {
    function $Set(){};
    ...
    def.$initialize = TMP_1 = function(enum$) {
      ...
      if ((($a = enum$['$nil?']()) !== nil && (!$a._isBoolean || $a == true))) {
        return nil};
      if ((($a = $scope.get('Enumerable')['$==='](enum$)) !== nil && (!$a._isBoolean || $a == true))) {
        } else {
...
if (o == null) o = nil;
    ...
    def['$=='] = function(other) {
      ...
      } else if ((($a = ($b = other['$is_a?']($scope.get('Set')), $b !== false && $b !== nil ?self.$size()['$=='](other.$size()) : $b)) !== nil && (!$a._isBoolean || $a == true))) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def['$=='] = function(other) {
        ...
        if ((($a = other['$is_a?']($scope.get('Sexp'))) !== nil && (!$a._isBoolean || $a == true))) {
...
if (decl == null) decl = nil;
      return ($a = $scope.get('KeywordTable')).$new.apply($a, [].concat(decl))}, TMP_1._s = self, TMP_1), $a).call($b));
      ...
      $opal.defs(self, '$map', function() {
        ...
        if ((($a = self.map) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          self.map = $hash2([], {});
          ($a = ($b = $scope.get('KEYWORDS')).$each, $a._p = (TMP_2 = function(k){var self = TMP_2._s || this;
            if (self.map == null) self.map = nil;
if (k == null) k = nil;
    ...
    (function($base, $super) {
      ...
      def.$read_escape = function() {
        ...
        if ((($a = self.$scan(/\\/)) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          if ((($a = ($opal.Object._scope.Encoding == null ? nil : 'constant')) !== nil && (!$a._isBoolean || $a == true))) {
            return self.$scanner()['$[]'](1).$to_i(16).$chr((($scope.get('Encoding'))._scope.get('UTF_8')))
            } else {
            return ""
          }
          } else {
      ...
      def.$parse_string = function() {
        ...
        if ((($a = (($b = qwords !== false && qwords !== nil) ? self.$scan(/\s+/) : $b)) !== nil && (!$a._isBoolean || $a == true))) {
          space = true};
        str_buffer = [];
        if ((($a = self.$scan($scope.get('Regexp').$new($scope.get('Regexp').$escape(str_parse['$[]']("term"))))) !== nil && (!$a._isBoolean || $a == true))) {
        ...
        if (space !== false && space !== nil) {
          self['$yylval='](" ");
          return "tSPACE";};
        if ((($a = ($b = str_parse['$[]']("balance"), $b !== false && $b !== nil ?self.$scan($scope.get('Regexp').$new($scope.get('Regexp').$escape(str_parse['$[]']("paren")))) : $b)) !== nil && (!$a._isBoolean || $a == true))) {
          str_buffer['$<<'](self.$scanner().$matched());
          ($a = "nesting", $b = str_parse, $b['$[]=']($a, $b['$[]']($a)['$+'](1)));
      ...
      def.$add_string_content = function(str_buffer, str_parse) {
        ...
        } else if ((($b = ($c = str_parse['$[]']("balance"), $c !== false && $c !== nil ?self.$scan($scope.get('Regexp').$new($scope.get('Regexp').$escape(str_parse['$[]']("paren")))) : $c)) !== nil && (!$b._isBoolean || $b == true))) {
          ($b = "nesting", $c = str_parse, $c['$[]=']($b, $c['$[]']($b)['$+'](1)));
          c = self.$scanner().$matched();
      ...
      def.$process_identifier = function(matched, cmd_start) {
        ...
        if ((($a = ($b = self.lex_state['$==']("expr_dot")['$!'](), $b !== false && $b !== nil ?kw = $scope.get('Keywords').$keyword(matched) : $b)) !== nil && (!$a._isBoolean || $a == true))) {
      ...
      return (def.$yylex = function() {
        ...
        if ((($b = self.$skip(/\ |\t|\r/)) !== nil && (!$b._isBoolean || $b == true))) {
          ...
          self['$strterm='](self.$new_strterm($scope.get('STR_DQUOTE'), "\"", "\x00"));
          return "tSTRING_BEG";
        } else if ((($b = self.$scan(/\'/)) !== nil && (!$b._isBoolean || $b == true))) {
          self['$strterm='](self.$new_strterm($scope.get('STR_SQUOTE'), "'", "\x00"));
          return "tSTRING_BEG";
        } else if ((($b = self.$scan(/\`/)) !== nil && (!$b._isBoolean || $b == true))) {
          self['$strterm='](self.$new_strterm($scope.get('STR_XQUOTE'), "`", "\x00"));
          return "tXSTRING_BEG";
        } else if ((($b = self.$scan(/\&/)) !== nil && (!$b._isBoolean || $b == true))) {
          if ((($b = self.$scan(/\&/)) !== nil && (!$b._isBoolean || $b == true))) {
            self.lex_state = "expr_beg";
          ...
          return ["tAWORDS_BEG", $scope.get('STR_SWORD')];}else if ("x"['$===']($case)) {return ["tXSTRING_BEG", $scope.get('STR_XQUOTE')]}else if ("r"['$===']($case)) {return ["tREGEXP_BEG", $scope.get('STR_REGEXP')]}else { return nil }})()), token = ($b[0] == null ? nil : $b[0]), func = ($b[1] == null ? nil : $b[1]);
          self['$strterm='](self.$new_strterm2(func, term, paren));
          return token;
        } else if ((($b = self.$scan(/\//)) !== nil && (!$b._isBoolean || $b == true))) {
          if ((($b = self['$beg?']()) !== nil && (!$b._isBoolean || $b == true))) {
            self['$strterm='](self.$new_strterm($scope.get('STR_REGEXP'), "/", "/"));
            return "tREGEXP_BEG";
          } else if ((($b = self.$scan(/\=/)) !== nil && (!$b._isBoolean || $b == true))) {
            self.lex_state = "expr_beg";
            return self.$new_op_asgn("/");
          ...
          if ((($b = self.$scan(/\=/)) !== nil && (!$b._isBoolean || $b == true))) {
            ...
            if ((($b = ((($c = self.lex_state['$==']("expr_beg")) !== false && $c !== nil) ? $c : ((($d = self.lex_state['$==']("expr_arg")) ? self.space_seen : $d)))) !== nil && (!$b._isBoolean || $b == true))) {
              ...
              self['$strterm='](self.$new_strterm2($scope.get('STR_DQUOTE'), end_word, start_word));
              return "tSTRING_BEG";}};
          self.$set_arg_state();
          return "tPERCENT";
        } else if ((($b = self.$scan(/\\/)) !== nil && (!$b._isBoolean || $b == true))) {
          ...
          if ((($b = ((($c = self['$end?']()) !== false && $c !== nil) ? $c : self.$check(/\s/))) !== nil && (!$b._isBoolean || $b == true))) {
            ...
            return "tSYMBEG";};
          if ((($b = self.$scan(/\'/)) !== nil && (!$b._isBoolean || $b == true))) {
            self['$strterm='](self.$new_strterm($scope.get('STR_SSYM'), "'", "\x00"))
          } else if ((($b = self.$scan(/\"/)) !== nil && (!$b._isBoolean || $b == true))) {
            self['$strterm='](self.$new_strterm($scope.get('STR_DSYM'), "\"", "\x00"))};
          self.lex_state = "expr_fname";
          return "tSYMBEG";
        } else if ((($b = self.$scan(/\^\=/)) !== nil && (!$b._isBoolean || $b == true))) {
          self.lex_state = "expr_beg";
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$_racc_setup = function() {
        ...
        return ((self.$class())._scope.get('Racc_arg'));
      };
...
if (t == null) t = nil;
      ...
      def.$racc_token2str = function(tok) {
        ...
        return ((self.$class())._scope.get('Racc_token_to_s_table'))['$[]'](tok);
      };
...
Opal.modules["opal/parser/grammar"] = function($opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      racc_action_table = arr = Opal.get('Array').$new(23432, nil);
...
if (i == null) i = nil;
      ...
      racc_action_check = arr = Opal.get('Array').$new(23432, nil);
...
if (i == null) i = nil;
      ...
      racc_goto_table = arr = Opal.get('Array').$new(2625, nil);
...
if (i == null) i = nil;
      ...
      racc_goto_check = arr = Opal.get('Array').$new(2625, nil);
...
if (i == null) i = nil;
    ...
    })(self, (($scope.get('Racc'))._scope.get('Parser')))
...
if (arg == null) arg = nil;
          if ((($a = arg['$is_a?']($scope.get('Symbol'))) !== nil && (!$a._isBoolean || $a == true))) {
              self.$scope().$add_local(arg);
...
if (_opt == null) _opt = nil;
      ...
      def.$new_assignable = function(ref) {
        ...
        ref['$type=']("lasgn");}else if ("gvar"['$===']($case)) {ref['$type=']("gasgn")}else if ("cvar"['$===']($case)) {ref['$type=']("cvdecl")}else {self.$raise($scope.get('SyntaxError'), "Bad new_assignable type: " + (ref.$type()))};
        return ref;
      };
...
if (tmp == null) tmp = nil;
        ...
        def.$js_truthy_optimize = function(sexp) {
          ...
          if (sexp.$type()['$==']("call")) {
            ...
            } else if ((($a = (($scope.get('Compiler'))._scope.get('COMPARE'))['$include?'](mid.$to_s())) !== nil && (!$a._isBoolean || $a == true))) {
              return self.$expr(sexp)
            } else if (mid['$==']("==")) {
              return self.$expr(sexp)
              } else {
...
if (type == null) type = nil;
          return $scope.get('Base').$handlers()['$[]='](type, self)}, TMP_1._s = self, TMP_1), $a).call($b);
        });
...
if (str == null) str = nil;
          if ((($a = str['$is_a?']($scope.get('String'))) !== nil && (!$a._isBoolean || $a == true))) {
...
if (str == null) str = nil;
        ...
        def.$fragment = function(str) {
          ...
          return (($scope.get('Opal'))._scope.get('Fragment')).$new(str, self.sexp);
        };
...
Opal.modules["opal/nodes/literal"] = function($opal) {
  ...
  $opal.add_stubs(['$require', '$handle', '$push', '$to_s', '$type', '$children', '$value', '$recv?', '$wrap', '$inspect', '$===', '$raise', '$new', '$flags', '$each_line', '$==', '$s', '$source=', '$+', '$line', '$include', '$stmt?', '$!', '$include?', '$compile_split_lines', '$needs_semicolon?', '$each_with_index', '$expr', '$[]', '$last', '$each', '$requires_semicolon', '$helper', '$start', '$finish']);
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        return (def.$compile = function() {
          ...
          return self.$raise($scope.get('SyntaxError'), message);}else {return self.$push("" + ($scope.get('Regexp').$new(self.$value()).$inspect()) + (self.$flags()))}})();
        }, nil) && 'compile';
      })(self, $scope.get('Base'));
...
if (part == null) part = nil;if (idx == null) idx = nil;
          if (idx['$=='](0)) {
            ...
            if ((($a = $scope.get('String')['$==='](part)) !== nil && (!$a._isBoolean || $a == true))) {
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        return (def.$compile = function() {
          ...
          self.$push("((");
          self.$push(self.$expr(self.$base()));
          return self.$push(")._scope.get('" + (self.$name()) + "'))");
        }, nil) && 'compile';
      })(self, $scope.get('Base'));
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        def.$compile = function() {
          ...
          if ((($a = $scope.get('HELPERS')['$include?'](self.$meth().$to_sym())) !== nil && (!$a._isBoolean || $a == true))) {
...
Opal.modules["opal/nodes/call"] = function($opal) {
  ...
  $opal.add_stubs(['$require', '$handle', '$children', '$[]=', '$define_method', '$to_proc', '$handle_special', '$compile_default?', '$<<', '$method_calls', '$compiler', '$to_sym', '$meth', '$using_irb?', '$compile_irb_var', '$mid_to_jsid', '$to_s', '$any?', '$==', '$first', '$[]', '$arglist', '$===', '$last', '$type', '$pop', '$iter', '$new_temp', '$scope', '$expr', '$recv', '$recv_sexp', '$s', '$!', '$insert', '$push', '$unshift', '$queue_temp', '$recvr', '$with_temp', '$variable', '$intern', '$irb?', '$top?', '$nil?', '$include?', '$__send__', '$compatible?', '$compile', '$new', '$add_special', '$compile_default!', '$resolve', '$requires', '$fragment', '$class_scope?', '$handle_block_given_call', '$def?', '$inspect', '$mid', '$handle_part', '$map', '$expand_path', '$join', '$split', '$dynamic_require_severity', '$error', '$line', '$warning', '$inject']);
  self.$require("set");
  self.$require("opal/nodes/base");
  ...
  return (function($base) {
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        def.compiler = def.sexp = def.level = def.compile_default = nil;
        self.$handle("call");
        ...
        def.$compile = function() {
          ...
          self.$handle_special();
          if ((($a = self['$compile_default?']()) !== nil && (!$a._isBoolean || $a == true))) {
            } else {
            return nil
          };
...
if (a == null) a = nil;
          ...
          if ((($a = ($c = $scope.get('Sexp')['$==='](self.$arglist().$last()), $c !== false && $c !== nil ?self.$arglist().$last().$type()['$==']("block_pass") : $c)) !== nil && (!$a._isBoolean || $a == true))) {
...
if (tmp == null) tmp = nil;
        ...
        def.$handle_special = function() {
          ...
          if ((($a = $scope.get('SPECIALS')['$include?'](self.$meth())) !== nil && (!$a._isBoolean || $a == true))) {
            self.compile_default = false;
            return self.$__send__("handle_" + (self.$meth()));
          } else if ((($a = $scope.get('RuntimeHelpers')['$compatible?'](self.$recvr(), self.$meth(), self.$arglist())) !== nil && (!$a._isBoolean || $a == true))) {
            self.compile_default = false;
        ...
        self['$compile_default!']();
          ...
          return self.$push(self.$fragment(""));}, TMP_4._s = self, TMP_4), $a).call($b, "require");
        ...
        return self.$push(self.$compiler().$handle_block_given_call(self.sexp))}, TMP_6._s = self, TMP_6), $a).call($d, "block_given?");
        ...
        return self.$push(self.$fragment("debugger"))}, TMP_9._s = self, TMP_9), $a).call($g, "debugger");
...
if (r == null) r = nil;
        ...
        return (def.$compile_and = function() {
          ...
          return ($a = ($b = self).$with_temp, $a._p = (TMP_5 = function(a){var self = TMP_5._s || this, $a, $b, TMP_6;
if (a == null) a = nil;
          return ($a = ($b = self).$with_temp, $a._p = (TMP_6 = function(r){var self = TMP_6._s || this, aref = nil, aset = nil, andop = nil;
if (r == null) r = nil;
            aref = self.$s("call", self.$s("js_tmp", r), "[]", self.$s("arglist", self.$s("js_tmp", a)));
              aset = self.$s("call", self.$s("js_tmp", r), "[]=", self.$s("arglist", self.$s("js_tmp", a), self.$rhs()));
              andop = self.$s("and", aref, aset);
              self.$push("(" + (a) + " = ", self.$expr(self.$first_arg()), ", " + (r) + " = ", self.$expr(self.$lhs()));
              return self.$push(", ", self.$expr(andop), ")");}, TMP_6._s = self, TMP_6), $a).call($b)}, TMP_5._s = self, TMP_5), $a).call($b);
        }, nil) && 'compile_and';
      })(self, $scope.get('Base'));
      ...
      (function($base, $super) {
        ...
        def.$compile_or = function() {
          ...
          return ($a = ($b = self).$with_temp, $a._p = (TMP_7 = function(tmp){var self = TMP_7._s || this, getr = nil, asgn = nil, orop = nil;
if (tmp == null) tmp = nil;
          getr = self.$s("call", self.$s("js_tmp", tmp), self.$meth(), self.$s("arglist"));
            ...
            return self.$push("(" + (tmp) + " = ", self.$expr(self.$lhs()), ", ", self.$expr(orop), ")");}, TMP_7._s = self, TMP_7), $a).call($b);
        };

        def.$compile_and = function() {
          var $a, $b, TMP_8, self = this;

          return ($a = ($b = self).$with_temp, $a._p = (TMP_8 = function(tmp){var self = TMP_8._s || this, getr = nil, asgn = nil, andop = nil;
if (tmp == null) tmp = nil;
          getr = self.$s("call", self.$s("js_tmp", tmp), self.$meth(), self.$s("arglist"));
            asgn = self.$s("call", self.$s("js_tmp", tmp), self.$mid(), self.$s("arglist", self.$rhs()));
            andop = self.$s("and", getr, asgn);
            return self.$push("(" + (tmp) + " = ", self.$expr(self.$lhs()), ", ", self.$expr(andop), ")");}, TMP_8._s = self, TMP_8), $a).call($b);
        };

        return (def.$compile_operator = function() {
          var $a, $b, TMP_9, self = this;

          return ($a = ($b = self).$with_temp, $a._p = (TMP_9 = function(tmp){var self = TMP_9._s || this, getr = nil, oper = nil, asgn = nil;
if (tmp == null) tmp = nil;
          getr = self.$s("call", self.$s("js_tmp", tmp), self.$meth(), self.$s("arglist"));
            oper = self.$s("call", getr, self.$op(), self.$s("arglist", self.$rhs()));
            asgn = self.$s("call", self.$s("js_tmp", tmp), self.$mid(), self.$s("arglist", oper));
            return self.$push("(" + (tmp) + " = ", self.$expr(self.$lhs()), ", ", self.$expr(asgn), ")");}, TMP_9._s = self, TMP_9), $a).call($b);
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        def.$compile = function() {
          ...
          if ((($a = ($b = self.$args().$last()['$is_a?']($scope.get('Sexp')), $b !== false && $b !== nil ?self.$args().$last().$type()['$==']("splat") : $b)) !== nil && (!$a._isBoolean || $a == true))) {
...
if (_arg == null) _arg = nil;if (_idx == null) _idx = nil;
        ...
        def.$extract_opt_args = function() {
          ...
          if ((($a = ($b = self.$args().$last()['$is_a?']($scope.get('Sexp')), $b !== false && $b !== nil ?self.$args().$last().$type()['$==']("block") : $b)) !== nil && (!$a._isBoolean || $a == true))) {
        ...
        def.$extract_block_arg = function() {
          ...
          if ((($a = ($b = self.$args().$last()['$is_a?']($scope.get('Sexp')), $b !== false && $b !== nil ?self.$args().$last().$type()['$==']("block_pass") : $b)) !== nil && (!$a._isBoolean || $a == true))) {
        ...
        def.$args = function() {
          ...
          if ((($a = ((($b = $scope.get('Fixnum')['$==='](self.$args_sexp())) !== false && $b !== nil) ? $b : self.$args_sexp()['$nil?']())) !== nil && (!$a._isBoolean || $a == true))) {
            return self.$s("array")
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        def.$compile = function() {
          ...
          params = nil;
          scope_name = nil;
          if ((($a = $scope.get('Sexp')['$==='](self.$args().$last())) !== nil && (!$a._isBoolean || $a == true))) {
            opt = self.$args().$pop()};
      ...
      (function($base, $super) {
        ...
        def.$compile = function() {
          ...
          self.$line("$opal.dynamic_require_severity = " + (self.$compiler().$dynamic_require_severity().$to_s().$inspect()) + ";");
            ...
            if ((($a = body_code['$is_a?']($scope.get('Array'))) !== nil && (!$a._isBoolean || $a == true))) {
              } else {
              body_code = [body_code]
            };
...
if (k == null) k = nil;
        ...
        return (def.$version_comment = function() {
          ...
          return "/* Generated by Opal " + ((($scope.get('Opal'))._scope.get('VERSION'))) + " */";
        }, nil) && 'version_comment';
      })(self, $scope.get('ScopeNode'))
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      $opal.defs(self, '$compiler_option', function(name, default_value, options) {
        ...
        return ($a = ($b = self).$define_method, $a._p = (TMP_1 = function(){var self = TMP_1._s || this, $a, $b, TMP_2, $c, value = nil;
          if (self.options == null) self.options = nil;

        value = ($a = ($b = self.options).$fetch, $a._p = (TMP_2 = function(){var self = TMP_2._s || this;

          return default_value}, TMP_2._s = self, TMP_2), $a).call($b, name);
          if ((($a = (($c = valid_values !== false && valid_values !== nil) ? (valid_values['$include?'](value))['$!']() : $c)) !== nil && (!$a._isBoolean || $a == true))) {
            self.$raise($scope.get('ArgumentError'))};
          return value;}, TMP_1._s = self, TMP_1), $a).call($b, ((($c = mid) !== false && $c !== nil) ? $c : name));
      });
      ...
      def.$source_map = function(source_file) {
        ...
        return (($scope.get('Opal'))._scope.get('SourceMap')).$new(self.fragments, ((($a = source_file) !== false && $a !== nil) ? $a : self.$file()));
      };
      ...
      def.$handlers = function() {
        ...
        return ((($a = self.handlers) !== false && $a !== nil) ? $a : self.handlers = (((($scope.get('Opal'))._scope.get('Nodes')))._scope.get('Base')).$handlers());
      };
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        def.$find_contents = function(result) {
          ...
          inner = nil.$gsub(/\\'/, "'").$gsub(/\\"/, "\"");
            if ((($a = inner['$=~']($scope.get('BLOCK_EXPR'))) !== nil && (!$a._isBoolean || $a == true))) {
