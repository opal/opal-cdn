...
(function($opal) {
  ...
  (function($base, $super) {
    ...
    $opal.defs(self, '$register', TMP_1 = function(name, options) {
      ...
      encoding = ($a = ($b = $scope.get('Class')).$new, $a._p = block.$to_proc(), $a).call($b, self).$new(name, names, ((($a = options['$[]']("ascii")) !== false && $a !== nil) ? $a : false), ((($a = options['$[]']("dummy")) !== false && $a !== nil) ? $a : false));
...
if (const$ == null) const$ = nil;
  ...
  ($a = ($b = $scope.get('Encoding')).$register, $a._p = (TMP_4 = function(){var self = TMP_4._s || this, TMP_5;
  ...
  ($a = ($c = $scope.get('Encoding')).$register, $a._p = (TMP_6 = function(){var self = TMP_6._s || this, TMP_7;
  ...
  ($a = ($d = $scope.get('Encoding')).$register, $a._p = (TMP_8 = function(){var self = TMP_8._s || this, TMP_9;
  ...
  return (function($base, $super) {
    ...
    def.encoding = nil;
    def.encoding = (($scope.get('Encoding'))._scope.get('UTF_16LE'));
