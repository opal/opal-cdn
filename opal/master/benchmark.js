...
Opal.modules["benchmark"] = function(Opal) {
  ...
  return (function($base) {
    ...
    Opal.defn(self, '$benchmark', TMP_1 = function(caption, label_width, format, labels) {
      var $a, $b, $c, TMP_2, self = this, $iter = TMP_1.$$p, $yield = $iter || nil, sync = nil, report = nil, results = nil;

      labels = $slice.call(arguments, 3);
      if (caption == null) {
        caption = ""
      }
      if (label_width == null) {
...
if (t == null) t = nil;
    ...
    Opal.defn(self, '$bm', TMP_3 = function(label_width, labels) {
      var $a, $b, self = this, $iter = TMP_3.$$p, blk = $iter || nil;

      labels = $slice.call(arguments, 1);
      if (label_width == null) {
        label_width = 0
      }
      TMP_3.$$p = null;
      return ($a = ($b = self).$benchmark, $a.$$p = blk.$to_proc(), $a).apply($b, [$scope.get('CAPTION'), label_width, $scope.get('FORMAT')].concat(labels));
    });
...
if (res == null) res = nil;
    ...
    (function($base, $super) {
      ...
      def.$item = TMP_10 = function(label) {
      ...
      Opal.defn(self, '$report', def.$item);
    ...
    (function($base, $super) {
      ...
      def.$initialize = function(width, format) {
        var $a, self = this;
      ...
      def.$item = TMP_11 = function(label, format) {
        ...
        self.$print(($a = res).$format.apply($a, [self.format].concat(format)));
        return res;
      };
    ...
    (function($base, $super) {
      ...
      def.$initialize = function(utime, stime, cutime, cstime, real, label) {
        var $a, self = this;
      ...
      return (def.$memberwise = function(op, x) {
