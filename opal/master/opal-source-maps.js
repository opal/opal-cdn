...
if (h == null) h = nil;if (i == null) i = nil;
      return h.$update($hash($scope.get('BASE64_DIGITS')['$[]'](i), i))}, TMP_1._s = self, TMP_1), $a).call($b, $hash2([], {})));
      ...
      $opal.defs(self, '$base64_encode', function(int$) {
        ...
        return ((($a = $scope.get('BASE64_DIGITS')['$[]'](int$)) !== false && $a !== nil) ? $a : self.$raise($scope.get('ArgumentError'), "" + (int$) + " is not a valid base64 digit"));
      });

      $opal.defs(self, '$base64_decode', function(char$) {
        var $a, self = this;

        return ((($a = $scope.get('BASE64_VALUES')['$[]'](char$)) !== false && $a !== nil) ? $a : self.$raise($scope.get('ArgumentError'), "" + (char$) + " is not a valid base64 digit"));
      });
...
if (line == null) line = nil;
      ...
      def.$save = function(file) {
        ...
        return ($a = ($b = $scope.get('File')).$open, $a._p = (TMP_2 = function(f){var self = TMP_2._s || this;
if (f == null) f = nil;
      ...
      def.$vlq = function(num, type) {
        ...
        return $scope.get('VLQ').$encode(ret);
      };
      ...
      def['$serialize_mappings!'] = function() {
        ...
        self.names = [];
        self.name_ids = $hash2([], {});
        self.previous_vlq = ($a = ($b = $scope.get('Hash')).$new, $a._p = (TMP_3 = function(){var self = TMP_3._s || this;
  ...
  return (function($base, $super) {
    ...
    $opal.defs(self, '$from_json', function(json) {
      ...
      if (json['$[]']("version")['$=='](3)) {
        ...
        self.$raise($scope.get('ParserError'), "Cannot parse version: " + (json['$[]']("version")) + " of SourceMap")
      };
    ...
    $opal.defs(self, '$from_s', function(str) {
      ...
      return self.$from_json($scope.get('JSON').$parse(str));
    });

    $opal.defs(self, '$load', function(filename) {
      var self = this;

      return self.$from_s($scope.get('File').$read(filename));
    });
    ...
    return (function($base) {
      ...
      def.$parse_mappings = function(string) {
        ...
        self.previous = ($a = ($b = $scope.get('Hash')).$new, $a._p = (TMP_1 = function(){var self = TMP_1._s || this;
...
if (x == null) x = nil;
      ...
      def.$parse_mapping = function(segment, line_num) {
        ...
        item = $scope.get('VLQ').$decode_array(segment);
        if ((($a = [1, 4, 5]['$include?'](item.$size())) !== nil && (!$a._isBoolean || $a == true))) {
          } else {
          self.$raise($scope.get('ParserError'), "In map for " + (self.$file()) + ":" + (line_num) + ": unparseable item: " + (segment))
        };
        ...
        if (map['$[]']("generated_col")['$<'](0)) {
          return self.$raise($scope.get('ParserError'), "In map for " + (self.$file()) + ":" + (line_num) + ": unexpected generated_col: " + (map['$[]']("generated_col")))
          ...
          return self.$raise($scope.get('ParserError'), "In map for " + (self.$file()) + ":" + (line_num) + ": unknown source id: " + (self.previous['$[]']("source_id")))
        } else if ((($a = ($b = map['$key?']("source_line"), $b !== false && $b !== nil ?map['$[]']("source_line")['$<'](1) : $b)) !== nil && (!$a._isBoolean || $a == true))) {
          return self.$raise($scope.get('ParserError'), "In map for " + (self.$file()) + ":" + (line_num) + ": unexpected source_line: " + (map['$[]']("source_line")))
        } else if ((($a = ($b = map['$key?']("source_col"), $b !== false && $b !== nil ?map['$[]']("source_col")['$<'](0) : $b)) !== nil && (!$a._isBoolean || $a == true))) {
          return self.$raise($scope.get('ParserError'), "In map for " + (self.$file()) + ":" + (line_num) + ": unexpected source_col: " + (map['$[]']("source_col")))
        } else if ((($a = ($b = map['$key?']("name"), $b !== false && $b !== nil ?(((($c = map['$[]']("name")['$nil?']()) !== false && $c !== nil) ? $c : self.previous['$[]']("name_id")['$<'](0))) : $b)) !== nil && (!$a._isBoolean || $a == true))) {
          return self.$raise($scope.get('ParserError'), "In map for " + (self.$file()) + ":" + (line_num) + ": unknown name id: " + (self.previous['$[]']("name_id")))
          } else {
          return map
        };
      };
...
Opal.modules["source_map"] = function($opal) {
  ...
  return (function($base, $super) {
    ...
    self.$include((($scope.get('SourceMap'))._scope.get('Generator')));

    self.$include((($scope.get('SourceMap'))._scope.get('Parser')));
    ...
    def.$initialize = function(opts) {
      ...
      if ((($a = ((remain = opts.$keys()['$-'](["generated_output", "file", "source_root", "sources", "names", "version"])))['$empty?']()) !== nil && (!$a._isBoolean || $a == true))) {
        ...
        self.$raise($scope.get('ArgumentError'), "Unsupported options to SourceMap.new: " + (remain.$inspect()))
      };
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$map = function() {
        ...
        return ((($a = self.map) !== false && $a !== nil) ? $a : self.map = ($b = ($c = Opal.get('SourceMap').$new()).$tap, $b._p = (TMP_1 = function(map){var self = TMP_1._s || this, $a, $b, TMP_2, line = nil, column = nil;
