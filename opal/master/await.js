Opal.modules["promise/v2"] = function(Opal) {/* Generated by Opal 1.5.0.dev */
  var $nesting = [], nil = Opal.nil, $klass = Opal.klass, $def = Opal.def, $eqeq = Opal.eqeq, $send = Opal.send, $alias = Opal.alias, $truthy = Opal.truthy, $rb_gt = Opal.rb_gt, $rb_minus = Opal.rb_minus, $to_a = Opal.to_a, $eqeqeq = Opal.eqeqeq, $rb_plus = Opal.rb_plus;

  Opal.add_stubs('instance_variable_set,Array,==,length,first,tap,attr_reader,!=,native?,raise,include?,any?,proc,call,nativity_check!,gen_tracing_proc,<<,there_can_be_only_one!,then,to_proc,fail,always,!,>,value,unshift,-,prev,trace,light_nativity_check!,nil?,resolved?,===,rejected?,map,when,new,rescue,resolve,reject,class,+,object_id,inspect');
...
Opal.modules["await"] = function(Opal) {/* Generated by Opal 1.5.0.dev */
