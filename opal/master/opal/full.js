Opal.modules["corelib/trace_point"] = function(Opal) {/* Generated by Opal 1.6.0 */
  ...
  return (function($base, $super) {
    ...
    return $def(self, '$self', $return_ivar("trace_object"), 0);
  })('::', null)
};

Opal.modules["corelib/pattern_matching/base"] = function(Opal) {/* Generated by Opal 1.6.0 */
  ...
  (function($base, $super) {
    ...
    return $def(self, '$deconstruct', $return_self, 0)
  })('::', null);
  (function($base, $super) {
    var self = $klass($base, $super, 'Hash');

    
    return $def(self, '$deconstruct_keys', $return_self, 0)
  })('::', null);
  (function($base, $super) {
    ...
    return $def(self, '$deconstruct_keys', function $$deconstruct_keys(keys) {
      ...
      (function(){try { var $t_break = $thrower('break'); return $send(keys, 'each', [], function $$1(key){var $a, self = $$1.$$s == null ? this : $$1.$$s, should_break = nil, $ret_or_1 = nil;
        ...
        return ($a = [key, self['$[]'](key)], $send(out, '[]=', $a), $a[$a.length - 1]);}, {$$arity: 1, $$s: self})} catch($e) {
...
Opal.modules["corelib/pattern_matching"] = function(Opal) {/* Generated by Opal 1.6.0 */
  ...
  return (function($base, $super) {
    ...
    return $def(self, '$match', function $$match(from, pattern) {try { var $t_return = $thrower('return'); 
      ...
      if ($eqeq(pattern, "var")) {
        ...
        $a = [].concat($to_a(pattern)), (type = ($a[0] == null ? nil : $a[0])), (args = $slice.call($a, 1)), $a;
        ...
        switch (type) {
          ...
          case "any":
            return $send(args, 'any?', [], function $$1(arg){var self = $$1.$$s == null ? this : $$1.$$s;
              ...
              if (arg == null) arg = nil;
              return self.$match(from, arg);}, {$$arity: 1, $$s: self})
          case "all":
          ...
          case "array":
            ...
            return $send(array_match.$each_with_index(), 'all?', [], function $$3(elem, i){var $b, $c, self = $$3.$$s == null ? this : $$3.$$s;
              ...
              if (i == null) i = nil;
              $c = elem, $b = $to_ary($c), (type = ($b[0] == null ? nil : $b[0])), (args = $slice.call($b, 1)), $c;
          ...
          case "find":
            ...
            $a = [].concat($to_a(find_match)), (first = ($a[0] == null ? nil : $a[0])), $b = $a.length - 1, $b = ($b < 1) ? 1 : $b, (find_match = $slice.call($a, 1, $b)), (last = ($a[$b] == null ? nil : $a[$b])), $a;
            ...
            return $send(iterations.$times(), 'any?', [], function $$4(skip){var self = $$4.$$s == null ? this : $$4.$$s, first_part = nil, content = nil, last_part = nil, success = nil;
              ...
              success = $send(content.$each_with_index(), 'all?', [], function $$5(e, i){var self = $$5.$$s == null ? this : $$5.$$s;
                ...
                if (e == null) e = nil;
                if (i == null) i = nil;
                return self.$match(e, find_match['$[]'](i));}, {$$arity: 2, $$s: self});
              if ($truthy(last)) {
          ...
          case "hash":
            ...
            if ($truthy(($ret_or_2 = $send(hash_match, 'all?', [], function $$6(k, v){var self = $$6.$$s == null ? this : $$6.$$s;
              ...
              return self.$match(a['$[]'](k), v);}, {$$arity: 2, $$s: self, $$ret: $t_return})))) {
              $ret_or_2
            } else {
...
Opal.modules["corelib/object_space"] = function(Opal) {/* Generated by Opal 1.6.0 */
  ...
  ;
    ...
    return (function($base, $super) {
      ...
      $send(["each", "each_key", "each_value", "each_pair", "keys", "values", "size", "length"], 'each', [], function $WeakMap$4(i){var self = $WeakMap$4.$$s == null ? this : $WeakMap$4.$$s;
        ...
        if (i == null) i = nil;
        return $send(self, 'define_method', [i], function $$5($a){var $post_args, $rest_arg;

          
          $post_args = $slice.call(arguments);
          $rest_arg = $post_args;
          return $Kernel.$raise($$$('NotImplementedError'), "#" + (i) + " can't be implemented on top of JS interfaces");}, -1);}, {$$arity: 1, $$s: self});
...
Opal.modules["corelib/array/pack"] = function(Opal) {/* Generated by Opal 1.6.0 */
...
Opal.modules["corelib/string/unpack"] = function(Opal) {/* Generated by Opal 1.6.0 */
...
Opal.modules["corelib/marshal"] = function(Opal) {/* Generated by Opal 1.6.0 */
...
Opal.modules["corelib/pack_unpack/format_string_parser"] = function(Opal) {/* Generated by Opal 1.6.0 */
...
Opal.modules["base64"] = function(Opal) {/* Generated by Opal 1.6.0 */
...
Opal.modules["corelib/marshal/read_buffer"] = function(Opal) {/* Generated by Opal 1.6.0 */
    ...
    ;
      ...
      $def(self, '$read_bignum', function $$read_bignum() {
        ...
        $send(Opal.Range.$new(0,size, true), 'each', [], function $$1(exp){var self = $$1.$$s == null ? this : $$1.$$s;
          ...
          if (exp == null) exp = nil;
          return (result = $rb_plus(result, $rb_times(self.$read_char().$ord(), (2)['$**']($rb_times(exp, 8)))));}, {$$arity: 1, $$s: self});
...
Opal.modules["corelib/marshal/write_buffer"] = function(Opal) {/* Generated by Opal 1.6.0 */
    ...
    ;
      ...
      $def(self, '$write_bignum', function $$write_bignum(n) {
        ...
        return $send(arr, 'each', [], function $$3(x){var self = $$3.$$s == null ? this : $$3.$$s;
          ...
          return self.$append(String.fromCharCode($rb_divide(x, 256).$floor()));}, {$$arity: 1, $$s: self});
      }, 1);
      ...
      $def(self, '$write_array', function $$write_array(a) {
        ...
        return $send(a, 'each', [], function $$4(item){var self = $$4.$$s == null ? this : $$4.$$s;
          ...
          return self.$write(item);}, {$$arity: 1, $$s: self});
      }, 1);
      ...
      $def(self, '$write_hash', function $$write_hash(h) {
        ...
        return $send(h, 'each', [], function $$5(key, value){var self = $$5.$$s == null ? this : $$5.$$s;
          ...
          if (value == null) value = nil;
          self.$write(key);
          return self.$write(value);}, {$$arity: 2, $$s: self});
      }, 1);
      ...
      $def(self, '$write_ivars_suffix', function $$write_ivars_suffix(object, force) {
        ...
        return $send(object.$instance_variables(), 'each', [], function $$6(ivar_name){var self = $$6.$$s == null ? this : $$6.$$s;
          ...
          return self.$write(object.$instance_variable_get(ivar_name));}, {$$arity: 1, $$s: self});
      }, -2);
      ...
      $def(self, '$write_extends', function $$write_extends(object) {
        ...
        if ($truthy(own_mods['$empty?']())) {
          ...
          return $send(own_mods, 'each', [], function $$9(mod){var self = $$9.$$s == null ? this : $$9.$$s;
            ...
            if (mod == null) mod = nil;
            self.$append("e");
            return self.$append_symbol(mod.$name());}, {$$arity: 1, $$s: self})
        };
      }, 1);
