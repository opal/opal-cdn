Opal.modules["forwardable"] = function(Opal) {/* Generated by Opal 1.5.0.dev */
...
Opal.modules["date/infinity"] = function(Opal) {/* Generated by Opal 1.5.0.dev */
  var $nesting = [], nil = Opal.nil, $$$ = Opal.$$$, $klass = Opal.klass, $def = Opal.def, $eqeqeq = Opal.eqeqeq, $to_ary = Opal.to_ary, $send2 = Opal.send2, $find_super = Opal.find_super, $eqeq = Opal.eqeq, $truthy = Opal.truthy, $rb_gt = Opal.rb_gt;
...
Opal.modules["date/date_time"] = function(Opal) {/* Generated by Opal 1.5.0.dev */
  var $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $$$ = Opal.$$$, $klass = Opal.klass, $def = Opal.def, $alias = Opal.alias, $rb_divide = Opal.rb_divide, $rb_times = Opal.rb_times, $rb_plus = Opal.rb_plus, $rb_minus = Opal.rb_minus, $truthy = Opal.truthy;

  Opal.add_stubs('wrap,now,parse,new,def_delegators,/,usec,gmt_offset,*,+,-,is_a?,clone,_parse_offset,dup,year,month,day');
  return (function($base, $super, $parent_nesting) {
...
Opal.modules["date/formatters"] = function(Opal) {/* Generated by Opal 1.5.0.dev */
  var $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $klass = Opal.klass, $hash2 = Opal.hash2, $send = Opal.send, $to_a = Opal.to_a, $hash = Opal.hash, $defs = Opal.defs, $alias = Opal.alias;

  Opal.add_stubs('def_formatter');
...
Opal.modules["date"] = function(Opal) {/* Generated by Opal 1.5.0.dev */
  var self = Opal.top, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$, $klass = Opal.klass, $const_set = Opal.const_set, $rb_plus = Opal.rb_plus, $def = Opal.def, $send = Opal.send, $alias = Opal.alias, $rb_minus = Opal.rb_minus, $truthy = Opal.truthy, $rb_lt = Opal.rb_lt, $rb_times = Opal.rb_times, $defs = Opal.defs;

  Opal.add_stubs('require,include,extend,new,-@,+,allocate,join,compact,map,to_proc,downcase,wrap,raise,attr_reader,<=>,jd,===,<<,prev_month,dup,def_delegators,clone,prev_day,next_day,_days_in_month,class,-,year,month,day,prev_year,to_s,strftime,to_i,<,*,reverse,step,abs,each');
...
Opal.modules["time"] = function(Opal) {/* Generated by Opal 1.5.0.dev */
  var self = Opal.top, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$, $klass = Opal.klass, $defs = Opal.defs, $hash2 = Opal.hash2, $send = Opal.send, $eqeqeq = Opal.eqeqeq, $truthy = Opal.truthy, $rb_gt = Opal.rb_gt, $rb_plus = Opal.rb_plus, $alias = Opal.alias, $def = Opal.def;

  Opal.add_stubs('define_method,===,new_offset,utc,year,month,day,getutc,strftime,>,+,def_formatter,wrap,require');
  ...
  (function($base, $super, $parent_nesting) {
    ...
    $defs(self, '$def_formatter', function $$def_formatter(name, format, $kwargs) {
      ...
      on_utc = $kwargs.$$smap["on_utc"];
      if (on_utc == null) on_utc = false;
      
      utc_tz = $kwargs.$$smap["utc_tz"];
      if (utc_tz == null) utc_tz = nil;
      
      tz_format = $kwargs.$$smap["tz_format"];
      if (tz_format == null) tz_format = nil;
      
      fractions = $kwargs.$$smap["fractions"];
      if (fractions == null) fractions = false;
    ...
    return $def(self, '$to_time', function $$to_time() {
      var self = this;
