Opal.modules["thread"] = function(Opal) {/* Generated by Opal 1.5.0.dev */
  var $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $$$ = Opal.$$$, $klass = Opal.klass, $truthy = Opal.truthy, $defs = Opal.defs, $def = Opal.def, $send = Opal.send, $to_a = Opal.to_a, $rb_minus = Opal.rb_minus, $hash2 = Opal.hash2, $Opal = Opal.Opal, $alias = Opal.alias, $const_set = Opal.const_set;
  ...
  (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$[]=', function $Thread_$$$eq$2(key, value) {
      ...
      $send(self.fiber_locals, '[]=', $to_a($writer));
    ...
    $def(self, '$thread_variable_set', function $$thread_variable_set(key, value) {
      ...
      $writer = [self.$coerce_key_name(key), value];
      $send(self.thread_locals, '[]=', $to_a($writer));
      return $writer[$rb_minus($writer["length"], 1)];
    }, 2);
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$locked?', function $Mutex_locked$ques$7() {
      var self = this;

      return self.locked
    }, 0);
    
    $def(self, '$owned?', function $Mutex_owned$ques$8() {
      var self = this;
...
Opal.modules["stringio"] = function(Opal) {/* Generated by Opal 1.5.0.dev */
...
Opal.modules["prettyprint"] = function(Opal) {/* Generated by Opal 1.5.0.dev */
...
Opal.modules["pp"] = function(Opal) {/* Generated by Opal 1.5.0.dev */
  var self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $$$ = Opal.$$$, $klass = Opal.klass, $gvars = Opal.gvars, $send = Opal.send, $defs = Opal.defs, $to_a = Opal.to_a, $module = Opal.module, $eqeq = Opal.eqeq, $hash2 = Opal.hash2, $rb_minus = Opal.rb_minus, $def = Opal.def, $truthy = Opal.truthy, $rb_plus = Opal.rb_plus, $eqeqeq = Opal.eqeqeq, $neqeq = Opal.neqeq, $not = Opal.not, $rb_gt = Opal.rb_gt, $rb_le = Opal.rb_le;
  ...
  (function($base, $super, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      $def(self, '$guard_inspect_key', function $$guard_inspect_key() {
        var $yield = $$guard_inspect_key.$$p || nil, $writer = nil, save = nil;
        ...
        return Opal.yieldX($yield, []);;
          ...
          (($writer = ["inspect", save]), $send($$('Thread').$current()['$[]']("__recursive_key__"), '[]=', $to_a($writer)), $writer[$rb_minus($writer["length"], 1)])
        }; })();;
      }, 0);
      ...
      $def(self, '$push_inspect_key', function $$push_inspect_key(id) {
        ...
        $writer = [id, true];
        $send($$('Thread').$current()['$[]']("__recursive_key__")['$[]']("inspect"), '[]=', $to_a($writer));
        return $writer[$rb_minus($writer["length"], 1)];
      }, 1);
  ...
  (function(self, $parent_nesting) {
    ...
    return $def(self, '$pretty_print', function $$pretty_print(q) {
      ...
      h = $hash2([], {});
      $send($$('ENV').$keys().$sort(), 'each', [], function $$18(k){var $writer = nil;
  ...
  (function($base, $super) {
    ...
    return $def(self, '$pretty_print', function $$pretty_print(q) {
      ...
      $send(self.$regexp().$named_captures(), 'each', [], function $$26(name, indexes){
        ...
        return $send(indexes, 'each', [], function $$27(i){var $writer = nil;
          ...
          $writer = [i, name];
          $send(nc, '[]=', $to_a($writer));
          return $writer[$rb_minus($writer["length"], 1)];}, 1);}, 2);
...
Opal.modules["opal-replutils"] = function(Opal) {/* Generated by Opal 1.5.0.dev */
  ...
  return (function($base, $parent_nesting) {
    ...
    $def(self, '$ls', function $$ls(object, colorize) {
      ...
      if (!$truthy(cvs['$empty?']())) {
        out = $rb_plus("" + (blue['$[]']("class variables")) + ": " + ($send(cvs, 'map', [], function $$4(i){
          ...
          if (i == null) i = nil;;
          return dark_blue['$[]'](i);}, 1).$sort().$join("  ")) + "\n", out)
      };
      if (!$truthy(ivs['$empty?']())) {
    ...
    $def(self, '$eval_and_print', function $$eval_and_print(func, mode, colorize) {
      ...
      try {
        ...
        printer = ($truthy(colorize) ? ($lambda(function $$8(i){var e = nil;
          ...
          };}, 1)) : ($lambda(function $$9(i){var out = nil;
    ...
    ;
        ...
        if (Opal.rescue($err, [$$('Exception')])) {(e = $err)
          try {
            return e.$full_message($hash2(["highlight"], {"highlight": true}))
          } finally { Opal.pop_exception(); }
        } else { throw $err; }
      }
    }, 3);
    ...
    $def(self, '$js_repl', function $$js_repl() {
      var $a, self = this, line = nil, input = nil, out = nil;
    ...
    return (function($base, $super, $parent_nesting) {
      ...
      $defs(self, '$token', function $$token(string, $a) {
        ...
        name = $post_args;;
        return $rb_plus($rb_plus($send($$('TOKEN_COLORS'), 'dig', $to_a(name)), string), "\u001b[0m");
      }, -2);
