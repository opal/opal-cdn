...
args = $slice.call(arguments, 0);
          ...
          if ((($a = value = ($b = ($c = $scope.get('Native')).$call, $b._p = block.$to_proc(), $b).apply($c, [self["native"], old].concat(args))) !== nil && (!$a._isBoolean || $a == true))) {
...
args = $slice.call(arguments, 0);
          ...
          return ($a = ($b = $scope.get('Native')).$call, $a._p = block.$to_proc(), $a).apply($b, [self["native"], old].concat(args))}, TMP_4._s = self, TMP_4), $a).call($d, new$)
        };
      };
...
if (value == null) value = nil;
    ...
    def.$initialize = function(native$) {
      ...
      if ((($a = $scope.get('Kernel')['$native?'](native$)) !== nil && (!$a._isBoolean || $a == true))) {
        } else {
  ...
  (function($base) {
    ...
    def.$Native = function(obj) {
      ...
      if ((($a = obj == null) !== nil && (!$a._isBoolean || $a == true))) {
        ...
        return (($scope.get('Native'))._scope.get('Object')).$new(obj)
        } else {
        return obj
      };
    };
    ...
    def.$Array = TMP_9 = function(object, args) {
      ...
      if (object == null || object === nil) {
        ...
        return ($a = ($b = (($scope.get('Native'))._scope.get('Array'))).$new, $a._p = block.$to_proc(), $a).apply($b, [object].concat(args)).$to_a();
      }
  ...
  (function($base, $super) {
    ...
    $opal.defn(self, '$method_missing', TMP_11 = function(mid, args) {
      ...
      if (mid.charAt(mid.length - 1) === '=') {
        ...
        return ($a = ($b = Opal.get('Native')).$call, $a._p = block.$to_proc(), $a).apply($b, [self["native"], mid].concat(args));
      }
    ;
    });
    ...
    $opal.defn(self, '$to_a', TMP_12 = function(options) {
      ...
      TMP_12._p = null;
      return ($a = ($b = (($scope.get('Native'))._scope.get('Array'))).$new, $a._p = block.$to_proc(), $a).call($b, self["native"], options).$to_a();
    });
  ...
  (function($base, $super) {
    ...
    def['$[]'] = function(index) {
      ...
      result = (function() {$case = index;if ($scope.get('String')['$===']($case) || $scope.get('Symbol')['$===']($case)) {if ((($a = self.named) !== nil && (!$a._isBoolean || $a == true))) {
        return self["native"][self.named](index);
        } else {
        return self["native"][index];
      }}else if ($scope.get('Integer')['$===']($case)) {if ((($a = self.get) !== nil && (!$a._isBoolean || $a == true))) {
