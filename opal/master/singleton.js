  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      Opal.def(self, '$clone', $SingletonClassMethods_clone$3 = function $$clone() {
        ...
        return $$($nesting, 'Singleton').$__init__($send2(self, $find_super(self, 'clone', $SingletonClassMethods_clone$3, false, true), 'clone', $zuper, $iter))
      ...
      return (Opal.def(self, '$inherited', $SingletonClassMethods_inherited$4 = function $$inherited(sub_klass) {
        ...
        $send2(self, $find_super(self, 'inherited', $SingletonClassMethods_inherited$4, false, true), 'inherited', $zuper, $iter);
    ...
    return (function(self, $parent_nesting) {
      ...
      return (Opal.def(self, '$included', $included$8 = function $$included(klass) {
        ...
        $send2(self, $find_super(self, 'included', $included$8, false, true), 'included', $zuper, $iter);
