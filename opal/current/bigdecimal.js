...
Opal.modules["bigdecimal"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defs(self, '$mode', TMP_2 = function ːmode(mode, value) {
      ...
      return (function() {$case = mode;if ($scope.get('ROUND_MODE')['$===']($case)) {if (value !== false && value !== nil) {
        self.round_mode = value};
      return ((($a = self.round_mode) !== false && $a !== nil) ? $a : $scope.get('ROUND_HALF_UP'));}else { return nil }})();
    }, TMP_2.$$arity = -2);
    ...
    Opal.defn(self, '$<', TMP_6 = function(other) {
      ...
      if ((($a = ((($b = self['$nan?']()) !== false && $b !== nil) ? $b : (($c = other !== false && other !== nil) ? other['$nan?']() : other))) !== nil && (!$a.$$is_boolean || $a == true))) {
        return false};
    ...
    Opal.defn(self, '$add', TMP_11 = function ːadd(other, digits) {
      ...
      if ((($a = $rb_lt(digits, 0)) !== nil && (!$a.$$is_boolean || $a == true))) {
      ...
      if ((($a = $rb_gt(digits, 0)) !== nil && (!$a.$$is_boolean || $a == true))) {
    ...
    Opal.defn(self, '$ceil', TMP_12 = function ːceil(n) {
      ...
      if ((($a = self.$bignumber().isFinite()) !== nil && (!$a.$$is_boolean || $a == true))) {
        } else {
      ...
      } else if ((($a = $rb_ge(n, 0)) !== nil && (!$a.$$is_boolean || $a == true))) {
    ...
    Opal.defn(self, '$div', TMP_14 = function ːdiv(other, digits) {
      ...
      if (digits['$=='](nil)) {
        if ((($a = other['$zero?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.$raise($scope.get('ZeroDivisionError'), "divided by 0")};
        if ((($a = self['$infinite?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.$raise($scope.get('FloatDomainError'), "Computation results to 'Infinity'")};
    ...
    Opal.defn(self, '$infinite?', TMP_16 = function() {
      ...
      if ((($a = ((($b = self['$finite?']()) !== false && $b !== nil) ? $b : self['$nan?']())) !== nil && (!$a.$$is_boolean || $a == true))) {
        return nil};
      if ((($a = self.$bignumber().isNegative()) !== nil && (!$a.$$is_boolean || $a == true))) {
        return -1
        } else {
        return 1
      };
    ...
    Opal.defn(self, '$sign', TMP_21 = function ːsign() {
      ...
      if ((($a = self.$bignumber().isNaN()) !== nil && (!$a.$$is_boolean || $a == true))) {
        return $scope.get('SIGN_NaN')};
      if ((($a = self.$bignumber().isZero()) !== nil && (!$a.$$is_boolean || $a == true))) {
        return (function() {if ((($a = self.$bignumber().isNegative()) !== nil && (!$a.$$is_boolean || $a == true))) {
