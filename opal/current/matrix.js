...
Opal.modules["e2mmap"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    Opal.defs($$($nesting, 'E2MM'), '$extend_object', $Exception2MessageMapper_extend_object$1 = function $$extend_object(cl) {
      ...
      $send(self, Opal.find_super_dispatcher(self, 'extend_object', $Exception2MessageMapper_extend_object$1, false, self.$$class.$$prototype), $zuper, $iter);
    ...
    Opal.def(self, '$bind', $Exception2MessageMapper_bind$2 = function $$bind(cl) {
      ...
      return $send(self, 'module_eval', [], ($$3 = function(){var self = $$3.$$s || this, $Raise$4, $included$5;
    ...
    Opal.defs($$($nesting, 'E2MM'), '$def_e2message', $Exception2MessageMapper_def_e2message$9 = function $$def_e2message(k, c, m) {
      ...
      $send($$($nesting, 'E2MM'), 'instance_eval', [], ($$10 = function(){var self = $$10.$$s || this, $writer = nil;
    ...
    Opal.defs($$($nesting, 'E2MM'), '$def_exception', $Exception2MessageMapper_def_exception$11 = function $$def_exception(k, n, m, s) {
      ...
      $send($$($nesting, 'E2MM'), 'instance_eval', [], ($$12 = function(){var self = $$12.$$s || this, $writer = nil;
        if (self.MessageMap == null) self.MessageMap = nil;
      ...
      if ($truthy(k['$const_defined?'](n, false))) {
        $send(k, 'module_eval', [], ($$13 = function(){var self = $$13.$$s || this;
    ...
    Opal.defs($$($nesting, 'E2MM'), '$e2mm_message', $Exception2MessageMapper_e2mm_message$15 = function $$e2mm_message(klass, exp) {try {
      ...
      $send(klass.$ancestors(), 'each', [], ($$16 = function(c){var self = $$16.$$s || this, mes = nil;
        if (self.MessageMap == null) self.MessageMap = nil;
    ...
    return (function($base, $super, $parent_nesting) {
      ...
      Opal.def(self, '$initialize', $EigenvalueDecomposition_initialize$1 = function $$initialize(a) {
        ...
        if ($truthy((self.symmetric = a['$symmetric?']()))) {
          ...
          self.v = $send($$($nesting, 'Array'), 'new', [self.size], ($$2 = function(){var self = $$2.$$s || this;
      ...
      Opal.def(self, '$eigenvalues', $EigenvalueDecomposition_eigenvalues$5 = function $$eigenvalues() {
        ...
        values = self.d.$dup();
        $send(self.e, 'each_with_index', [], ($$6 = function(imag, i){var self = $$6.$$s || this, $writer = nil;
      ...
      Opal.def(self, '$eigenvectors', $EigenvalueDecomposition_eigenvectors$7 = function $$eigenvectors() {
        ...
        return $send(self.$build_eigenvectors(), 'map', [], ($$8 = function(ev){var self = $$8.$$s || this;
      ...
      Opal.def(self, '$build_eigenvectors', $EigenvalueDecomposition_build_eigenvectors$11 = function $$build_eigenvectors() {
        ...
        return $send(self.e.$each_with_index(), 'map', [], ($$12 = function(imag, i){var self = $$12.$$s || this, $$13, $$14, $$15;
          if (self.size == null) self.size = nil;
          ...
          if (imag['$=='](0)) {
            return $send($$($nesting, 'Array'), 'new', [self.size], ($$13 = function(j){var self = $$13.$$s || this;
            ...
            return $send($$($nesting, 'Array'), 'new', [self.size], ($$14 = function(j){var self = $$14.$$s || this;
              if (self.v == null) self.v = nil;
            ...
            return $send($$($nesting, 'Array'), 'new', [self.size], ($$15 = function(j){var self = $$15.$$s || this;
              if (self.v == null) self.v = nil;
      ...
      Opal.def(self, '$tridiagonalize', $EigenvalueDecomposition_tridiagonalize$17 = function $$tridiagonalize() {
        ...
        $send(self.size, 'times', [], ($$18 = function(j){var self = $$18.$$s || this, $writer = nil;
          if (self.v == null) self.v = nil;
          if (self.size == null) self.size = nil;
        ...
        $send($rb_minus(self.size, 1), 'downto', [$rb_plus(0, 1)], ($$19 = function(i){var self = $$19.$$s || this, $$20, $$21, $$22, $$23, $$24, $$26, $$27, $$28, scale = nil, h = nil, $writer = nil, f = nil, g = nil, hh = nil;
          if (self.d == null) self.d = nil;
          ...
          scale = 0.0;
          h = 0.0;
          $send(i, 'times', [], ($$20 = function(k){var self = $$20.$$s || this;
            if (self.d == null) self.d = nil;
          ...
          if ($truthy(scale['$=='](0.0))) {
            ...
            $send(i, 'times', [], ($$21 = function(j){var self = $$21.$$s || this;
              if (self.v == null) self.v = nil;
              if (self.d == null) self.d = nil;
            ...
            $send(i, 'times', [], ($$22 = function(k){var self = $$22.$$s || this;
              if (self.d == null) self.d = nil;
            ...
            $send(self.d, '[]=', Opal.to_a($writer));
            $writer[$rb_minus($writer["length"], 1)];;
            $send(i, 'times', [], ($$23 = function(j){var self = $$23.$$s || this;
              if (self.e == null) self.e = nil;
            ...
            $send(i, 'times', [], ($$24 = function(j){var self = $$24.$$s || this, $$25;
              if (self.d == null) self.d = nil;
              if (self.v == null) self.v = nil;
              if (self.e == null) self.e = nil;
              ...
              $send($rb_plus(j, 1), 'upto', [$rb_minus(i, 1)], ($$25 = function(k){var self = $$25.$$s || this;
                if (self.v == null) self.v = nil;
                if (self.d == null) self.d = nil;
                if (self.e == null) self.e = nil;
            ...
            f = 0.0;
            $send(i, 'times', [], ($$26 = function(j){var self = $$26.$$s || this;
              if (self.e == null) self.e = nil;
              if (self.d == null) self.d = nil;
            ...
            $send(i, 'times', [], ($$27 = function(j){var self = $$27.$$s || this;
              if (self.e == null) self.e = nil;
              if (self.d == null) self.d = nil;
            ...
            $send(i, 'times', [], ($$28 = function(j){var self = $$28.$$s || this, $$29;
              if (self.d == null) self.d = nil;
              if (self.e == null) self.e = nil;
              if (self.v == null) self.v = nil;
              ...
              f = self.d['$[]'](j);
              g = self.e['$[]'](j);
              $send(j, 'upto', [$rb_minus(i, 1)], ($$29 = function(k){var self = $$29.$$s || this, $binary_op_recvr_tmp_3 = nil;
                if (self.v == null) self.v = nil;
                if (self.e == null) self.e = nil;
                if (self.d == null) self.d = nil;
        ...
        $send((0), 'upto', [$rb_minus($rb_minus(self.size, 1), 1)], ($$30 = function(i){var self = $$30.$$s || this, $$31, $$32, $$35, $writer = nil, h = nil;
          if (self.v == null) self.v = nil;
          if (self.size == null) self.size = nil;
          if (self.d == null) self.d = nil;
          ...
          if ($truthy(h['$!='](0.0))) {
            ...
            $send((0), 'upto', [i], ($$31 = function(k){var self = $$31.$$s || this;
              if (self.v == null) self.v = nil;
              if (self.d == null) self.d = nil;
            ...
            $send((0), 'upto', [i], ($$32 = function(j){var self = $$32.$$s || this, $$33, $$34, g = nil;
              ...
              g = 0.0;
              $send((0), 'upto', [i], ($$33 = function(k){var self = $$33.$$s || this;
                if (self.v == null) self.v = nil;
              ...
              return $send((0), 'upto', [i], ($$34 = function(k){var self = $$34.$$s || this, $binary_op_recvr_tmp_4 = nil;
                if (self.v == null) self.v = nil;
                if (self.d == null) self.d = nil;
          ...
          return $send((0), 'upto', [i], ($$35 = function(k){var self = $$35.$$s || this;
            if (self.v == null) self.v = nil;
        ...
        $send(self.size, 'times', [], ($$36 = function(j){var self = $$36.$$s || this, $writer = nil;
          if (self.v == null) self.v = nil;
          if (self.size == null) self.size = nil;
          if (self.d == null) self.d = nil;
      ...
      Opal.def(self, '$diagonalize', $EigenvalueDecomposition_diagonalize$37 = function $$diagonalize() {
        ...
        $send((1), 'upto', [$rb_minus(self.size, 1)], ($$38 = function(i){var self = $$38.$$s || this, $writer = nil;
          if (self.e == null) self.e = nil;
        ...
        $send(self.size, 'times', [], ($$39 = function(l){var self = $$39.$$s || this, $a, $$40, $$41, m = nil, iter = nil, g = nil, p = nil, r = nil, dl1 = nil, h = nil, c = nil, c2 = nil, c3 = nil, el1 = nil, s = nil, s2 = nil;
          if (self.d == null) self.d = nil;
          if (self.e == null) self.e = nil;
          if (self.size == null) self.size = nil;
          ...
          if ($truthy($rb_gt(m, l))) {
            ...
            while ($truthy($rb_gt(self.e['$[]'](l).$abs(), $rb_times(eps, tst1)))) {
              ...
              $send($rb_plus(l, 2), 'upto', [$rb_minus(self.size, 1)], ($$40 = function(i){var self = $$40.$$s || this;
                if (self.d == null) self.d = nil;
              ...
              s = 0.0;
              s2 = 0.0;
              $send($rb_minus(m, 1), 'downto', [l], ($$41 = function(i){var self = $$41.$$s || this, $$42;
                if (self.e == null) self.e = nil;
                if (self.d == null) self.d = nil;
                if (self.size == null) self.size = nil;
                ...
                $send(self.d, '[]=', Opal.to_a($writer));
                $writer[$rb_minus($writer["length"], 1)];;
                return $send(self.size, 'times', [], ($$42 = function(k){var self = $$42.$$s || this;
                  if (self.v == null) self.v = nil;
        ...
        return $send((0), 'upto', [$rb_minus(self.size, 2)], ($$43 = function(i){var self = $$43.$$s || this, $$44, $$45, k = nil, p = nil;
          if (self.d == null) self.d = nil;
          if (self.size == null) self.size = nil;
          ...
          k = i;
          p = self.d['$[]'](i);
          $send($rb_plus(i, 1), 'upto', [$rb_minus(self.size, 1)], ($$44 = function(j){var self = $$44.$$s || this;
            if (self.d == null) self.d = nil;
          ...
          if ($truthy(k['$!='](i))) {
            ...
            $send(self.d, '[]=', Opal.to_a($writer));
            $writer[$rb_minus($writer["length"], 1)];;
            return $send(self.size, 'times', [], ($$45 = function(j){var self = $$45.$$s || this;
              if (self.v == null) self.v = nil;
      ...
      Opal.def(self, '$reduce_to_hessenberg', $EigenvalueDecomposition_reduce_to_hessenberg$46 = function $$reduce_to_hessenberg() {
        ...
        $send($rb_plus(low, 1), 'upto', [$rb_minus(high, 1)], ($$47 = function(m){var self = $$47.$$s || this, $$48, $$49, $$50, $$53, scale = nil, h = nil, g = nil, $writer = nil;
          ...
          scale = 0.0;
          $send(m, 'upto', [high], ($$48 = function(i){var self = $$48.$$s || this;
            if (self.h == null) self.h = nil;
          ...
          if ($truthy(scale['$!='](0.0))) {
            ...
            h = 0.0;
            $send(high, 'downto', [m], ($$49 = function(i){var self = $$49.$$s || this, $writer = nil;
              if (self.h == null) self.h = nil;
              if (self.ort == null) self.ort = nil;
            ...
            $send(self.ort, '[]=', Opal.to_a($writer));
            $writer[$rb_minus($writer["length"], 1)];;
            $send(m, 'upto', [$rb_minus(self.size, 1)], ($$50 = function(j){var self = $$50.$$s || this, $$51, $$52, f = nil;
              ...
              f = 0.0;
              $send(high, 'downto', [m], ($$51 = function(i){var self = $$51.$$s || this;
                if (self.ort == null) self.ort = nil;
                if (self.h == null) self.h = nil;
              ...
              f = $rb_divide(f, h);
              return $send(m, 'upto', [high], ($$52 = function(i){var self = $$52.$$s || this, $binary_op_recvr_tmp_5 = nil;
                if (self.h == null) self.h = nil;
                if (self.ort == null) self.ort = nil;
            ...
            $send((0), 'upto', [high], ($$53 = function(i){var self = $$53.$$s || this, $$54, $$55, f = nil;
              ...
              f = 0.0;
              $send(high, 'downto', [m], ($$54 = function(j){var self = $$54.$$s || this;
                if (self.ort == null) self.ort = nil;
                if (self.h == null) self.h = nil;
              ...
              f = $rb_divide(f, h);
              return $send(m, 'upto', [high], ($$55 = function(j){var self = $$55.$$s || this, $binary_op_recvr_tmp_6 = nil;
                if (self.h == null) self.h = nil;
                if (self.ort == null) self.ort = nil;
        ...
        $send(self.size, 'times', [], ($$56 = function(i){var self = $$56.$$s || this, $$57;
          if (self.size == null) self.size = nil;
          ...
          return $send(self.size, 'times', [], ($$57 = function(j){var self = $$57.$$s || this, $writer = nil;
            if (self.v == null) self.v = nil;
        ...
        return $send($rb_minus(high, 1), 'downto', [$rb_plus(low, 1)], ($$58 = function(m){var self = $$58.$$s || this, $$59, $$60;
          if (self.h == null) self.h = nil;
          ...
          if ($truthy(self.h['$[]'](m)['$[]']($rb_minus(m, 1))['$!='](0.0))) {
            ...
            $send($rb_plus(m, 1), 'upto', [high], ($$59 = function(i){var self = $$59.$$s || this, $writer = nil;
              if (self.h == null) self.h = nil;
              if (self.ort == null) self.ort = nil;
            ...
            return $send(m, 'upto', [high], ($$60 = function(j){var self = $$60.$$s || this, $$61, $$62, g = nil;
              if (self.ort == null) self.ort = nil;
              if (self.h == null) self.h = nil;
              ...
              g = 0.0;
              $send(m, 'upto', [high], ($$61 = function(i){var self = $$61.$$s || this;
                if (self.ort == null) self.ort = nil;
                if (self.v == null) self.v = nil;
              ...
              return $send(m, 'upto', [high], ($$62 = function(i){var self = $$62.$$s || this, $binary_op_recvr_tmp_7 = nil, $writer = nil;
                if (self.v == null) self.v = nil;
                if (self.ort == null) self.ort = nil;
      ...
      return (Opal.def(self, '$hessenberg_to_real_schur', $EigenvalueDecomposition_hessenberg_to_real_schur$63 = function $$hessenberg_to_real_schur() {
        ...
        p = (q = (r = (s = (z = 0))));
        norm = 0.0;
        $send(nn, 'times', [], ($$64 = function(i){var self = $$64.$$s || this, $a, $$65, $writer = nil;
          if (self.h == null) self.h = nil;
          if (self.d == null) self.d = nil;
          if (self.e == null) self.e = nil;
          ...
          if ($truthy(($truthy($a = $rb_lt(i, low)) ? $a : $rb_gt(i, high)))) {
            ...
            $send(self.e, '[]=', Opal.to_a($writer));
            $writer[$rb_minus($writer["length"], 1)];;};
          return $send([$rb_minus(i, 1), 0].$max(), 'upto', [$rb_minus(nn, 1)], ($$65 = function(j){var self = $$65.$$s || this;
            if (self.h == null) self.h = nil;
        ...
        while ($truthy($rb_ge(n, low))) {
          ...
          if ($truthy(l['$=='](n))) {
            ...
            if ($truthy($rb_ge(q, 0))) {
              ...
              p = $rb_divide(p, r);
              q = $rb_divide(q, r);
              $send($rb_minus(n, 1), 'upto', [$rb_minus(nn, 1)], ($$66 = function(j){var self = $$66.$$s || this;
                if (self.h == null) self.h = nil;
              ...
              $send((0), 'upto', [n], ($$67 = function(i){var self = $$67.$$s || this;
                if (self.h == null) self.h = nil;
              ...
              $send(low, 'upto', [high], ($$68 = function(i){var self = $$68.$$s || this;
                if (self.v == null) self.v = nil;
            ...
            if ($truthy(iter['$=='](10))) {
              ...
              $send(low, 'upto', [n], ($$69 = function(i){var self = $$69.$$s || this, $binary_op_recvr_tmp_8 = nil;
                if (self.h == null) self.h = nil;
            ...
            if ($truthy(iter['$=='](30))) {
              ...
              if ($truthy($rb_gt(s, 0))) {
                ...
                $send(low, 'upto', [n], ($$70 = function(i){var self = $$70.$$s || this, $binary_op_recvr_tmp_9 = nil;
                  if (self.h == null) self.h = nil;
            ...
            $send($rb_plus(m, 2), 'upto', [n], ($$71 = function(i){var self = $$71.$$s || this;
              if (self.h == null) self.h = nil;
            ...
            $send(m, 'upto', [$rb_minus(n, 1)], ($$72 = function(k){var self = $$72.$$s || this, $$73, $$74, $$75, notlast = nil;
              if (self.h == null) self.h = nil;
              ...
              if ($truthy(s['$!='](0))) {
                ...
                q = $rb_divide(q, p);
                r = $rb_divide(r, p);
                $send(k, 'upto', [$rb_minus(nn, 1)], ($$73 = function(j){var self = $$73.$$s || this;
                  if (self.h == null) self.h = nil;
                ...
                $send((0), 'upto', [[n, $rb_plus(k, 3)].$min()], ($$74 = function(i){var self = $$74.$$s || this;
                  if (self.h == null) self.h = nil;
                ...
                return $send(low, 'upto', [high], ($$75 = function(i){var self = $$75.$$s || this;
                  if (self.v == null) self.v = nil;
        ...
        if ($truthy(norm['$=='](0.0))) {
          return nil};
        $send($rb_minus(nn, 1), 'downto', [0], ($$76 = function(k){var self = $$76.$$s || this, $$77, $c, $d, $$80, cdivr = nil, cdivi = nil;
          if (self.d == null) self.d = nil;
          if (self.e == null) self.e = nil;
          if (self.h == null) self.h = nil;
          ...
          if ($truthy(q['$=='](0))) {
            ...
            $send(self.h['$[]'](k), '[]=', Opal.to_a($writer));
            $writer[$rb_minus($writer["length"], 1)];;
            return $send($rb_minus(k, 1), 'downto', [0], ($$77 = function(i){var self = $$77.$$s || this, $$78, $$79, t = nil;
              if (self.h == null) self.h = nil;
              if (self.e == null) self.e = nil;
              if (self.d == null) self.d = nil;
              ...
              r = 0.0;
              $send(l, 'upto', [k], ($$78 = function(j){var self = $$78.$$s || this;
                if (self.h == null) self.h = nil;
              ...
              if ($truthy($rb_lt(self.e['$[]'](i), 0.0))) {
                ...
                if ($truthy($rb_gt($rb_times($rb_times(eps, t), t), 1))) {
                  return $send(i, 'upto', [k], ($$79 = function(j){var self = $$79.$$s || this;
                    if (self.h == null) self.h = nil;
            ...
            $send(self.h['$[]'](n), '[]=', Opal.to_a($writer));
            $writer[$rb_minus($writer["length"], 1)];;
            return $send($rb_minus(n, 2), 'downto', [0], ($$80 = function(i){var self = $$80.$$s || this, $$81, $e, $f, $$82, ra = nil, sa = nil, vr = nil, vi = nil, t = nil;
              if (self.h == null) self.h = nil;
              if (self.e == null) self.e = nil;
              if (self.d == null) self.d = nil;
              ...
              ra = 0.0;
              sa = 0.0;
              $send(l, 'upto', [n], ($$81 = function(j){var self = $$81.$$s || this;
                if (self.h == null) self.h = nil;
              ...
              if ($truthy($rb_lt(self.e['$[]'](i), 0.0))) {
                ...
                if ($truthy($rb_gt($rb_times($rb_times(eps, t), t), 1))) {
                  return $send(i, 'upto', [n], ($$82 = function(j){var self = $$82.$$s || this;
                    if (self.h == null) self.h = nil;
        ...
        $send(nn, 'times', [], ($$83 = function(i){var self = $$83.$$s || this, $c, $$84;
          ...
          if ($truthy(($truthy($c = $rb_lt(i, low)) ? $c : $rb_gt(i, high)))) {
            return $send(i, 'upto', [$rb_minus(nn, 1)], ($$84 = function(j){var self = $$84.$$s || this;
              if (self.h == null) self.h = nil;
              if (self.v == null) self.v = nil;
        ...
        return $send($rb_minus(nn, 1), 'downto', [low], ($$85 = function(j){var self = $$85.$$s || this, $$86;
          ...
          return $send(low, 'upto', [high], ($$86 = function(i){var self = $$86.$$s || this, $$87;
            if (self.v == null) self.v = nil;
            ...
            z = 0.0;
            $send(low, 'upto', [[j, high].$min()], ($$87 = function(k){var self = $$87.$$s || this;
              if (self.v == null) self.v = nil;
              if (self.h == null) self.h = nil;
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return (function($base, $super, $parent_nesting) {
      ...
      Opal.def(self, '$l', $LUPDecomposition_l$1 = function $$l() {
        ...
        return $send($$($nesting, 'Matrix'), 'build', [self.row_count, [self.column_count, self.row_count].$min()], ($$2 = function(i, j){var self = $$2.$$s || this;
      ...
      Opal.def(self, '$u', $LUPDecomposition_u$3 = function $$u() {
        ...
        return $send($$($nesting, 'Matrix'), 'build', [[self.column_count, self.row_count].$min(), self.column_count], ($$4 = function(i, j){var self = $$4.$$s || this;
          if (self.lu == null) self.lu = nil;
      ...
      Opal.def(self, '$p', $LUPDecomposition_p$5 = function $$p() {
        ...
        rows = $send($$($nesting, 'Array'), 'new', [self.row_count], ($$6 = function(){var self = $$6.$$s || this;
          if (self.row_count == null) self.row_count = nil;

        return $$($nesting, 'Array').$new(self.row_count, 0)}, $$6.$$s = self, $$6.$$arity = 0, $$6));
        $send(self.pivots, 'each_with_index', [], ($$7 = function(p, i){var self = $$7.$$s || this, $writer = nil;
      ...
      Opal.def(self, '$singular?', $LUPDecomposition_singular$ques$9 = function() {try {
        ...
        $send(self.column_count, 'times', [], ($$10 = function(j){var self = $$10.$$s || this;
          if (self.lu == null) self.lu = nil;
      ...
      Opal.def(self, '$det', $LUPDecomposition_det$11 = function $$det() {
        ...
        d = self.pivot_sign;
        $send(self.column_count, 'times', [], ($$12 = function(j){var self = $$12.$$s || this;
          if (self.lu == null) self.lu = nil;
      ...
      Opal.def(self, '$solve', $LUPDecomposition_solve$13 = function $$solve(b) {
        ...
        if ($truthy(b['$is_a?']($$($nesting, 'Matrix')))) {
          ...
          if ($truthy(b.$row_count()['$!='](self.row_count))) {
            $$($nesting, 'Matrix').$Raise($$$($$($nesting, 'Matrix'), 'ErrDimensionMismatch'))};
          nx = b.$column_count();
          m = $send(self.pivots, 'map', [], ($$14 = function(row){var self = $$14.$$s || this;
          ...
          $send(self.column_count, 'times', [], ($$15 = function(k){var self = $$15.$$s || this, $$16;
            ...
            return $send($rb_plus(k, 1), 'upto', [$rb_minus(self.column_count, 1)], ($$16 = function(i){var self = $$16.$$s || this, $$17;
              ...
              return $send(nx, 'times', [], ($$17 = function(j){var self = $$17.$$s || this, $binary_op_recvr_tmp_10 = nil, $writer = nil;
                if (self.lu == null) self.lu = nil;
          ...
          $send($rb_minus(self.column_count, 1), 'downto', [0], ($$18 = function(k){var self = $$18.$$s || this, $$19, $$20;
            ...
            $send(nx, 'times', [], ($$19 = function(j){var self = $$19.$$s || this, $writer = nil;
              if (self.lu == null) self.lu = nil;
              ...
              return $writer[$rb_minus($writer["length"], 1)];}, $$19.$$s = self, $$19.$$arity = 1, $$19));
            return $send(k, 'times', [], ($$20 = function(i){var self = $$20.$$s || this, $$21;
              ...
              return $send(nx, 'times', [], ($$21 = function(j){var self = $$21.$$s || this, $binary_op_recvr_tmp_11 = nil, $writer = nil;
                if (self.lu == null) self.lu = nil;
          ...
          $send(self.column_count, 'times', [], ($$22 = function(k){var self = $$22.$$s || this, $$23;
            if (self.column_count == null) self.column_count = nil;
            ...
            return $send($rb_plus(k, 1), 'upto', [$rb_minus(self.column_count, 1)], ($$23 = function(i){var self = $$23.$$s || this, $writer = nil;
              if (self.lu == null) self.lu = nil;
          ...
          $send($rb_minus(self.column_count, 1), 'downto', [0], ($$24 = function(k){var self = $$24.$$s || this, $$25, $writer = nil;
            if (self.lu == null) self.lu = nil;
            ...
            $send(m, '[]=', Opal.to_a($writer));
            $writer[$rb_minus($writer["length"], 1)];;
            return $send(k, 'times', [], ($$25 = function(i){var self = $$25.$$s || this;
              if (self.lu == null) self.lu = nil;
      ...
      return (Opal.def(self, '$initialize', $LUPDecomposition_initialize$26 = function $$initialize(a) {
        ...
        $send(self.row_count, 'times', [], ($$27 = function(i){var self = $$27.$$s || this, $writer = nil;
        ...
        return $send(self.column_count, 'times', [], ($$28 = function(j){var self = $$28.$$s || this, $$29, $$30, $$32, $$33, $a, $$34, p = nil, k = nil, $writer = nil;
          if (self.row_count == null) self.row_count = nil;
          if (self.column_count == null) self.column_count = nil;
          if (self.pivots == null) self.pivots = nil;
          ...
          $send(self.row_count, 'times', [], ($$29 = function(i){var self = $$29.$$s || this, $writer = nil;
            if (self.lu == null) self.lu = nil;
            ...
            return $writer[$rb_minus($writer["length"], 1)];}, $$29.$$s = self, $$29.$$arity = 1, $$29));
          $send(self.row_count, 'times', [], ($$30 = function(i){var self = $$30.$$s || this, $$31, lu_row_i = nil, kmax = nil, s = nil, $writer = nil;
            if (self.lu == null) self.lu = nil;
            ...
            kmax = [i, j].$min();
            s = 0;
            $send(kmax, 'times', [], ($$31 = function(k){var self = $$31.$$s || this;
          ...
          p = j;
          $send($rb_plus(j, 1), 'upto', [$rb_minus(self.row_count, 1)], ($$32 = function(i){var self = $$32.$$s || this;
          ...
          if ($truthy(p['$!='](j))) {
            ...
            $send(self.column_count, 'times', [], ($$33 = function(k){var self = $$33.$$s || this, t = nil, $writer = nil;
              if (self.lu == null) self.lu = nil;
          ...
          if ($truthy(($truthy($a = $rb_lt(j, self.row_count)) ? self.lu['$[]'](j)['$[]'](j)['$!='](0) : $a))) {
            return $send($rb_plus(j, 1), 'upto', [$rb_minus(self.row_count, 1)], ($$34 = function(i){var self = $$34.$$s || this;
              if (self.lu == null) self.lu = nil;
...
Opal.modules["matrix"] = function(Opal) {
  ...
  (function($base, $super, $parent_nesting) {
    ...
    Opal.defs($$($nesting, 'Matrix'), '$rows', $Matrix_rows$2 = function $$rows(rows, copy) {
      ...
      $send(rows, 'map!', [], ($$3 = function(row){var self = $$3.$$s || this;
      ...
      $send(rows, 'each', [], ($$4 = function(row){var self = $$4.$$s || this;
    ...
    Opal.defs($$($nesting, 'Matrix'), '$build', $Matrix_build$6 = function $$build(row_count, column_count) {
      var $a, $$7, $iter = $Matrix_build$6.$$p, $yield = $iter || nil, self = this, rows = nil;
      ...
      rows = $send($$($nesting, 'Array'), 'new', [row_count], ($$7 = function(i){var self = $$7.$$s || this, $$8;
        ...
        return $send($$($nesting, 'Array'), 'new', [column_count], ($$8 = function(j){var self = $$8.$$s || this;
    ...
    Opal.defs($$($nesting, 'Matrix'), '$diagonal', $Matrix_diagonal$9 = function $$diagonal($a) {
      ...
      rows = $send($$($nesting, 'Array'), 'new', [size], ($$10 = function(j){var self = $$10.$$s || this, row = nil, $writer = nil;
    ...
    Opal.defs($$($nesting, 'Matrix'), '$zero', $Matrix_zero$13 = function $$zero(row_count, column_count) {
      ...
      rows = $send($$($nesting, 'Array'), 'new', [row_count], ($$14 = function(){var self = $$14.$$s || this;
    ...
    Opal.defs($$($nesting, 'Matrix'), '$vstack', $Matrix_vstack$18 = function $$vstack(x, $a) {
      ...
      $send(matrices, 'each', [], ($$19 = function(m){var self = $$19.$$s || this;
    ...
    Opal.defs($$($nesting, 'Matrix'), '$hstack', $Matrix_hstack$20 = function $$hstack(x, $a) {
      ...
      $send(matrices, 'each', [], ($$21 = function(m){var self = $$21.$$s || this, $$22;
        ...
        $send(result, 'each_with_index', [], ($$22 = function(row, i){var self = $$22.$$s || this;
    ...
    Opal.defs($$($nesting, 'Matrix'), '$combine', $Matrix_combine$23 = function $$combine($a) {
      ...
      x = matrices.$first();
      $send(matrices, 'each', [], ($$24 = function(m){var self = $$24.$$s || this, $b;
      ...
      rows = $send($$($nesting, 'Array'), 'new', [x.$row_count()], ($$25 = function(i){var self = $$25.$$s || this, $$26;
        ...
        return $send($$($nesting, 'Array'), 'new', [x.$column_count()], ($$26 = function(j){var self = $$26.$$s || this, $$27;
          ...
          return Opal.yield1($yield, $send(matrices, 'map', [], ($$27 = function(m){var self = $$27.$$s || this;
    ...
    Opal.def(self, '$[]', $Matrix_$$$31 = function(i, j) {try {
      ...
      return $send(self.rows, 'fetch', [i], ($$32 = function(){var self = $$32.$$s || this;
    ...
    Opal.def(self, '$row', $Matrix_row$35 = function $$row(i) {try {
      ...
      if ((block !== nil)) {
        ...
        $send($send(self.rows, 'fetch', [i], ($$36 = function(){var self = $$36.$$s || this;

        Opal.ret(self)}, $$36.$$s = self, $$36.$$arity = 0, $$36)), 'each', [], block.$to_proc());
        return self;
      } else {
        return $$($nesting, 'Vector').$elements($send(self.rows, 'fetch', [i], ($$37 = function(){var self = $$37.$$s || this;
    ...
    Opal.def(self, '$column', $Matrix_column$38 = function $$column(j) {
      var $a, $$39, $$40, $iter = $Matrix_column$38.$$p, $yield = $iter || nil, self = this, col = nil;
      ...
      if (($yield !== nil)) {
        ...
        if ($truthy(($truthy($a = $rb_ge(j, self.$column_count())) ? $a : $rb_lt(j, self.$column_count()['$-@']())))) {
          return self};
        $send(self.$row_count(), 'times', [], ($$39 = function(i){var self = $$39.$$s || this;
        ...
        if ($truthy(($truthy($a = $rb_ge(j, self.$column_count())) ? $a : $rb_lt(j, self.$column_count()['$-@']())))) {
          return nil};
        col = $send($$($nesting, 'Array'), 'new', [self.$row_count()], ($$40 = function(i){var self = $$40.$$s || this;
          if (self.rows == null) self.rows = nil;
    ...
    Opal.def(self, '$collect', $Matrix_collect$41 = function $$collect() {
      ...
      rows = $send(self.rows, 'collect', [], ($$42 = function(row){var self = $$42.$$s || this;
    ...
    Opal.def(self, '$each', $Matrix_each$43 = function $$each(which) {try {
      ...
      $send(self.rows, 'each', [], ($$44 = function(row){var self = $$44.$$s || this;
      ...
      else if ("diagonal"['$===']($case)) {$send(self.rows, 'each_with_index', [], ($$45 = function(row, row_index){var self = $$45.$$s || this, $$46;
        ...
        return Opal.yield1($yield, $send(row, 'fetch', [row_index], ($$46 = function(){var self = $$46.$$s || this;

        Opal.ret(self)}, $$46.$$s = self, $$46.$$arity = 0, $$46)));;}, $$45.$$s = self, $$45.$$arity = 2, $$45))}
      else if ("off_diagonal"['$===']($case)) {$send(self.rows, 'each_with_index', [], ($$47 = function(row, row_index){var self = $$47.$$s || this, $$48;
        ...
        return $send(self.$column_count(), 'times', [], ($$48 = function(col_index){var self = $$48.$$s || this;
      ...
      else if ("lower"['$===']($case)) {$send(self.rows, 'each_with_index', [], ($$49 = function(row, row_index){var self = $$49.$$s || this, $$50;
        ...
        return $send((0), 'upto', [[row_index, last].$min()], ($$50 = function(col_index){var self = $$50.$$s || this;
      ...
      else if ("strict_lower"['$===']($case)) {$send(self.rows, 'each_with_index', [], ($$51 = function(row, row_index){var self = $$51.$$s || this, $$52;
        ...
        return $send([row_index, self.$column_count()].$min(), 'times', [], ($$52 = function(col_index){var self = $$52.$$s || this;
      ...
      else if ("strict_upper"['$===']($case)) {$send(self.rows, 'each_with_index', [], ($$53 = function(row, row_index){var self = $$53.$$s || this, $$54;
        ...
        return $send($rb_plus(row_index, 1), 'upto', [last], ($$54 = function(col_index){var self = $$54.$$s || this;
      ...
      else if ("upper"['$===']($case)) {$send(self.rows, 'each_with_index', [], ($$55 = function(row, row_index){var self = $$55.$$s || this, $$56;
        ...
        return $send(row_index, 'upto', [last], ($$56 = function(col_index){var self = $$56.$$s || this;
    ...
    Opal.def(self, '$each_with_index', $Matrix_each_with_index$57 = function $$each_with_index(which) {try {
      ...
      last = $rb_minus(self.$column_count(), 1);
      $case = which;
      if ("all"['$===']($case)) {$send(self.rows, 'each_with_index', [], ($$58 = function(row, row_index){var self = $$58.$$s || this, $$59;
        ...
        return $send(row, 'each_with_index', [], ($$59 = function(e, col_index){var self = $$59.$$s || this;
      ...
      else if ("diagonal"['$===']($case)) {$send(self.rows, 'each_with_index', [], ($$60 = function(row, row_index){var self = $$60.$$s || this, $$61;
        ...
        return Opal.yieldX($yield, [$send(row, 'fetch', [row_index], ($$61 = function(){var self = $$61.$$s || this;

        Opal.ret(self)}, $$61.$$s = self, $$61.$$arity = 0, $$61)), row_index, row_index]);;}, $$60.$$s = self, $$60.$$arity = 2, $$60))}
      else if ("off_diagonal"['$===']($case)) {$send(self.rows, 'each_with_index', [], ($$62 = function(row, row_index){var self = $$62.$$s || this, $$63;
        ...
        return $send(self.$column_count(), 'times', [], ($$63 = function(col_index){var self = $$63.$$s || this;
      ...
      else if ("lower"['$===']($case)) {$send(self.rows, 'each_with_index', [], ($$64 = function(row, row_index){var self = $$64.$$s || this, $$65;
        ...
        return $send((0), 'upto', [[row_index, last].$min()], ($$65 = function(col_index){var self = $$65.$$s || this;
      ...
      else if ("strict_lower"['$===']($case)) {$send(self.rows, 'each_with_index', [], ($$66 = function(row, row_index){var self = $$66.$$s || this, $$67;
        ...
        return $send([row_index, self.$column_count()].$min(), 'times', [], ($$67 = function(col_index){var self = $$67.$$s || this;
      ...
      else if ("strict_upper"['$===']($case)) {$send(self.rows, 'each_with_index', [], ($$68 = function(row, row_index){var self = $$68.$$s || this, $$69;
        ...
        return $send($rb_plus(row_index, 1), 'upto', [last], ($$69 = function(col_index){var self = $$69.$$s || this;
      ...
      else if ("upper"['$===']($case)) {$send(self.rows, 'each_with_index', [], ($$70 = function(row, row_index){var self = $$70.$$s || this, $$71;
        ...
        return $send(row_index, 'upto', [last], ($$71 = function(col_index){var self = $$71.$$s || this;
    ...
    Opal.def(self, '$index', $Matrix_index$72 = function $$index($a) {try {
      ...
      var $post_args, args, $b, $$73, $$74, $iter = $Matrix_index$72.$$p, $yield = $iter || nil, self = this, which = nil, value = nil;
      ...
      if (args.$size()['$=='](1)) {
        ...
        value = args.$first();
        $send(self, 'each_with_index', [which], ($$73 = function(e, row_index, col_index){var self = $$73.$$s || this;
        ...
        $send(self, 'each_with_index', [which], ($$74 = function(e, row_index, col_index){var self = $$74.$$s || this;
    ...
    Opal.def(self, '$minor', $Matrix_minor$75 = function $$minor($a) {
      var $post_args, param, $b, $c, $d, $$76, self = this, $case = nil, row_range = nil, col_range = nil, from_row = nil, to_row = nil, size_row = nil, from_col = nil, to_col = nil, size_col = nil, rows = nil;
      ...
      if ($truthy(($truthy($b = ($truthy($c = ($truthy($d = $rb_gt(from_row, self.$row_count())) ? $d : $rb_gt(from_col, self.$column_count()))) ? $c : $rb_lt(from_row, 0))) ? $b : $rb_lt(from_col, 0)))) {
        return nil};
      rows = $send(self.rows['$[]'](from_row, size_row), 'collect', [], ($$76 = function(row){var self = $$76.$$s || this;
    ...
    Opal.def(self, '$first_minor', $Matrix_first_minor$77 = function $$first_minor(row, column) {
      ...
      $send(arrays, 'each', [], ($$78 = function(array){var self = $$78.$$s || this;
    ...
    Opal.def(self, '$adjugate', $Matrix_adjugate$80 = function $$adjugate() {
      ...
      return $send($$($nesting, 'Matrix'), 'build', [self.$row_count(), self.$column_count()], ($$81 = function(row, column){var self = $$81.$$s || this;
    ...
    Opal.def(self, '$laplace_expansion', $Matrix_laplace_expansion$82 = function $$laplace_expansion($kwargs) {
      var row, column, $a, $b, $$83, self = this, num = nil;
      ...
      return $send(self.$send((function() {if ($truthy(row)) {
        ...
        return "column"
      }; return nil; })(), num).$map(), 'with_index', [], ($$83 = function(e, k){var self = $$83.$$s || this;
    ...
    Opal.def(self, '$hermitian?', $Matrix_hermitian$ques$86 = function() {
      ...
      return $send(self.$each_with_index("upper"), 'all?', [], ($$87 = function(e, row, col){var self = $$87.$$s || this;
    ...
    Opal.def(self, '$normal?', $Matrix_normal$ques$89 = function() {try {
      ...
      $send(self.$rows(), 'each_with_index', [], ($$90 = function(row_i, i){var self = $$90.$$s || this, $$91;
        ...
        return $send(self.$rows(), 'each_with_index', [], ($$91 = function(row_j, j){var self = $$91.$$s || this, $$92, s = nil;
          ...
          s = 0;
          $send(self.$rows(), 'each_with_index', [], ($$92 = function(row_k, k){var self = $$92.$$s || this;
    ...
    Opal.def(self, '$orthogonal?', $Matrix_orthogonal$ques$93 = function() {try {
      ...
      $send(self.$rows(), 'each_with_index', [], ($$94 = function(row, i){var self = $$94.$$s || this, $$95;
        ...
        return $send(self.$column_count(), 'times', [], ($$95 = function(j){var self = $$95.$$s || this, $$96, s = nil;
          ...
          s = 0;
          $send(self.$row_count(), 'times', [], ($$96 = function(k){var self = $$96.$$s || this;
    ...
    Opal.def(self, '$permutation?', $Matrix_permutation$ques$97 = function() {try {
      ...
      $send(self.$rows(), 'each_with_index', [], ($$98 = function(row, i){var self = $$98.$$s || this, $$99, found = nil;
        ...
        found = false;
        $send(row, 'each_with_index', [], ($$99 = function(e, j){var self = $$99.$$s || this, $a, $writer = nil;
    ...
    Opal.def(self, '$symmetric?', $Matrix_symmetric$ques$104 = function() {try {
      ...
      $send(self, 'each_with_index', ["strict_upper"], ($$105 = function(e, row, col){var self = $$105.$$s || this;
    ...
    Opal.def(self, '$antisymmetric?', $Matrix_antisymmetric$ques$106 = function() {try {
      ...
      $send(self, 'each_with_index', ["upper"], ($$107 = function(e, row, col){var self = $$107.$$s || this;
    ...
    Opal.def(self, '$unitary?', $Matrix_unitary$ques$108 = function() {try {
      ...
      $send(self.$rows(), 'each_with_index', [], ($$109 = function(row, i){var self = $$109.$$s || this, $$110;
        ...
        return $send(self.$column_count(), 'times', [], ($$110 = function(j){var self = $$110.$$s || this, $$111, s = nil;
          ...
          s = 0;
          $send(self.$row_count(), 'times', [], ($$111 = function(k){var self = $$111.$$s || this;
    ...
    Opal.def(self, '$*', $Matrix_$$118 = function(m) {
      ...
      rows = $send(self.rows, 'collect', [], ($$119 = function(row){var self = $$119.$$s || this, $$120;
        ...
        return $send(row, 'collect', [], ($$120 = function(e){var self = $$120.$$s || this;
      ...
      if ($truthy(self.$column_count()['$!='](m.$row_count()))) {
        $$($nesting, 'Matrix').$Raise($$($nesting, 'ErrDimensionMismatch'))};
      rows = $send($$($nesting, 'Array'), 'new', [self.$row_count()], ($$121 = function(i){var self = $$121.$$s || this, $$122;
        ...
        return $send($$($nesting, 'Array'), 'new', [m.$column_count()], ($$122 = function(j){var self = $$122.$$s || this, $$123;
          ...
          return $send(Opal.Range.$new(0,self.$column_count(), true), 'inject', [0], ($$123 = function(vij, k){var self = $$123.$$s || this;
    ...
    Opal.def(self, '$+', $Matrix_$plus$124 = function(m) {
      var $a, $$125, self = this, $case = nil, rows = nil;
      ...
      rows = $send($$($nesting, 'Array'), 'new', [self.$row_count()], ($$125 = function(i){var self = $$125.$$s || this, $$126;
        ...
        return $send($$($nesting, 'Array'), 'new', [self.$column_count()], ($$126 = function(j){var self = $$126.$$s || this;
    ...
    Opal.def(self, '$-', $Matrix_$minus$127 = function(m) {
      var $a, $$128, self = this, $case = nil, rows = nil;
      ...
      rows = $send($$($nesting, 'Array'), 'new', [self.$row_count()], ($$128 = function(i){var self = $$128.$$s || this, $$129;
        ...
        return $send($$($nesting, 'Array'), 'new', [self.$column_count()], ($$129 = function(j){var self = $$129.$$s || this;
    ...
    Opal.def(self, '$/', $Matrix_$slash$130 = function(other) {
      ...
      if ($$($nesting, 'Numeric')['$===']($case)) {
      rows = $send(self.rows, 'collect', [], ($$131 = function(row){var self = $$131.$$s || this, $$132;
        ...
        return $send(row, 'collect', [], ($$132 = function(e){var self = $$132.$$s || this;
    ...
    Opal.def(self, '$hadamard_product', $Matrix_hadamard_product$133 = function $$hadamard_product(m) {
      ...
      return $send(self, 'combine', [m], ($$134 = function(a, b){var self = $$134.$$s || this;
    ...
    Opal.def(self, '$inverse_from', $Matrix_inverse_from$136 = function $$inverse_from(src) {
      ...
      a = src.$to_a();
      $send((0), 'upto', [last], ($$137 = function(k){var self = $$137.$$s || this, $$138, $a, $$139, $$142, $$143, i = nil, akk = nil;
        if (self.rows == null) self.rows = nil;
        ...
        i = k;
        akk = a['$[]'](k)['$[]'](k).$abs();
        $send($rb_plus(k, 1), 'upto', [last], ($$138 = function(j){var self = $$138.$$s || this, v = nil;
        ...
        akk = a['$[]'](k)['$[]'](k);
        $send((0), 'upto', [last], ($$139 = function(ii){var self = $$139.$$s || this, $$140, $$141, q = nil, $writer = nil;
          ...
          $writer[$rb_minus($writer["length"], 1)];;
          $send($rb_plus(k, 1), 'upto', [last], ($$140 = function(j){var self = $$140.$$s || this, $binary_op_recvr_tmp_1 = nil;
          ...
          return $send((0), 'upto', [last], ($$141 = function(j){var self = $$141.$$s || this, $binary_op_recvr_tmp_2 = nil;
            if (self.rows == null) self.rows = nil;
        ...
        $send($rb_plus(k, 1), 'upto', [last], ($$142 = function(j){var self = $$142.$$s || this, $writer = nil;
        ...
        return $send((0), 'upto', [last], ($$143 = function(j){var self = $$143.$$s || this, $writer = nil;
          if (self.rows == null) self.rows = nil;
    ...
    Opal.def(self, '$**', $Matrix_$$$144 = function(other) {try {
      ...
      if ($truthy($rb_le(other, 0))) {
        ...
        other = other['$-@']();};
      z = nil;
      return $send(self, 'loop', [], ($$145 = function(){var self = $$145.$$s || this;
      ...
      return $rb_times($rb_times(v, $send(self.$class(), 'diagonal', Opal.to_a($send(d.$each("diagonal"), 'map', [], ($$146 = function(e){var self = $$146.$$s || this;
    ...
    Opal.def(self, '$-@', $Matrix_$minus$$148 = function() {
      ...
      return $send(self, 'collect', [], ($$149 = function(e){var self = $$149.$$s || this;
    ...
    Opal.def(self, '$determinant_bareiss', $Matrix_determinant_bareiss$151 = function $$determinant_bareiss() {try {
      ...
      a = self.$to_a();
      no_pivot = $send($$($nesting, 'Proc'), 'new', [], ($$152 = function(){var self = $$152.$$s || this;

      Opal.ret(0)}, $$152.$$s = self, $$152.$$arity = 0, $$152));
      sign = 1;
      pivot = 1;
      $send(size, 'times', [], ($$153 = function(k){var self = $$153.$$s || this, $$154, $a, $$155, previous_pivot = nil, switch$ = nil;
        ...
        if ((pivot = a['$[]'](k)['$[]'](k))['$=='](0)) {
          ...
          switch$ = $send(Opal.Range.$new($rb_plus(k, 1),size, true), 'find', [no_pivot], ($$154 = function(row){var self = $$154.$$s || this;
          ...
          pivot = a['$[]'](k)['$[]'](k);
          sign = sign['$-@']();};
        return $send($rb_plus(k, 1), 'upto', [last], ($$155 = function(i){var self = $$155.$$s || this, $$156, ai = nil;
          ...
          ai = a['$[]'](i);
          return $send($rb_plus(k, 1), 'upto', [last], ($$156 = function(j){var self = $$156.$$s || this, $writer = nil;
    ...
    Opal.def(self, '$rank', $Matrix_rank$159 = function $$rank() {
      ...
      pivot_row = 0;
      previous_pivot = 1;
      $send((0), 'upto', [last_column], ($$160 = function(k){var self = $$160.$$s || this, $$161, $a, $$162, switch_row = nil, pivot = nil;
        ...
        switch_row = $send(Opal.Range.$new(pivot_row, last_row, false), 'find', [], ($$161 = function(row){var self = $$161.$$s || this;
        ...
        if ($truthy(switch_row)) {
          ...
          pivot = a['$[]'](pivot_row)['$[]'](k);
          $send($rb_plus(pivot_row, 1), 'upto', [last_row], ($$162 = function(i){var self = $$162.$$s || this, $$163, ai = nil;
            ...
            ai = a['$[]'](i);
            return $send($rb_plus(k, 1), 'upto', [last_column], ($$163 = function(j){var self = $$163.$$s || this, $writer = nil;
    ...
    Opal.def(self, '$round', $Matrix_round$165 = function $$round(ndigits) {
      ...
      return $send(self, 'map', [], ($$166 = function(e){var self = $$166.$$s || this;
    ...
    Opal.def(self, '$trace', $Matrix_trace$167 = function $$trace() {
      ...
      return $send(Opal.Range.$new(0,self.$column_count(), true), 'inject', [0], ($$168 = function(tr, i){var self = $$168.$$s || this;
        if (self.rows == null) self.rows = nil;
    ...
    Opal.def(self, '$row_vectors', $Matrix_row_vectors$178 = function $$row_vectors() {
      ...
      return $send($$($nesting, 'Array'), 'new', [self.$row_count()], ($$179 = function(i){var self = $$179.$$s || this;
    ...
    Opal.def(self, '$column_vectors', $Matrix_column_vectors$180 = function $$column_vectors() {
      ...
      return $send($$($nesting, 'Array'), 'new', [self.$column_count()], ($$181 = function(i){var self = $$181.$$s || this;
    ...
    Opal.def(self, '$to_s', $Matrix_to_s$187 = function $$to_s() {
      ...
      if ($truthy(self['$empty?']())) {
        ...
        return $rb_plus($rb_plus("" + (self.$class()) + "[", $send(self.rows, 'collect', [], ($$188 = function(row){var self = $$188.$$s || this, $$189;
          ...
          return $rb_plus($rb_plus("[", $send(row, 'collect', [], ($$189 = function(e){var self = $$189.$$s || this;
    ...
    return (function($base, $super, $parent_nesting) {
      ...
      Opal.def(self, '$*', $Scalar_$$199 = function(other) {
        ...
        else if ($$($nesting, 'Vector')['$===']($case) || $$($nesting, 'Matrix')['$===']($case)) {return $send(other, 'collect', [], ($$200 = function(e){var self = $$200.$$s || this;
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$round', $Vector_round$210 = function $$round(ndigits) {
      ...
      return $send(self, 'map', [], ($$211 = function(e){var self = $$211.$$s || this;
    ...
    Opal.def(self, '$each2', $Vector_each2$214 = function $$each2(v) {
      ...
      $send(self.$size(), 'times', [], ($$215 = function(i){var self = $$215.$$s || this;
    ...
    Opal.def(self, '$collect2', $Vector_collect2$216 = function $$collect2(v) {
      ...
      return $send($$($nesting, 'Array'), 'new', [self.$size()], ($$217 = function(i){var self = $$217.$$s || this;
        if (self.elements == null) self.elements = nil;
    ...
    Opal.defs($$($nesting, 'Vector'), '$independent?', $Vector_independent$ques$218 = function($a) {
      ...
      vs = $post_args;;
      $send(vs, 'each', [], ($$219 = function(v){var self = $$219.$$s || this;
    ...
    Opal.def(self, '$*', $Vector_$$226 = function(x) {
      ...
      if ($$($nesting, 'Numeric')['$===']($case)) {
      els = $send(self.elements, 'collect', [], ($$227 = function(e){var self = $$227.$$s || this;
    ...
    Opal.def(self, '$+', $Vector_$plus$228 = function(v) {
      ...
      if ($truthy(self.$size()['$!='](v.$size()))) {
        $$($nesting, 'Vector').$Raise($$($nesting, 'ErrDimensionMismatch'))};
      els = $send(self, 'collect2', [v], ($$229 = function(v1, v2){var self = $$229.$$s || this;
    ...
    Opal.def(self, '$-', $Vector_$minus$230 = function(v) {
      ...
      if ($truthy(self.$size()['$!='](v.$size()))) {
        $$($nesting, 'Vector').$Raise($$($nesting, 'ErrDimensionMismatch'))};
      els = $send(self, 'collect2', [v], ($$231 = function(v1, v2){var self = $$231.$$s || this;
    ...
    Opal.def(self, '$/', $Vector_$slash$232 = function(x) {
      ...
      return (function() {$case = x;
      if ($$($nesting, 'Numeric')['$===']($case)) {
      els = $send(self.elements, 'collect', [], ($$233 = function(e){var self = $$233.$$s || this;
    ...
    Opal.def(self, '$-@', $Vector_$minus$$235 = function() {
      ...
      return $send(self, 'collect', [], ($$236 = function(e){var self = $$236.$$s || this;
    ...
    Opal.def(self, '$inner_product', $Vector_inner_product$237 = function $$inner_product(v) {
      ...
      if ($truthy(self.$size()['$!='](v.$size()))) {
        $$($nesting, 'Vector').$Raise($$($nesting, 'ErrDimensionMismatch'))};
      p = 0;
      $send(self, 'each2', [v], ($$238 = function(v1, v2){var self = $$238.$$s || this;
    ...
    Opal.def(self, '$cross_product', $Vector_cross_product$239 = function $$cross_product($a) {
      ...
      $send(vs, 'each', [], ($$240 = function(v){var self = $$240.$$s || this;
      ...
      rows = [self].concat(Opal.to_a(vs)).concat([$send($$($nesting, 'Array'), 'new', [self.$size()], ($$241 = function(i){var self = $$241.$$s || this;
    ...
    Opal.def(self, '$magnitude', $Vector_magnitude$243 = function $$magnitude() {
      ...
      return $$($nesting, 'Math').$sqrt($send(self.elements, 'inject', [0], ($$244 = function(v, e){var self = $$244.$$s || this;
