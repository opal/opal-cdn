Opal.modules["opal/raw"] = function(Opal) {/* Generated by Opal 1.8.3.rc1 */
...
Opal.modules["bigdecimal/bignumber"] = function(Opal) {/* Generated by Opal 1.8.3.rc1 */
...
Opal.modules["bigdecimal"] = function(Opal) {/* Generated by Opal 1.8.3.rc1 */
  var $klass = Opal.klass, $module = Opal.module, $def = Opal.def, $slice = Opal.slice, $extract_kwargs = Opal.extract_kwargs, $ensure_kwargs = Opal.ensure_kwargs, $kwrestargs = Opal.kwrestargs, $send = Opal.send, $to_a = Opal.to_a, $defs = Opal.defs, $const_set = Opal.const_set, $truthy = Opal.truthy, $eqeqeq = Opal.eqeqeq, $send2 = Opal.send2, $find_super = Opal.find_super, $rb_lt = Opal.rb_lt, $to_ary = Opal.to_ary, $rb_gt = Opal.rb_gt, $rb_ge = Opal.rb_ge, $eqeq = Opal.eqeq, $rb_divide = Opal.rb_divide, $alias = Opal.alias, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $$$ = Opal.$$$;
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$initialize', function $$initialize(initial, digits) {
      ...
      if (digits == null) digits = 0;
      return (self.bignumber = $$$($$('Opal'), 'Raw').$new($$('BigNumber'), initial));
    }, -2);
    ...
    $def(self, '$abs', function $$abs() {
      ...
      return self.$BigDecimal(self.$bignumber().abs())
    });
    ...
    $def(self, '$ceil', function $$ceil(n) {
      ...
      if ($truthy(n['$nil?']())) {
        ...
        return self.$BigDecimal(self.$bignumber().round(n, $$('ROUND_CEILING')))
      } else {
        return self.$BigDecimal(self.$bignumber().round(0, $$('ROUND_CEILING')))
      };
    }, -1);
    ...
    $def(self, '$coerce', function $$coerce(other) {
      ...
      if ($eqeqeq(self.$class(), ($ret_or_1 = other))) {
        ...
        return [self.$BigDecimal(other), self]
      } else {
    ...
    $def(self, '$div', function $$div(other, digits) {
      ...
      if ($truthy(digits['$nil?']())) {
        ...
        return self.$BigDecimal(self.$bignumber().dividedToIntegerBy(other.$bignumber()));
      };
      return self.$BigDecimal(self.$bignumber().dividedBy(other.$bignumber()).round(digits, self.$class().$mode($$('ROUND_MODE'))));
    }, -2);
    ...
    $def(self, '$minus', function $$minus(other) {
      ...
      $b = self.$coerce(other), $a = $to_ary($b), (other = ($a[0] == null ? nil : $a[0])), (_ = ($a[1] == null ? nil : $a[1])), $b;
      return self.$BigDecimal(self.$bignumber().minus(other.$bignumber()));
    });
    ...
    $def(self, '$mult', function $$mult(other, digits) {
      ...
      $b = self.$coerce(other), $a = $to_ary($b), (other = ($a[0] == null ? nil : $a[0])), (_ = ($a[1] == null ? nil : $a[1])), $b;
      if ($truthy(digits['$nil?']())) {
        return self.$BigDecimal(self.$bignumber().times(other.$bignumber()))
      };
      return self.$BigDecimal(self.$bignumber().times(other.$bignumber()).round(digits, self.$class().$mode($$('ROUND_MODE'))));
    }, -2);
    ...
    $def(self, '$quo', function $$quo(other) {
      ...
      $b = self.$coerce(other), $a = $to_ary($b), (other = ($a[0] == null ? nil : $a[0])), (_ = ($a[1] == null ? nil : $a[1])), $b;
      return self.$BigDecimal(self.$bignumber().dividedBy(other.$bignumber()));
    });
