...
Opal.modules["benchmark"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    Opal.def(self, '$benchmark', $Benchmark_benchmark$1 = function $$benchmark($a, $b, $c, $d) {
      var $post_args, caption, label_width, format, labels, $e, $$2, $iter = $Benchmark_benchmark$1.$$p, $yield = $iter || nil, self = this, sync = nil, $writer = nil, report = nil, results = nil;
      ...
      ($truthy($e = $$($nesting, 'Array')['$==='](results)) ? $send(results.$grep($$($nesting, 'Tms')), 'each', [], ($$2 = function(t){var self = $$2.$$s || this, $f, $g;
        ...
        return self.$print(($truthy($f = ($truthy($g = labels.$shift()) ? $g : t.$label())) ? $f : "").$ljust(label_width), t.$format(format));}, $$2.$$s = self, $$2.$$arity = 1, $$2)) : $e);
      return report.$list();
      } finally {
    ...
    Opal.def(self, '$bmbm', $Benchmark_bmbm$4 = function $$bmbm(width) {
      ...
      ets = $send(job.$list(), 'inject', [$$($nesting, 'Tms').$new()], ($$5 = function(sum, $mlhs_tmp1){var self = $$5.$$s || this, $a, $b, label = nil, item = nil, res = nil;
      ...
      return $send(job.$list(), 'map', [], ($$6 = function(label, item){var self = $$6.$$s || this, $$7;
        ...
        $$($nesting, 'GC').$start();
        self.$print(label.$ljust(width));
        return $send($send($$($nesting, 'Benchmark'), 'measure', [label], item.$to_proc()), 'tap', [], ($$7 = function(res){var self = $$7.$$s || this;
    ...
    (function($base, $super, $parent_nesting) {
      ...
      Opal.def(self, '$format', $Tms_format$21 = function $$format($a, $b) {
        var $post_args, format, args, $c, $$22, $$23, $$24, $$25, $$26, $$27, $$28, self = this, str = nil;
        ...
        args = $post_args;;
        str = $send($send($send($send($send($send($send(($truthy($c = format) ? $c : $$($nesting, 'FORMAT')).$dup(), 'gsub', [/(%[-+.\d]*)n/], ($$22 = function(){var self = $$22.$$s || this, $d;

        return (("" + ((($d = $gvars['~']) === nil ? nil : $d['$[]'](1)))) + "s")['$%'](self.$label())}, $$22.$$s = self, $$22.$$arity = 0, $$22)), 'gsub', [/(%[-+.\d]*)u/], ($$23 = function(){var self = $$23.$$s || this, $d;

        return (("" + ((($d = $gvars['~']) === nil ? nil : $d['$[]'](1)))) + "f")['$%'](self.$utime())}, $$23.$$s = self, $$23.$$arity = 0, $$23)), 'gsub', [/(%[-+.\d]*)y/], ($$24 = function(){var self = $$24.$$s || this, $d;

        return (("" + ((($d = $gvars['~']) === nil ? nil : $d['$[]'](1)))) + "f")['$%'](self.$stime())}, $$24.$$s = self, $$24.$$arity = 0, $$24)), 'gsub', [/(%[-+.\d]*)U/], ($$25 = function(){var self = $$25.$$s || this, $d;

        return (("" + ((($d = $gvars['~']) === nil ? nil : $d['$[]'](1)))) + "f")['$%'](self.$cutime())}, $$25.$$s = self, $$25.$$arity = 0, $$25)), 'gsub', [/(%[-+.\d]*)Y/], ($$26 = function(){var self = $$26.$$s || this, $d;

        return (("" + ((($d = $gvars['~']) === nil ? nil : $d['$[]'](1)))) + "f")['$%'](self.$cstime())}, $$26.$$s = self, $$26.$$arity = 0, $$26)), 'gsub', [/(%[-+.\d]*)t/], ($$27 = function(){var self = $$27.$$s || this, $d;

        return (("" + ((($d = $gvars['~']) === nil ? nil : $d['$[]'](1)))) + "f")['$%'](self.$total())}, $$27.$$s = self, $$27.$$arity = 0, $$27)), 'gsub', [/(%[-+.\d]*)r/], ($$28 = function(){var self = $$28.$$s || this, $d;

        return ((("" + "(") + ((($d = $gvars['~']) === nil ? nil : $d['$[]'](1)))) + "f)")['$%'](self.$real())}, $$28.$$s = self, $$28.$$arity = 0, $$28));
        if ($truthy(format)) {
          return str['$%'](args)
        } else {
          return str
