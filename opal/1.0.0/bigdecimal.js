...
Opal.modules["bigdecimal/kernel"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    Opal.def(self, '$BigDecimal', $Kernel_BigDecimal$1 = function $$BigDecimal(initial, digits) {
      var self = this;
      ...
      return $$($nesting, 'BigDecimal').$new(initial, digits);
    }, $Kernel_BigDecimal$1.$$arity = -2)
  })($nesting[0], $nesting)
};
...
Opal.modules["bigdecimal"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$===', '$attr_reader', '$new', '$class', '$bignumber', '$nan?', '$nil?', '$raise', '$<', '$coerce', '$>', '$mode', '$>=', '$==', '$/', '$zero?', '$infinite?', '$finite?']);
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var $nesting = [self].concat($parent_nesting), $BigDecimal_limit$1, $BigDecimal_mode$2, $BigDecimal_initialize$3, $BigDecimal_$eq_eq$4, $BigDecimal_$lt_eq_gt$5, $BigDecimal_$lt$6, $BigDecimal_$lt_eq$7, $BigDecimal_$gt$8, $BigDecimal_$gt_eq$9, $BigDecimal_abs$10, $BigDecimal_add$11, $BigDecimal_ceil$12, $BigDecimal_coerce$13, $BigDecimal_div$14, $BigDecimal_finite$ques$15, $BigDecimal_infinite$ques$16, $BigDecimal_minus$17, $BigDecimal_mult$18, $BigDecimal_nan$ques$19, $BigDecimal_quo$20, $BigDecimal_sign$21, $BigDecimal_sub$22, $BigDecimal_to_f$23, $BigDecimal_to_s$24, $BigDecimal_zero$ques$25;
    ...
    Opal.defs(self, '$limit', $BigDecimal_limit$1 = function $$limit(digits) {
      var self = this;
      ...
      if ($truthy(digits)) {
        self.digits = digits};
      return self.digits;
    }, $BigDecimal_limit$1.$$arity = -1);
    Opal.defs(self, '$mode', $BigDecimal_mode$2 = function $$mode(mode, value) {
      ...
      return ($truthy($a = self.round_mode) ? $a : $$($nesting, 'ROUND_HALF_UP'));}
      else { return nil }})();
    }, $BigDecimal_mode$2.$$arity = -2);
    self.$attr_reader("bignumber");
    
    Opal.def(self, '$initialize', $BigDecimal_initialize$3 = function $$initialize(initial, digits) {
      var self = this;
    ...
    }, $BigDecimal_initialize$3.$$arity = -2);
    
    Opal.def(self, '$==', $BigDecimal_$eq_eq$4 = function(other) {
    ...
    }, $BigDecimal_$eq_eq$4.$$arity = 1);
    Opal.alias(self, "===", "==");
    
    Opal.def(self, '$<=>', $BigDecimal_$lt_eq_gt$5 = function(other) {
    ...
    }, $BigDecimal_$lt_eq_gt$5.$$arity = 1);
    
    Opal.def(self, '$<', $BigDecimal_$lt$6 = function(other) {
      var $a, $b, $iter = $BigDecimal_$lt$6.$$p, $yield = $iter || nil, self = this, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;

      if ($iter) $BigDecimal_$lt$6.$$p = null;
      ...
      if ($truthy(($truthy($a = self['$nan?']()) ? $a : ($truthy($b = other) ? other['$nan?']() : $b)))) {
        return false};
      return $send(self, Opal.find_super_dispatcher(self, '<', $BigDecimal_$lt$6, false), $zuper, $iter);
    }, $BigDecimal_$lt$6.$$arity = 1);
    
    Opal.def(self, '$<=', $BigDecimal_$lt_eq$7 = function(other) {
      var $a, $b, $iter = $BigDecimal_$lt_eq$7.$$p, $yield = $iter || nil, self = this, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;

      if ($iter) $BigDecimal_$lt_eq$7.$$p = null;
      // Prepare super implicit arguments
      for($zuper_i = 0, $zuper_ii = arguments.length, $zuper = new Array($zuper_ii); $zuper_i < $zuper_ii; $zuper_i++) {
        $zuper[$zuper_i] = arguments[$zuper_i];
      }
      ...
      if ($truthy(($truthy($a = self['$nan?']()) ? $a : ($truthy($b = other) ? other['$nan?']() : $b)))) {
        return false};
      return $send(self, Opal.find_super_dispatcher(self, '<=', $BigDecimal_$lt_eq$7, false), $zuper, $iter);
    }, $BigDecimal_$lt_eq$7.$$arity = 1);
    
    Opal.def(self, '$>', $BigDecimal_$gt$8 = function(other) {
      var $a, $b, $iter = $BigDecimal_$gt$8.$$p, $yield = $iter || nil, self = this, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;

      if ($iter) $BigDecimal_$gt$8.$$p = null;
      // Prepare super implicit arguments
      for($zuper_i = 0, $zuper_ii = arguments.length, $zuper = new Array($zuper_ii); $zuper_i < $zuper_ii; $zuper_i++) {
        $zuper[$zuper_i] = arguments[$zuper_i];
      }
      ...
      if ($truthy(($truthy($a = self['$nan?']()) ? $a : ($truthy($b = other) ? other['$nan?']() : $b)))) {
        return false};
      return $send(self, Opal.find_super_dispatcher(self, '>', $BigDecimal_$gt$8, false), $zuper, $iter);
    }, $BigDecimal_$gt$8.$$arity = 1);
    
    Opal.def(self, '$>=', $BigDecimal_$gt_eq$9 = function(other) {
      var $a, $b, $iter = $BigDecimal_$gt_eq$9.$$p, $yield = $iter || nil, self = this, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;

      if ($iter) $BigDecimal_$gt_eq$9.$$p = null;
      // Prepare super implicit arguments
      for($zuper_i = 0, $zuper_ii = arguments.length, $zuper = new Array($zuper_ii); $zuper_i < $zuper_ii; $zuper_i++) {
        $zuper[$zuper_i] = arguments[$zuper_i];
      }
      ...
      if ($truthy(($truthy($a = self['$nan?']()) ? $a : ($truthy($b = other) ? other['$nan?']() : $b)))) {
        return false};
      return $send(self, Opal.find_super_dispatcher(self, '>=', $BigDecimal_$gt_eq$9, false), $zuper, $iter);
    }, $BigDecimal_$gt_eq$9.$$arity = 1);
    
    Opal.def(self, '$abs', $BigDecimal_abs$10 = function $$abs() {
      var self = this;

      return self.$class().$new(self.$bignumber().abs())
    }, $BigDecimal_abs$10.$$arity = 0);
    
    Opal.def(self, '$add', $BigDecimal_add$11 = function $$add(other, digits) {
    ...
    }, $BigDecimal_add$11.$$arity = -2);
    Opal.alias(self, "+", "add");
    
    Opal.def(self, '$ceil', $BigDecimal_ceil$12 = function $$ceil(n) {
      var self = this;
    ...
    }, $BigDecimal_ceil$12.$$arity = -1);
    
    Opal.def(self, '$coerce', $BigDecimal_coerce$13 = function $$coerce(other) {
      var self = this, $case = nil;
    ...
    }, $BigDecimal_coerce$13.$$arity = 1);
    
    Opal.def(self, '$div', $BigDecimal_div$14 = function $$div(other, digits) {
    ...
    }, $BigDecimal_div$14.$$arity = -2);
    
    Opal.def(self, '$finite?', $BigDecimal_finite$ques$15 = function() {
      var self = this;

      return self.$bignumber().isFinite()
    }, $BigDecimal_finite$ques$15.$$arity = 0);
    
    Opal.def(self, '$infinite?', $BigDecimal_infinite$ques$16 = function() {
      var $a, self = this;
    ...
    }, $BigDecimal_infinite$ques$16.$$arity = 0);
    
    Opal.def(self, '$minus', $BigDecimal_minus$17 = function $$minus(other) {
      var $a, $b, self = this, _ = nil;

      
      $b = self.$coerce(other), $a = Opal.to_ary($b), (other = ($a[0] == null ? nil : $a[0])), (_ = ($a[1] == null ? nil : $a[1])), $b;
      return self.$class().$new(self.$bignumber().minus(other.$bignumber()));
    }, $BigDecimal_minus$17.$$arity = 1);
    Opal.alias(self, "-", "minus");
    
    Opal.def(self, '$mult', $BigDecimal_mult$18 = function $$mult(other, digits) {
      var $a, $b, self = this, _ = nil;
    ...
    }, $BigDecimal_mult$18.$$arity = -2);
    Opal.alias(self, "*", "mult");
    
    Opal.def(self, '$nan?', $BigDecimal_nan$ques$19 = function() {
      var self = this;

      return self.$bignumber().isNaN()
    }, $BigDecimal_nan$ques$19.$$arity = 0);
    
    Opal.def(self, '$quo', $BigDecimal_quo$20 = function $$quo(other) {
      var $a, $b, self = this, _ = nil;

      
      $b = self.$coerce(other), $a = Opal.to_ary($b), (other = ($a[0] == null ? nil : $a[0])), (_ = ($a[1] == null ? nil : $a[1])), $b;
      return self.$class().$new(self.$bignumber().dividedBy(other.$bignumber()));
    }, $BigDecimal_quo$20.$$arity = 1);
    Opal.alias(self, "/", "quo");
    
    Opal.def(self, '$sign', $BigDecimal_sign$21 = function $$sign() {
      var self = this;
    ...
    }, $BigDecimal_sign$21.$$arity = 0);
    
    Opal.def(self, '$sub', $BigDecimal_sub$22 = function $$sub(other, precision) {
      var $a, $b, self = this, _ = nil;

      
      $b = self.$coerce(other), $a = Opal.to_ary($b), (other = ($a[0] == null ? nil : $a[0])), (_ = ($a[1] == null ? nil : $a[1])), $b;
      return self.$class().$new(self.$bignumber().minus(other.$bignumber()));
    }, $BigDecimal_sub$22.$$arity = 2);
    
    Opal.def(self, '$to_f', $BigDecimal_to_f$23 = function $$to_f() {
      var self = this;

      return self.$bignumber().toNumber()
    }, $BigDecimal_to_f$23.$$arity = 0);
    
    Opal.def(self, '$to_s', $BigDecimal_to_s$24 = function $$to_s(s) {
      var self = this;
    ...
    }, $BigDecimal_to_s$24.$$arity = -1);
    return (Opal.def(self, '$zero?', $BigDecimal_zero$ques$25 = function() {
      var self = this;

      return self.$bignumber().isZero()
    }, $BigDecimal_zero$ques$25.$$arity = 0), nil) && 'zero?';
  })($nesting[0], null, $nesting);
};
