  ...
  return (function($base, $super, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      Opal.def(self, '$coerce', $Infinity_coerce$10 = function $$coerce(other) {
        ...
        else {return $send(self, Opal.find_super_dispatcher(self, 'coerce', $Infinity_coerce$10, false), $zuper, $iter)}})()
    ...
    Opal.def(self, '$step', $Date_step$48 = function $$step(limit, step) {
      ...
      result = $send(steps, 'map', [], ($$49 = function(i){var self = $$49.$$s || this;
      ...
      if ((block !== nil)) {
        ...
        $send(result, 'each', [], ($$50 = function(i){var self = $$50.$$s || this;
