...
Opal.modules["bigdecimal"] = function(Opal) {
  ...
  var $new$2, self = Opal.top, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$, $$ = Opal.$$, $klass = Opal.klass, $module = Opal.module, $hash2 = Opal.hash2, $send = Opal.send, $hash = Opal.hash, $truthy = Opal.truthy, $send2 = Opal.send2;
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$<', $BigDecimal_$lt$8 = function(other) {
      var $iter = $BigDecimal_$lt$8.$$p, $yield = $iter || nil, self = this, $ret_or_2 = nil, $ret_or_3 = nil, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;
      ...
      if ($truthy((function() {if ($truthy(($ret_or_2 = self['$nan?']()))) {
        ...
        return false};
      return $send2(self, Opal.find_super_dispatcher(self, '<', $BigDecimal_$lt$8, false, true), '<', $zuper, $iter);
    }, $BigDecimal_$lt$8.$$arity = 1);
    
    Opal.def(self, '$<=', $BigDecimal_$lt_eq$9 = function(other) {
      var $iter = $BigDecimal_$lt_eq$9.$$p, $yield = $iter || nil, self = this, $ret_or_4 = nil, $ret_or_5 = nil, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;
      ...
      if ($truthy((function() {if ($truthy(($ret_or_4 = self['$nan?']()))) {
        ...
        return false};
      return $send2(self, Opal.find_super_dispatcher(self, '<=', $BigDecimal_$lt_eq$9, false, true), '<=', $zuper, $iter);
    }, $BigDecimal_$lt_eq$9.$$arity = 1);
    
    Opal.def(self, '$>', $BigDecimal_$gt$10 = function(other) {
      var $iter = $BigDecimal_$gt$10.$$p, $yield = $iter || nil, self = this, $ret_or_6 = nil, $ret_or_7 = nil, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;
      ...
      if ($truthy((function() {if ($truthy(($ret_or_6 = self['$nan?']()))) {
        ...
        return false};
      return $send2(self, Opal.find_super_dispatcher(self, '>', $BigDecimal_$gt$10, false, true), '>', $zuper, $iter);
    }, $BigDecimal_$gt$10.$$arity = 1);
    
    Opal.def(self, '$>=', $BigDecimal_$gt_eq$11 = function(other) {
      var $iter = $BigDecimal_$gt_eq$11.$$p, $yield = $iter || nil, self = this, $ret_or_8 = nil, $ret_or_9 = nil, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;
      ...
      if ($truthy((function() {if ($truthy(($ret_or_8 = self['$nan?']()))) {
        ...
        return false};
      return $send2(self, Opal.find_super_dispatcher(self, '>=', $BigDecimal_$gt_eq$11, false, true), '>=', $zuper, $iter);
