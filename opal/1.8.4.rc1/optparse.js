Opal.modules["optparse/version"] = function(Opal) {/* Generated by Opal 1.8.4.rc1 */
...
Opal.modules["shellwords"] = function(Opal) {/* Generated by Opal 1.8.4.rc1 */
...
Opal.modules["optparse"] = function(Opal) {/* Generated by Opal 1.8.4.rc1 */
  ...
  (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$version', function $$version() {
      ...
      if ($truthy(($ret_or_1 = ($truthy(($ret_or_2 = (($a = self['version'], $a != null && $a !== nil) ? 'instance-variable' : nil))) ? (self.version) : ($ret_or_2))))) {
        ...
        if ($truthy(($ret_or_2 = ((($b = $$$('::', 'Version', 'skip_raise'))) != null ? 'constant' : nil)))) {
          return $$$('Version')
        } else {
          return $ret_or_2
        };
    ...
    $def(self, '$release', function $$release() {
      ...
      if ($truthy(($ret_or_1 = ($truthy(($ret_or_2 = ($truthy(($ret_or_3 = (($a = self['release'], $a != null && $a !== nil) ? 'instance-variable' : nil))) ? (self.release) : ($ret_or_3)))) ? ($ret_or_2) : (($truthy(($ret_or_3 = ((($b = $$$('::', 'Release', 'skip_raise'))) != null ? 'constant' : nil))) ? ($$$('Release')) : ($ret_or_3))))))) {
        return $ret_or_1
      } else {
        
        if ($truthy(($ret_or_2 = ((($c = $$$('::', 'RELEASE', 'skip_raise'))) != null ? 'constant' : nil)))) {
          return $$$('RELEASE')
        } else {
          return $ret_or_2
        };
    ...
    $def(self, '$additional_message', function $$additional_message(typ, opt) {
      ...
      if (!(($truthy(typ) && ($truthy(opt))) && ($truthy(((($b = $$('DidYouMean', 'skip_raise')) && ($a = $$$($b, 'SpellChecker', 'skip_raise'))) != null ? 'constant' : nil))))) {
        return nil
      };
      all_candidates = [];
