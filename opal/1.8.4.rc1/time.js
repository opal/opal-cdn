Opal.modules["forwardable"] = function(Opal) {/* Generated by Opal 1.8.4.rc1 */
...
Opal.modules["date/infinity"] = function(Opal) {/* Generated by Opal 1.8.4.rc1 */
...
Opal.modules["time"] = function(Opal) {/* Generated by Opal 1.8.4.rc1 */
  ...
  (function($base, $super, $parent_nesting) {
    ...
    $defs(self, '$def_formatter', function $$def_formatter(name, format, $kwargs) {
      ...
      return $send(on, 'define_method', [name], function $$1(fdigits){var $a, $b, self = $$1.$$s == null ? this : $$1.$$s, $ret_or_2 = nil, $ret_or_1 = nil, date = nil, str = nil;
        ...
        if ($eqeqeq(($truthy(($ret_or_2 = ((($a = $$$('::', 'DateTime', 'skip_raise'))) != null ? 'constant' : nil))) ? ($$$('DateTime')) : ($ret_or_2)), ($ret_or_1 = self))) {
          date = ($truthy(on_utc) ? (self.$new_offset(0)) : (self))
        } else if ($eqeqeq(($truthy(($ret_or_2 = ((($b = $$$('::', 'Date', 'skip_raise'))) != null ? 'constant' : nil))) ? ($$$('Date')) : ($ret_or_2)), $ret_or_1)) {
...
Opal.modules["date/date_time"] = function(Opal) {/* Generated by Opal 1.8.4.rc1 */
...
Opal.modules["date/formatters"] = function(Opal) {/* Generated by Opal 1.8.4.rc1 */
...
Opal.modules["date"] = function(Opal) {/* Generated by Opal 1.8.4.rc1 */
