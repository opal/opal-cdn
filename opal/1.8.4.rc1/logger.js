Opal.modules["logger"] = function(Opal) {/* Generated by Opal 1.8.4.rc1 */
  var $klass = Opal.klass, $module = Opal.module, $const_set = Opal.const_set, $send = Opal.send, $def = Opal.def, $eqeqeq = Opal.eqeqeq, $ensure_kwargs = Opal.ensure_kwargs, $hash_get = Opal.hash_get, $truthy = Opal.truthy, $rb_le = Opal.rb_le, $rb_lt = Opal.rb_lt, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$;
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$initialize', function $$initialize(pipe, $kwargs) {
      var level, progname, formatter, self = this, $ret_or_1 = nil;

      
      $kwargs = $ensure_kwargs($kwargs);
      
      level = $hash_get($kwargs, "level");if (level == null) level = $$('DEBUG');
      
      progname = $hash_get($kwargs, "progname");if (progname == null) progname = nil;
      
      formatter = $hash_get($kwargs, "formatter");if (formatter == null) formatter = nil;
      self.pipe = pipe;
      self.level = level;
      self.formatter = ($truthy(($ret_or_1 = formatter)) ? ($ret_or_1) : ($$('Formatter').$new()));
      return (self.progname = progname);
    }, -2);
