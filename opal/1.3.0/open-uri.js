...
Opal.modules["corelib/pack_unpack/format_string_parser"] = function(Opal) {/* Generated by Opal 1.3.0 */
...
Opal.modules["corelib/array/pack"] = function(Opal) {/* Generated by Opal 1.3.0 */
...
Opal.modules["open-uri"] = function(Opal) {/* Generated by Opal 1.3.0 */
  function $rb_minus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs - rhs : lhs['$-'](rhs);
  }
  function $rb_plus(lhs, rhs) {
