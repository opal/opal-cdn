...
Opal.modules["benchmark"] = function(Opal) {
  ...
  return (function($base) {
    ...
    Opal.defn(self, '$benchmark', TMP_1 = function ːbenchmark(caption, label_width, format, $a_rest) {
      ...
      ((($b = label_width) !== false && $b !== nil) ? $b : label_width = 0);
      label_width = $rb_plus(label_width, 1);
      ((($b = format) !== false && $b !== nil) ? $b : format = $scope.get('FORMAT'));
      if ((($b = caption['$empty?']()) !== nil && (!$b.$$is_boolean || $b == true))) {
        } else {
      ...
      ($b = $scope.get('Array')['$==='](results), $b !== false && $b !== nil ?($c = ($d = results.$grep($scope.get('Tms'))).$each, $c.$$p = (TMP_2 = function(t){var self = TMP_2.$$s || this, $a, $e;
if (t == null) t = nil;
      return self.$print((((($a = ((($e = labels.$shift()) !== false && $e !== nil) ? $e : t.$label())) !== false && $a !== nil) ? $a : "")).$ljust(label_width), t.$format(format))}, TMP_2.$$s = self, TMP_2.$$arity = 1, TMP_2), $c).call($d) : $b);
      return report.$list();
      } finally {
        if ((($b = sync['$nil?']()) !== nil && (!$b.$$is_boolean || $b == true))) {
          } else {
...
if (res == null) res = nil;
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$format', TMP_28 = function ːformat(format, $a_rest) {
        ...
        str = ($b = ($c = ($d = ($e = ($f = ($g = ($h = ($i = ($j = ($k = ($l = ($m = ($n = ($o = (((($p = format) !== false && $p !== nil) ? $p : $scope.get('FORMAT'))).$dup()).$gsub, $n.$$p = (TMP_27 = function(){var self = TMP_27.$$s || this, $a;
