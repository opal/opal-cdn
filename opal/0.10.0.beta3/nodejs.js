...
if (string == null) string = nil;
  return process.stdout.write(string);}, TMP_1.$$s = self, TMP_1.$$arity = 1, TMP_1), $c).call($d)]), $b = $scope.get('STDOUT'), $b['$write_proc='].apply($b, $a), $a[$a.length-1]);
  (($a = [($c = ($e = self).$lambda, $c.$$p = (TMP_2 = function(string){var self = TMP_2.$$s || this;
if (string == null) string = nil;
  return process.stderr.write(string);}, TMP_2.$$s = self, TMP_2.$$arity = 1, TMP_2), $c).call($e)]), $b = $scope.get('STDERR'), $b['$write_proc='].apply($b, $a), $a[$a.length-1]);
