...
Opal.modules["date"] = function(Opal) {
  ...
  Opal.add_stubs(['$include', '$<=>', '$nonzero?', '$d', '$zero?', '$new', '$class', '$-@', '$+@', '$===', '$coerce', '$==', '$>', '$+', '$allocate', '$join', '$compact', '$map', '$to_proc', '$downcase', '$wrap', '$raise', '$clone', '$>>', '$wday', '$-', '$to_s', '$alias_method']);
  return (function($base, $super) {
    function $Date(){};
    var self = $Date = $klass($base, $super, 'Date', $Date);

    var def = self.$$proto, $scope = self.$$scope, TMP_16, TMP_17, TMP_18, TMP_19, TMP_20, TMP_21, TMP_22, TMP_23, TMP_24, TMP_25, TMP_26, TMP_27, TMP_28, TMP_29, TMP_30, TMP_31, TMP_32, TMP_33, TMP_34, TMP_35, TMP_36, TMP_37, TMP_38, TMP_39, TMP_40, TMP_41, TMP_42, TMP_43, TMP_44, TMP_45, TMP_46, TMP_47;
    ...
    (function(self) {
      var $scope = self.$$scope, def = self.$$proto, TMP_13, TMP_14, TMP_15;
      ...
      return (Opal.defn(self, '$today', TMP_15 = function ːtoday() {
        var self = this;

        return self.$wrap(new Date());
      }, TMP_15.$$arity = 0), nil) && 'today';
    })(Opal.get_singleton_class(self));

    Opal.defn(self, '$initialize', TMP_16 = function ːinitialize(year, month, day, start) {
      var self = this;
    ...
    Opal.defn(self, '$-', TMP_17 = function(date) {
      var self = this;
    ...
    Opal.defn(self, '$>>', TMP_25 = function(n) {
      var self = this;
    ...
    Opal.defn(self, '$clone', TMP_27 = function ːclone() {
      var self = this;

      return $scope.get('Date').$wrap(new Date(self.date.getTime()));
    }, TMP_27.$$arity = 0);

    Opal.defn(self, '$day', TMP_28 = function ːday() {
      var self = this;

      return self.date.getDate();
    }, TMP_28.$$arity = 0);

    Opal.defn(self, '$friday?', TMP_29 = function() {
      var self = this;

      return self.$wday()['$=='](5);
    }, TMP_29.$$arity = 0);

    Opal.defn(self, '$jd', TMP_30 = function ːjd() {
      var self = this;
    ...
    Opal.defn(self, '$julian?', TMP_31 = function() {
      var self = this;

      return self.date < new Date(1582, 10 - 1, 15, 12);
    }, TMP_31.$$arity = 0);

    Opal.defn(self, '$monday?', TMP_32 = function() {
      var self = this;

      return self.$wday()['$=='](1);
    }, TMP_32.$$arity = 0);

    Opal.defn(self, '$month', TMP_33 = function ːmonth() {
      var self = this;

      return self.date.getMonth() + 1;
    }, TMP_33.$$arity = 0);

    Opal.defn(self, '$next', TMP_34 = function ːnext() {
      var self = this;

      return $rb_plus(self, 1);
    }, TMP_34.$$arity = 0);

    Opal.defn(self, '$next_day', TMP_35 = function ːnext_day(n) {
      var self = this;
    ...
    Opal.defn(self, '$next_month', TMP_36 = function ːnext_month() {
      var self = this;
    ...
    Opal.defn(self, '$prev_day', TMP_37 = function ːprev_day(n) {
      var self = this;
    ...
    Opal.defn(self, '$prev_month', TMP_38 = function ːprev_month() {
      var self = this;
    ...
    Opal.defn(self, '$saturday?', TMP_39 = function() {
      var self = this;

      return self.$wday()['$=='](6);
    }, TMP_39.$$arity = 0);

    Opal.defn(self, '$strftime', TMP_40 = function ːstrftime(format) {
      var self = this;
    ...
    Opal.defn(self, '$sunday?', TMP_41 = function() {
      var self = this;

      return self.$wday()['$=='](0);
    }, TMP_41.$$arity = 0);

    Opal.defn(self, '$thursday?', TMP_42 = function() {
      var self = this;

      return self.$wday()['$=='](4);
    }, TMP_42.$$arity = 0);

    Opal.defn(self, '$to_s', TMP_43 = function ːto_s() {
      var self = this;
    ...
    Opal.defn(self, '$tuesday?', TMP_44 = function() {
      var self = this;

      return self.$wday()['$=='](2);
    }, TMP_44.$$arity = 0);

    Opal.defn(self, '$wday', TMP_45 = function ːwday() {
      var self = this;

      return self.date.getDay();
    }, TMP_45.$$arity = 0);

    Opal.defn(self, '$wednesday?', TMP_46 = function() {
      var self = this;

      return self.$wday()['$=='](3);
    }, TMP_46.$$arity = 0);

    Opal.defn(self, '$year', TMP_47 = function ːyear() {
      var self = this;
