...
if (fragment == null) fragment = nil;
        mapping = nil;
          ...
          if ((($d = (($e = source_line !== false && source_line !== nil) ? source_column : source_line)) !== nil && (!$d.$$is_boolean || $d == true))) {
          ...
          if ((($d = $rb_gt(new_lines, 0)) !== nil && (!$d.$$is_boolean || $d == true))) {
      ...
      return (Opal.defn(self, '$magic_comment', TMP_6 = function ːmagic_comment(map_path) {
        var self = this;

        return "\n//# sourceMappingURL=file://" + (map_path);
      }, TMP_6.$$arity = 1), nil) && 'magic_comment';
    })($scope.base, null)
  })($scope.base);
};
/* Generated by Opal 0.10.0.beta3 */
